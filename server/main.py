...
LOCAL_MODELS = [
    {
        ...
        "description": "MiniMax最新旗舰语言模型满血版，支持超长上下文和复杂推理，端侧运行性能强劲。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/minimax-h3-full.mnn",
        "recommended": True,
        "rank": 1,
        "author": "MiniMax",
        "version": "1.0.0",
    ...
    },
    {
        ...
        "type": "language",
        "size": 16384,  # MB
        "size_display": "16.0 GB",
        "description": "DeepSeek第四代专业版模型，超强代码能力和数学推理，适合开发者和专业用户。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/deepseek-4-pro.mnn",
        "recommended": True,
        "rank": 2,
        "author": "DeepSeek",
        "version": "4.0.0",
    ...
    },
    {
        ...
        "type": "language",
        "size": 14336,
        "size_display": "14.0 GB",
        "description": "通义千问3代72B参数模型，中文理解出色，多语言支持，综合能力均衡。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/qwen-3-72b.mnn",
        "recommended": False,
        "rank": 3,
        "author": "Alibaba",
        "version": "3.0.0",
    ...
    },
    {
        ...
        "type": "language",
        "size": 13824,
        "size_display": "13.5 GB",
        "description": "Meta最新Llama 4代70B模型，开源旗舰，英文表现优异，支持多种任务。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/llama-4-70b.mnn",
        "recommended": False,
        "rank": 4,
        "author": "Meta",
        "version": "4.0.0",
    ...
    },
    {
        ...
        "size": 9216,
        "size_display": "9.0 GB",
        "description": "智谱GLM-5 9B轻量版，移动端友好，响应速度快，日常对话足够用。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/glm-5-9b.mnn",
        "recommended": False,
        "rank": 5,
        "author": "Zhipu",
        "version": "5.0.0",
    ...
    },
    {
        ...
        "size": 7168,
        "size_display": "7.0 GB",
        "description": "微软Phi-4 14B小参数旗舰，推理效率极高，适合中低端设备本地运行。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/phi-4-14b.mnn",
        "recommended": False,
        "rank": 6,
        "author": "Microsoft",
        "version": "4.0.0",
    ...
    },
    {
        ...
        "type": "video",
        "size": 28672,
        "size_display": "28.0 GB",
        "description": "通义万相2.1视频生成模型，支持文生视频和图生视频，高画质输出。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/wan-2-14b-video.mnn",
        "recommended": False,
        "rank": 7,
        "author": "Alibaba",
        "version": "2.1.0",
    ...
    },
    {
        ...
        "type": "video",
        "size": 26624,
        "size_display": "26.0 GB",
        "description": "腾讯混元视频生成模型13B版本，支持5秒720P视频生成，画质流畅。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/hunyuan-video-13b.mnn",
        "recommended": False,
        "rank": 8,
        "author": "Tencent",
        "version": "1.0.0",
    ...
    },
    {
        ...
        "description": "智谱CogVideoX 5B视频生成模型，轻量级视频生成，适合移动端。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/cogvideox-5b.mnn",
        "recommended": False,
        "rank": 9,
        "author": "Zhipu",
        "version": "1.0.0",
    ...
    },
    {
        ...
        "type": "image",
        "size": 12288,
        "size_display": "12.0 GB",
        "description": "Stable Diffusion 3.5大模型版本，高质量图像生成，支持多种风格。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/sd-3-5-large.mnn",
        "recommended": False,
        "rank": 10,
        "author": "Stability AI",
        "version": "3.5.0",
    ...
    },
    {
        ...
        "type": "image",
        "size": 13312,
        "size_display": "13.0 GB",
        "description": "Black Forest Labs FLUX.1 Dev图像生成模型，目前最强开源文生图模型之一。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/flux-1-dev.mnn",
        "recommended": False,
        "rank": 11,
    ...
    },
    {
        ...
        "size": 3072,
        "size_display": "3.0 GB",
        "description": "OpenAI Whisper大模型V3版本，多语言语音识别，支持99种语言。",
        "download_url": "https://github.com/chumianyi/chumian-ai-models/releases/download/v1.0/whisper-large-v3.mnn",
        "recommended": False,
        "rank": 12,
        "author": "OpenAI",
        "version": "3.0.0",
...
async def get_local_models():
    """获取本地模型列表，包含下载地址"""
    sorted_models = sorted(LOCAL_MODELS, key=lambda x: x["rank"])
    return {
        "success": True,
        "data": sorted_models,
