...
/// Swing animation widget
class SwingAnimation2 extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SwingAnimation2> createState() => _SwingAnimation2State();
}

class _SwingAnimation2State extends State<SwingAnimation2> with SingleTickerProviderStateMixin {
