...
/// Sliver animated list animation widget
class SliverAnimatedListAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAnimatedListAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAnimatedListAnimation> createState() => _SliverAnimatedListAnimationState();
}

class _SliverAnimatedListAnimationState extends State<SliverAnimatedListAnimation> with SingleTickerProviderStateMixin {
