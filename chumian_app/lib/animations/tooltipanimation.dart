...
/// Tooltip animation widget
class TooltipAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<TooltipAnimation> createState() => _TooltipAnimationState();
}

class _TooltipAnimationState extends State<TooltipAnimation> with SingleTickerProviderStateMixin {
