...
/// Sliver geometry animation widget
class SliverGeometryAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverGeometryAnimation> createState() => _SliverGeometryAnimationState();
}

class _SliverGeometryAnimationState extends State<SliverGeometryAnimation> with SingleTickerProviderStateMixin {
