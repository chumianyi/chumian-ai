...
/// Sliver animated grid animation widget
class SliverAnimatedGridAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAnimatedGridAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAnimatedGridAnimation> createState() => _SliverAnimatedGridAnimationState();
}

class _SliverAnimatedGridAnimationState extends State<SliverAnimatedGridAnimation> with SingleTickerProviderStateMixin {
