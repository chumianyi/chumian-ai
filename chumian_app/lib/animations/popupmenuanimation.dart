...
/// Popup menu animation widget
class PopupMenuAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<PopupMenuAnimation> createState() => _PopupMenuAnimationState();
}

class _PopupMenuAnimationState extends State<PopupMenuAnimation> with SingleTickerProviderStateMixin {
