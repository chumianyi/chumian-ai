...
/// Sliver app bar state animation widget
class SliverAppBarStateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarStateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarStateAnimation> createState() => _SliverAppBarStateAnimationState();
}

class _SliverAppBarStateAnimationState extends State<SliverAppBarStateAnimation> with SingleTickerProviderStateMixin {
