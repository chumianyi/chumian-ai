...
/// Rotate out down right animation widget
class RotateOutDownRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateOutDownRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateOutDownRightAnimation> createState() => _RotateOutDownRightAnimationState();
}

class _RotateOutDownRightAnimationState extends State<RotateOutDownRightAnimation> with SingleTickerProviderStateMixin {
