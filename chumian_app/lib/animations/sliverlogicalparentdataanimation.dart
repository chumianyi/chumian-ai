...
/// Sliver logical parent data animation widget
class SliverLogicalParentDataAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverLogicalParentDataAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverLogicalParentDataAnimation> createState() => _SliverLogicalParentDataAnimationState();
}

class _SliverLogicalParentDataAnimationState extends State<SliverLogicalParentDataAnimation> with SingleTickerProviderStateMixin {
