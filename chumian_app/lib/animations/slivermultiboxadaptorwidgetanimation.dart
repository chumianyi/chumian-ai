...
/// Sliver multi box adaptor widget animation widget
class SliverMultiBoxAdaptorWidgetAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverMultiBoxAdaptorWidgetAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverMultiBoxAdaptorWidgetAnimation> createState() => _SliverMultiBoxAdaptorWidgetAnimationState();
}

class _SliverMultiBoxAdaptorWidgetAnimationState extends State<SliverMultiBoxAdaptorWidgetAnimation> with SingleTickerProviderStateMixin {
