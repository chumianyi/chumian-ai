...
/// Sliver constraints animation widget
class SliverConstraintsAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverConstraintsAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverConstraintsAnimation> createState() => _SliverConstraintsAnimationState();
}

class _SliverConstraintsAnimationState extends State<SliverConstraintsAnimation> with SingleTickerProviderStateMixin {
