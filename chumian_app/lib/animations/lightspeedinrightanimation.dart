...
/// Light speed in right animation widget
class LightSpeedInRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const LightSpeedInRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<LightSpeedInRightAnimation> createState() => _LightSpeedInRightAnimationState();
}

class _LightSpeedInRightAnimationState extends State<LightSpeedInRightAnimation> with SingleTickerProviderStateMixin {
