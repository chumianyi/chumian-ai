...
/// Sliver overlap injector animation widget
class SliverOverlapInjectorAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapInjectorAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapInjectorAnimation> createState() => _SliverOverlapInjectorAnimationState();
}

class _SliverOverlapInjectorAnimationState extends State<SliverOverlapInjectorAnimation> with SingleTickerProviderStateMixin {
