...
/// Elastic in right animation widget
class ElasticInRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ElasticInRightAnimation> createState() => _ElasticInRightAnimationState();
}

class _ElasticInRightAnimationState extends State<ElasticInRightAnimation> with SingleTickerProviderStateMixin {
