...
/// Sliver fixed extent list animation widget
class SliverFixedExtentListAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFixedExtentListAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFixedExtentListAnimation> createState() => _SliverFixedExtentListAnimationState();
}

class _SliverFixedExtentListAnimationState extends State<SliverFixedExtentListAnimation> with SingleTickerProviderStateMixin {
