...
/// Back in down animation widget
class BackInDownAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<BackInDownAnimation> createState() => _BackInDownAnimationState();
}

class _BackInDownAnimationState extends State<BackInDownAnimation> with SingleTickerProviderStateMixin {
