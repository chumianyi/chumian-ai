...
/// Sliver reorderable list animation widget
class SliverReorderableListAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverReorderableListAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverReorderableListAnimation> createState() => _SliverReorderableListAnimationState();
}

class _SliverReorderableListAnimationState extends State<SliverReorderableListAnimation> with SingleTickerProviderStateMixin {
