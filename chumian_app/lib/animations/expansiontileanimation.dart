...
/// Expansion tile animation widget
class ExpansionTileAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ExpansionTileAnimation> createState() => _ExpansionTileAnimationState();
}

class _ExpansionTileAnimationState extends State<ExpansionTileAnimation> with SingleTickerProviderStateMixin {
