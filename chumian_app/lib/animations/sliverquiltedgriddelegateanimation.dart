...
/// Sliver quilted grid delegate animation widget
class SliverQuiltedGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverQuiltedGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverQuiltedGridDelegateAnimation> createState() => _SliverQuiltedGridDelegateAnimationState();
}

class _SliverQuiltedGridDelegateAnimationState extends State<SliverQuiltedGridDelegateAnimation> with SingleTickerProviderStateMixin {
