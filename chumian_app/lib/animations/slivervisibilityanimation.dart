...
/// Sliver visibility animation widget
class SliverVisibilityAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverVisibilityAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverVisibilityAnimation> createState() => _SliverVisibilityAnimationState();
}

class _SliverVisibilityAnimationState extends State<SliverVisibilityAnimation> with SingleTickerProviderStateMixin {
