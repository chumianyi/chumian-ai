...
/// Elastic out down animation widget
class ElasticOutDownAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ElasticOutDownAnimation> createState() => _ElasticOutDownAnimationState();
}

class _ElasticOutDownAnimationState extends State<ElasticOutDownAnimation> with SingleTickerProviderStateMixin {
