...
/// Fade out up big animation widget
class FadeOutUpBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutUpBigAnimation> createState() => _FadeOutUpBigAnimationState();
}

class _FadeOutUpBigAnimationState extends State<FadeOutUpBigAnimation> with SingleTickerProviderStateMixin {
