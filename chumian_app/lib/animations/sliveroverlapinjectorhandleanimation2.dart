...
/// Sliver overlap injector handle animation widget
class SliverOverlapInjectorHandleAnimation2 extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapInjectorHandleAnimation2({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapInjectorHandleAnimation2> createState() => _SliverOverlapInjectorHandleAnimation2State();
}

class _SliverOverlapInjectorHandleAnimation2State extends State<SliverOverlapInjectorHandleAnimation2> with SingleTickerProviderStateMixin {
