...
/// Nested scroll view header slivers builder animation widget
class NestedScrollViewHeaderSliversBuilderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const NestedScrollViewHeaderSliversBuilderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<NestedScrollViewHeaderSliversBuilderAnimation> createState() => _NestedScrollViewHeaderSliversBuilderAnimationState();
}

class _NestedScrollViewHeaderSliversBuilderAnimationState extends State<NestedScrollViewHeaderSliversBuilderAnimation> with SingleTickerProviderStateMixin {
