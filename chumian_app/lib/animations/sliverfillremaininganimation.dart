...
/// Sliver fill remaining animation widget
class SliverFillRemainingAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFillRemainingAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFillRemainingAnimation> createState() => _SliverFillRemainingAnimationState();
}

class _SliverFillRemainingAnimationState extends State<SliverFillRemainingAnimation> with SingleTickerProviderStateMixin {
