...
/// Jack in the box animation widget
class JackInTheBoxAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<JackInTheBoxAnimation> createState() => _JackInTheBoxAnimationState();
}

class _JackInTheBoxAnimationState extends State<JackInTheBoxAnimation> with SingleTickerProviderStateMixin {
