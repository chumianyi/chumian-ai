...
/// Sliver list delegate animation widget
class SliverListDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverListDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverListDelegateAnimation> createState() => _SliverListDelegateAnimationState();
}

class _SliverListDelegateAnimationState extends State<SliverListDelegateAnimation> with SingleTickerProviderStateMixin {
