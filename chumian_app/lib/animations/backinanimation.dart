...
/// Back in animation widget
class BackInAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<BackInAnimation> createState() => _BackInAnimationState();
}

class _BackInAnimationState extends State<BackInAnimation> with SingleTickerProviderStateMixin {
