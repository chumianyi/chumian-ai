...
/// Elastic out right animation widget
class ElasticOutRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const ElasticOutRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<ElasticOutRightAnimation> createState() => _ElasticOutRightAnimationState();
}

class _ElasticOutRightAnimationState extends State<ElasticOutRightAnimation> with SingleTickerProviderStateMixin {
