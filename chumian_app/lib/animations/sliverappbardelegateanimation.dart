...
class SliverAppBarDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegateAnimation> createState() => _SliverAppBarDelegateAnimationState();
}

class _SliverAppBarDelegateAnimationState extends State<SliverAppBarDelegateAnimation> with SingleTickerProviderStateMixin {
