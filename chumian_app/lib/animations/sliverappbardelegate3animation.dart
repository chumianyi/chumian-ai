...
class SliverAppBarDelegate3Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate3Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate3Animation> createState() => _SliverAppBarDelegate3AnimationState();
}

class _SliverAppBarDelegate3AnimationState extends State<SliverAppBarDelegate3Animation> with SingleTickerProviderStateMixin {
