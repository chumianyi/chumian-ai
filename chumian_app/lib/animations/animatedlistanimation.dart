...
/// Animated list animation widget
class AnimatedListAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<AnimatedListAnimation> createState() => _AnimatedListAnimationState();
}

class _AnimatedListAnimationState extends State<AnimatedListAnimation> with SingleTickerProviderStateMixin {
