...
/// Sliver waterfall flow delegate animation widget
class SliverWaterfallFlowDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverWaterfallFlowDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverWaterfallFlowDelegateAnimation> createState() => _SliverWaterfallFlowDelegateAnimationState();
}

class _SliverWaterfallFlowDelegateAnimationState extends State<SliverWaterfallFlowDelegateAnimation> with SingleTickerProviderStateMixin {
