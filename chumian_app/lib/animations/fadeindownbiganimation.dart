...
/// Fade in down big animation widget
class FadeInDownBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeInDownBigAnimation> createState() => _FadeInDownBigAnimationState();
}

class _FadeInDownBigAnimationState extends State<FadeInDownBigAnimation> with SingleTickerProviderStateMixin {
