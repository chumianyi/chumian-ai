...
class SliverAppBarDelegate8Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate8Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate8Animation> createState() => _SliverAppBarDelegate8AnimationState();
}

class _SliverAppBarDelegate8AnimationState extends State<SliverAppBarDelegate8Animation> with SingleTickerProviderStateMixin {
