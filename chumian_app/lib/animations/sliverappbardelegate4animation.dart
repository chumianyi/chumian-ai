...
class SliverAppBarDelegate4Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate4Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate4Animation> createState() => _SliverAppBarDelegate4AnimationState();
}

class _SliverAppBarDelegate4AnimationState extends State<SliverAppBarDelegate4Animation> with SingleTickerProviderStateMixin {
