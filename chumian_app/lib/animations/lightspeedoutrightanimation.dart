...
/// Light speed out right animation widget
class LightSpeedOutRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const LightSpeedOutRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<LightSpeedOutRightAnimation> createState() => _LightSpeedOutRightAnimationState();
}

class _LightSpeedOutRightAnimationState extends State<LightSpeedOutRightAnimation> with SingleTickerProviderStateMixin {
