...
/// Nested scroll view animation widget
class NestedScrollViewAnimation extends StatefulWidget {
  final Widget child;
  ...
  const NestedScrollViewAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<NestedScrollViewAnimation> createState() => _NestedScrollViewAnimationState();
}

class _NestedScrollViewAnimationState extends State<NestedScrollViewAnimation> with SingleTickerProviderStateMixin {
