...
/// Roll in animation widget
class RollInAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<RollInAnimation> createState() => _RollInAnimationState();
}

class _RollInAnimationState extends State<RollInAnimation> with SingleTickerProviderStateMixin {
