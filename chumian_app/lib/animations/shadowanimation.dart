...
class ShadowAnimation extends StatefulWidget {
  ...
  @override
  State<ShadowAnimation> createState() => _ShadowAnimationState();
}

class _ShadowAnimationState extends State<ShadowAnimation> with SingleTickerProviderStateMixin {
