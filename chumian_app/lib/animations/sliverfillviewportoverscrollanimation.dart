...
/// Sliver fill viewport overscroll animation widget
class SliverFillViewportOverscrollAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFillViewportOverscrollAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFillViewportOverscrollAnimation> createState() => _SliverFillViewportOverscrollAnimationState();
}

class _SliverFillViewportOverscrollAnimationState extends State<SliverFillViewportOverscrollAnimation> with SingleTickerProviderStateMixin {
