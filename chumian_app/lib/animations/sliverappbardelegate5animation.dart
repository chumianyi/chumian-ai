...
class SliverAppBarDelegate5Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate5Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate5Animation> createState() => _SliverAppBarDelegate5AnimationState();
}

class _SliverAppBarDelegate5AnimationState extends State<SliverAppBarDelegate5Animation> with SingleTickerProviderStateMixin {
