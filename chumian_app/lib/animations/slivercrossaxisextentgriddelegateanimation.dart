...
/// Sliver cross axis extent grid delegate animation widget
class SliverCrossAxisExtentGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverCrossAxisExtentGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverCrossAxisExtentGridDelegateAnimation> createState() => _SliverCrossAxisExtentGridDelegateAnimationState();
}

class _SliverCrossAxisExtentGridDelegateAnimationState extends State<SliverCrossAxisExtentGridDelegateAnimation> with SingleTickerProviderStateMixin {
