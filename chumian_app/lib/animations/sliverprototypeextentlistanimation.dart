...
/// Sliver prototype extent list animation widget
class SliverPrototypeExtentListAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverPrototypeExtentListAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverPrototypeExtentListAnimation> createState() => _SliverPrototypeExtentListAnimationState();
}

class _SliverPrototypeExtentListAnimationState extends State<SliverPrototypeExtentListAnimation> with SingleTickerProviderStateMixin {
