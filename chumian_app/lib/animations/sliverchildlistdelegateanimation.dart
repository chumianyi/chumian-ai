...
/// Sliver child list delegate animation widget
class SliverChildListDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverChildListDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverChildListDelegateAnimation> createState() => _SliverChildListDelegateAnimationState();
}

class _SliverChildListDelegateAnimationState extends State<SliverChildListDelegateAnimation> with SingleTickerProviderStateMixin {
