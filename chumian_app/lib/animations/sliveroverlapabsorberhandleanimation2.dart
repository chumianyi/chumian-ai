...
/// Sliver overlap absorber handle animation widget
class SliverOverlapAbsorberHandleAnimation2 extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapAbsorberHandleAnimation2({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapAbsorberHandleAnimation2> createState() => _SliverOverlapAbsorberHandleAnimation2State();
}

class _SliverOverlapAbsorberHandleAnimation2State extends State<SliverOverlapAbsorberHandleAnimation2> with SingleTickerProviderStateMixin {
