...
/// Zoom in left animation widget
class ZoomInLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ZoomInLeftAnimation> createState() => _ZoomInLeftAnimationState();
}

class _ZoomInLeftAnimationState extends State<ZoomInLeftAnimation> with SingleTickerProviderStateMixin {
