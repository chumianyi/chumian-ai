...
/// Sliver list animation widget
class SliverListAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverListAnimation> createState() => _SliverListAnimationState();
}

class _SliverListAnimationState extends State<SliverListAnimation> with SingleTickerProviderStateMixin {
