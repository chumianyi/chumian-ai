...
/// Sliver variable size child delegate animation widget
class SliverVariableSizeChildDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverVariableSizeChildDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverVariableSizeChildDelegateAnimation> createState() => _SliverVariableSizeChildDelegateAnimationState();
}

class _SliverVariableSizeChildDelegateAnimationState extends State<SliverVariableSizeChildDelegateAnimation> with SingleTickerProviderStateMixin {
