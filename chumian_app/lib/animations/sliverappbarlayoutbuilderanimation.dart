...
/// Sliver app bar layout builder animation widget
class SliverAppBarLayoutBuilderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarLayoutBuilderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarLayoutBuilderAnimation> createState() => _SliverAppBarLayoutBuilderAnimationState();
}

class _SliverAppBarLayoutBuilderAnimationState extends State<SliverAppBarLayoutBuilderAnimation> with SingleTickerProviderStateMixin {
