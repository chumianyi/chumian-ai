...
/// Sliver opacity animation widget
class SliverOpacityAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverOpacityAnimation> createState() => _SliverOpacityAnimationState();
}

class _SliverOpacityAnimationState extends State<SliverOpacityAnimation> with SingleTickerProviderStateMixin {
