...
/// Slide in down animation widget
class SlideInDownAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SlideInDownAnimation> createState() => _SlideInDownAnimationState();
}

class _SlideInDownAnimationState extends State<SlideInDownAnimation> with SingleTickerProviderStateMixin {
