...
class SliverOverlapAbsorberHandleAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapAbsorberHandleAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapAbsorberHandleAnimation> createState() => _SliverOverlapAbsorberHandleAnimationState();
}

class _SliverOverlapAbsorberHandleAnimationState extends State<SliverOverlapAbsorberHandleAnimation> with SingleTickerProviderStateMixin {
