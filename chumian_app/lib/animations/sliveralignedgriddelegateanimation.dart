...
/// Sliver aligned grid delegate animation widget
class SliverAlignedGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAlignedGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAlignedGridDelegateAnimation> createState() => _SliverAlignedGridDelegateAnimationState();
}

class _SliverAlignedGridDelegateAnimationState extends State<SliverAlignedGridDelegateAnimation> with SingleTickerProviderStateMixin {
