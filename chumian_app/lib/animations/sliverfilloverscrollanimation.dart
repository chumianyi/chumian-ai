...
/// Sliver fill overscroll animation widget
class SliverFillOverscrollAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFillOverscrollAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFillOverscrollAnimation> createState() => _SliverFillOverscrollAnimationState();
}

class _SliverFillOverscrollAnimationState extends State<SliverFillOverscrollAnimation> with SingleTickerProviderStateMixin {
