...
/// Fade in left big animation widget
class FadeInLeftBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeInLeftBigAnimation> createState() => _FadeInLeftBigAnimationState();
}

class _FadeInLeftBigAnimationState extends State<FadeInLeftBigAnimation> with SingleTickerProviderStateMixin {
