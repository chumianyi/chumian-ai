...
class SlideOutAnimation extends StatefulWidget {
  ...
  @override
  State<SlideOutAnimation> createState() => _SlideOutAnimationState();
}

class _SlideOutAnimationState extends State<SlideOutAnimation> with SingleTickerProviderStateMixin {
