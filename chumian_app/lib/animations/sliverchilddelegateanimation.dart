...
/// Sliver child delegate animation widget
class SliverChildDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverChildDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverChildDelegateAnimation> createState() => _SliverChildDelegateAnimationState();
}

class _SliverChildDelegateAnimationState extends State<SliverChildDelegateAnimation> with SingleTickerProviderStateMixin {
