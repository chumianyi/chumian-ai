...
/// Bottom navigation animation widget
class BottomNavigationAnimation extends StatefulWidget {
  final Widget child;
  ...
  const BottomNavigationAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<BottomNavigationAnimation> createState() => _BottomNavigationAnimationState();
}

class _BottomNavigationAnimationState extends State<BottomNavigationAnimation> with SingleTickerProviderStateMixin {
