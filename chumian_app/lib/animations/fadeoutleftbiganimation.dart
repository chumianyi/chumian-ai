...
/// Fade out left big animation widget
class FadeOutLeftBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutLeftBigAnimation> createState() => _FadeOutLeftBigAnimationState();
}

class _FadeOutLeftBigAnimationState extends State<FadeOutLeftBigAnimation> with SingleTickerProviderStateMixin {
