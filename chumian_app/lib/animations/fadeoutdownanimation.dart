...
/// Fade out down animation widget
class FadeOutDownAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutDownAnimation> createState() => _FadeOutDownAnimationState();
}

class _FadeOutDownAnimationState extends State<FadeOutDownAnimation> with SingleTickerProviderStateMixin {
