...
/// Sliver varied extent list animation widget
class SliverVariedExtentListAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverVariedExtentListAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverVariedExtentListAnimation> createState() => _SliverVariedExtentListAnimationState();
}

class _SliverVariedExtentListAnimationState extends State<SliverVariedExtentListAnimation> with SingleTickerProviderStateMixin {
