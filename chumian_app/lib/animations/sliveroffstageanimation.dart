...
/// Sliver offstage animation widget
class SliverOffstageAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverOffstageAnimation> createState() => _SliverOffstageAnimationState();
}

class _SliverOffstageAnimationState extends State<SliverOffstageAnimation> with SingleTickerProviderStateMixin {
