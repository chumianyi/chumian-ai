...
/// Back in up animation widget
class BackInUpAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<BackInUpAnimation> createState() => _BackInUpAnimationState();
}

class _BackInUpAnimationState extends State<BackInUpAnimation> with SingleTickerProviderStateMixin {
