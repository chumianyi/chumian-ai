...
class SliverOverlapInjectorHandleAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapInjectorHandleAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapInjectorHandleAnimation> createState() => _SliverOverlapInjectorHandleAnimationState();
}

class _SliverOverlapInjectorHandleAnimationState extends State<SliverOverlapInjectorHandleAnimation> with SingleTickerProviderStateMixin {
