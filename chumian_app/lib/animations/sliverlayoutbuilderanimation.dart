...
/// Sliver layout builder animation widget
class SliverLayoutBuilderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverLayoutBuilderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverLayoutBuilderAnimation> createState() => _SliverLayoutBuilderAnimationState();
}

class _SliverLayoutBuilderAnimationState extends State<SliverLayoutBuilderAnimation> with SingleTickerProviderStateMixin {
