...
/// Rotate in up left animation widget
class RotateInUpLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<RotateInUpLeftAnimation> createState() => _RotateInUpLeftAnimationState();
}

class _RotateInUpLeftAnimationState extends State<RotateInUpLeftAnimation> with SingleTickerProviderStateMixin {
