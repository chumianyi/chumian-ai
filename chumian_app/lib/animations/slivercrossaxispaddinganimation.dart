...
/// Sliver cross axis padding animation widget
class SliverCrossAxisPaddingAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverCrossAxisPaddingAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverCrossAxisPaddingAnimation> createState() => _SliverCrossAxisPaddingAnimationState();
}

class _SliverCrossAxisPaddingAnimationState extends State<SliverCrossAxisPaddingAnimation> with SingleTickerProviderStateMixin {
