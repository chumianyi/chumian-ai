...
/// Zoom in down animation widget
class ZoomInDownAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ZoomInDownAnimation> createState() => _ZoomInDownAnimationState();
}

class _ZoomInDownAnimationState extends State<ZoomInDownAnimation> with SingleTickerProviderStateMixin {
