...
/// Rotate out up left animation widget
class RotateOutUpLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateOutUpLeftAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateOutUpLeftAnimation> createState() => _RotateOutUpLeftAnimationState();
}

class _RotateOutUpLeftAnimationState extends State<RotateOutUpLeftAnimation> with SingleTickerProviderStateMixin {
