...
/// Sliver app bar delegate animation widget
class SliverAppBarDelegate10Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate10Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate10Animation> createState() => _SliverAppBarDelegate10AnimationState();
}

class _SliverAppBarDelegate10AnimationState extends State<SliverAppBarDelegate10Animation> with SingleTickerProviderStateMixin {
