...
/// Sliver cross axis count grid delegate animation widget
class SliverCrossAxisCountGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverCrossAxisCountGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverCrossAxisCountGridDelegateAnimation> createState() => _SliverCrossAxisCountGridDelegateAnimationState();
}

class _SliverCrossAxisCountGridDelegateAnimationState extends State<SliverCrossAxisCountGridDelegateAnimation> with SingleTickerProviderStateMixin {
