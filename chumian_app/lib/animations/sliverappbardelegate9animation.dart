...
class SliverAppBarDelegate9Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate9Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate9Animation> createState() => _SliverAppBarDelegate9AnimationState();
}

class _SliverAppBarDelegate9AnimationState extends State<SliverAppBarDelegate9Animation> with SingleTickerProviderStateMixin {
