...
/// Rotate in up right animation widget
class RotateInUpRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateInUpRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateInUpRightAnimation> createState() => _RotateInUpRightAnimationState();
}

class _RotateInUpRightAnimationState extends State<RotateInUpRightAnimation> with SingleTickerProviderStateMixin {
