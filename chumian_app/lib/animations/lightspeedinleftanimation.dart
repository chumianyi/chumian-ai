...
/// Light speed in left animation widget
class LightSpeedInLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  const LightSpeedInLeftAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<LightSpeedInLeftAnimation> createState() => _LightSpeedInLeftAnimationState();
}

class _LightSpeedInLeftAnimationState extends State<LightSpeedInLeftAnimation> with SingleTickerProviderStateMixin {
