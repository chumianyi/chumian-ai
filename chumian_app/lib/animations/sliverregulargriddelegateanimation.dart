...
/// Sliver regular grid delegate animation widget
class SliverRegularGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverRegularGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverRegularGridDelegateAnimation> createState() => _SliverRegularGridDelegateAnimationState();
}

class _SliverRegularGridDelegateAnimationState extends State<SliverRegularGridDelegateAnimation> with SingleTickerProviderStateMixin {
