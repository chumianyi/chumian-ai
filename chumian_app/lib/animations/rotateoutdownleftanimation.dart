...
/// Rotate out down left animation widget
class RotateOutDownLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateOutDownLeftAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateOutDownLeftAnimation> createState() => _RotateOutDownLeftAnimationState();
}

class _RotateOutDownLeftAnimationState extends State<RotateOutDownLeftAnimation> with SingleTickerProviderStateMixin {
