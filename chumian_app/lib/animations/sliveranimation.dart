...
/// Sliver animation widget
class SliverAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverAnimation> createState() => _SliverAnimationState();
}

class _SliverAnimationState extends State<SliverAnimation> with SingleTickerProviderStateMixin {
