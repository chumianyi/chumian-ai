...
/// Sliver logical container parent data animation widget
class SliverLogicalContainerParentDataAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverLogicalContainerParentDataAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverLogicalContainerParentDataAnimation> createState() => _SliverLogicalContainerParentDataAnimationState();
}

class _SliverLogicalContainerParentDataAnimationState extends State<SliverLogicalContainerParentDataAnimation> with SingleTickerProviderStateMixin {
