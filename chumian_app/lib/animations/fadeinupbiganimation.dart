...
/// Fade in up big animation widget
class FadeInUpBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeInUpBigAnimation> createState() => _FadeInUpBigAnimationState();
}

class _FadeInUpBigAnimationState extends State<FadeInUpBigAnimation> with SingleTickerProviderStateMixin {
