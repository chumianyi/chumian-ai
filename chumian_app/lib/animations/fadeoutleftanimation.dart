...
/// Fade out left animation widget
class FadeOutLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutLeftAnimation> createState() => _FadeOutLeftAnimationState();
}

class _FadeOutLeftAnimationState extends State<FadeOutLeftAnimation> with SingleTickerProviderStateMixin {
