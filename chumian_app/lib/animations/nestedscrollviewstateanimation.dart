...
/// Nested scroll view state animation widget
class NestedScrollViewStateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const NestedScrollViewStateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<NestedScrollViewStateAnimation> createState() => _NestedScrollViewStateAnimationState();
}

class _NestedScrollViewStateAnimationState extends State<NestedScrollViewStateAnimation> with SingleTickerProviderStateMixin {
