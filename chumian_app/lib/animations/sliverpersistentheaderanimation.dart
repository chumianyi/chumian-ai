...
/// Sliver persistent header animation widget
class SliverPersistentHeaderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverPersistentHeaderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverPersistentHeaderAnimation> createState() => _SliverPersistentHeaderAnimationState();
}

class _SliverPersistentHeaderAnimationState extends State<SliverPersistentHeaderAnimation> with SingleTickerProviderStateMixin {
