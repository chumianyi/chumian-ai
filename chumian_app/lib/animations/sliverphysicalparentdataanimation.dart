...
/// Sliver physical parent data animation widget
class SliverPhysicalParentDataAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverPhysicalParentDataAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverPhysicalParentDataAnimation> createState() => _SliverPhysicalParentDataAnimationState();
}

class _SliverPhysicalParentDataAnimationState extends State<SliverPhysicalParentDataAnimation> with SingleTickerProviderStateMixin {
