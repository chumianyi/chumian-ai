...
/// Sliver fill animation widget
class SliverFillAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverFillAnimation> createState() => _SliverFillAnimationState();
}

class _SliverFillAnimationState extends State<SliverFillAnimation> with SingleTickerProviderStateMixin {
