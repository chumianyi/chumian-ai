...
/// Sliver fill viewport animation widget
class SliverFillViewportAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFillViewportAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFillViewportAnimation> createState() => _SliverFillViewportAnimationState();
}

class _SliverFillViewportAnimationState extends State<SliverFillViewportAnimation> with SingleTickerProviderStateMixin {
