...
/// Sliver masonry grid delegate animation widget
class SliverMasonryGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverMasonryGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverMasonryGridDelegateAnimation> createState() => _SliverMasonryGridDelegateAnimationState();
}

class _SliverMasonryGridDelegateAnimationState extends State<SliverMasonryGridDelegateAnimation> with SingleTickerProviderStateMixin {
