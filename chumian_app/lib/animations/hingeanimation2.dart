...
/// Hinge animation widget
class HingeAnimation2 extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<HingeAnimation2> createState() => _HingeAnimation2State();
}

class _HingeAnimation2State extends State<HingeAnimation2> with SingleTickerProviderStateMixin {
