...
/// Scaffold animation widget
class ScaffoldAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ScaffoldAnimation> createState() => _ScaffoldAnimationState();
}

class _ScaffoldAnimationState extends State<ScaffoldAnimation> with SingleTickerProviderStateMixin {
