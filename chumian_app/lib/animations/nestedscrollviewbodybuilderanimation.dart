...
/// Nested scroll view body builder animation widget
class NestedScrollViewBodyBuilderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const NestedScrollViewBodyBuilderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<NestedScrollViewBodyBuilderAnimation> createState() => _NestedScrollViewBodyBuilderAnimationState();
}

class _NestedScrollViewBodyBuilderAnimationState extends State<NestedScrollViewBodyBuilderAnimation> with SingleTickerProviderStateMixin {
