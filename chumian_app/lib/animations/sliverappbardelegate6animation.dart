...
class SliverAppBarDelegate6Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate6Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate6Animation> createState() => _SliverAppBarDelegate6AnimationState();
}

class _SliverAppBarDelegate6AnimationState extends State<SliverAppBarDelegate6Animation> with SingleTickerProviderStateMixin {
