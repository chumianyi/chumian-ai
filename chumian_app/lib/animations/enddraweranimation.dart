...
/// End drawer animation widget
class EndDrawerAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<EndDrawerAnimation> createState() => _EndDrawerAnimationState();
}

class _EndDrawerAnimationState extends State<EndDrawerAnimation> with SingleTickerProviderStateMixin {
