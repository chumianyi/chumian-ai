...
/// Elastic in up animation widget
class ElasticInUpAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ElasticInUpAnimation> createState() => _ElasticInUpAnimationState();
}

class _ElasticInUpAnimationState extends State<ElasticInUpAnimation> with SingleTickerProviderStateMixin {
