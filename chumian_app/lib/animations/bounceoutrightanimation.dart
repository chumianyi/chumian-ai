...
/// Bounce out right animation widget
class BounceOutRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<BounceOutRightAnimation> createState() => _BounceOutRightAnimationState();
}

class _BounceOutRightAnimationState extends State<BounceOutRightAnimation> with SingleTickerProviderStateMixin {
