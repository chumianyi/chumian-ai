...
/// Fade in right big animation widget
class FadeInRightBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeInRightBigAnimation> createState() => _FadeInRightBigAnimationState();
}

class _FadeInRightBigAnimationState extends State<FadeInRightBigAnimation> with SingleTickerProviderStateMixin {
