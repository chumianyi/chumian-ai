...
class SliverAppBarDelegate7Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate7Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate7Animation> createState() => _SliverAppBarDelegate7AnimationState();
}

class _SliverAppBarDelegate7AnimationState extends State<SliverAppBarDelegate7Animation> with SingleTickerProviderStateMixin {
