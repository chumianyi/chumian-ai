...
/// Elastic out animation widget
class ElasticOutAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ElasticOutAnimation> createState() => _ElasticOutAnimationState();
}

class _ElasticOutAnimationState extends State<ElasticOutAnimation> with SingleTickerProviderStateMixin {
