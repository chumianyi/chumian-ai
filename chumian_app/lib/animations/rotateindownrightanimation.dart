...
/// Rotate in down right animation widget
class RotateInDownRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateInDownRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateInDownRightAnimation> createState() => _RotateInDownRightAnimationState();
}

class _RotateInDownRightAnimationState extends State<RotateInDownRightAnimation> with SingleTickerProviderStateMixin {
