...
/// Sliver child builder delegate animation widget
class SliverChildBuilderDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverChildBuilderDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverChildBuilderDelegateAnimation> createState() => _SliverChildBuilderDelegateAnimationState();
}

class _SliverChildBuilderDelegateAnimationState extends State<SliverChildBuilderDelegateAnimation> with SingleTickerProviderStateMixin {
