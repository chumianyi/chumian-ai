...
/// Sliver grid delegate with fixed cross axis count animation widget
class SliverGridDelegateWithFixedCrossAxisCountAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverGridDelegateWithFixedCrossAxisCountAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverGridDelegateWithFixedCrossAxisCountAnimation> createState() => _SliverGridDelegateWithFixedCrossAxisCountAnimationState();
}

class _SliverGridDelegateWithFixedCrossAxisCountAnimationState extends State<SliverGridDelegateWithFixedCrossAxisCountAnimation> with SingleTickerProviderStateMixin {
