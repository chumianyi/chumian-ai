...
/// Sliver to box adapter animation widget
class SliverToBoxAdapterAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverToBoxAdapterAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverToBoxAdapterAnimation> createState() => _SliverToBoxAdapterAnimationState();
}

class _SliverToBoxAdapterAnimationState extends State<SliverToBoxAdapterAnimation> with SingleTickerProviderStateMixin {
