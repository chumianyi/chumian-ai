...
/// Light speed out left animation widget
class LightSpeedOutLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  const LightSpeedOutLeftAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<LightSpeedOutLeftAnimation> createState() => _LightSpeedOutLeftAnimationState();
}

class _LightSpeedOutLeftAnimationState extends State<LightSpeedOutLeftAnimation> with SingleTickerProviderStateMixin {
