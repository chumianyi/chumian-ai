...
/// Sliver grid animation widget
class SliverGridAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverGridAnimation> createState() => _SliverGridAnimationState();
}

class _SliverGridAnimationState extends State<SliverGridAnimation> with SingleTickerProviderStateMixin {
