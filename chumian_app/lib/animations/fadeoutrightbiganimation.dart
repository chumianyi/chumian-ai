...
/// Fade out right big animation widget
class FadeOutRightBigAnimation extends StatefulWidget {
  final Widget child;
  ...
  const FadeOutRightBigAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<FadeOutRightBigAnimation> createState() => _FadeOutRightBigAnimationState();
}

class _FadeOutRightBigAnimationState extends State<FadeOutRightBigAnimation> with SingleTickerProviderStateMixin {
