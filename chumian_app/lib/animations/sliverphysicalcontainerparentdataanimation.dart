...
/// Sliver physical container parent data animation widget
class SliverPhysicalContainerParentDataAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverPhysicalContainerParentDataAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverPhysicalContainerParentDataAnimation> createState() => _SliverPhysicalContainerParentDataAnimationState();
}

class _SliverPhysicalContainerParentDataAnimationState extends State<SliverPhysicalContainerParentDataAnimation> with SingleTickerProviderStateMixin {
