...
class SliverAppBarDelegate2Animation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarDelegate2Animation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarDelegate2Animation> createState() => _SliverAppBarDelegate2AnimationState();
}

class _SliverAppBarDelegate2AnimationState extends State<SliverAppBarDelegate2Animation> with SingleTickerProviderStateMixin {
