...
/// Zoom in up animation widget
class ZoomInUpAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ZoomInUpAnimation> createState() => _ZoomInUpAnimationState();
}

class _ZoomInUpAnimationState extends State<ZoomInUpAnimation> with SingleTickerProviderStateMixin {
