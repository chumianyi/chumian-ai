...
/// Sliver safe area animation widget
class SliverSafeAreaAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SliverSafeAreaAnimation> createState() => _SliverSafeAreaAnimationState();
}

class _SliverSafeAreaAnimationState extends State<SliverSafeAreaAnimation> with SingleTickerProviderStateMixin {
