...
/// Sliver grid delegate animation widget
class SliverGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverGridDelegateAnimation> createState() => _SliverGridDelegateAnimationState();
}

class _SliverGridDelegateAnimationState extends State<SliverGridDelegateAnimation> with SingleTickerProviderStateMixin {
