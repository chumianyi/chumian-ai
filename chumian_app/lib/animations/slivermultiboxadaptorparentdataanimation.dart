...
/// Sliver multi box adaptor parent data animation widget
class SliverMultiBoxAdaptorParentDataAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverMultiBoxAdaptorParentDataAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverMultiBoxAdaptorParentDataAnimation> createState() => _SliverMultiBoxAdaptorParentDataAnimationState();
}

class _SliverMultiBoxAdaptorParentDataAnimationState extends State<SliverMultiBoxAdaptorParentDataAnimation> with SingleTickerProviderStateMixin {
