...
/// Relative position animation widget
class RelativePositionAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RelativePositionAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RelativePositionAnimation> createState() => _RelativePositionAnimationState();
}

class _RelativePositionAnimationState extends State<RelativePositionAnimation> with SingleTickerProviderStateMixin {
