...
/// Light speed in animation widget
class LightSpeedInAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<LightSpeedInAnimation> createState() => _LightSpeedInAnimationState();
}

class _LightSpeedInAnimationState extends State<LightSpeedInAnimation> with SingleTickerProviderStateMixin {
