...
/// Rotate out up right animation widget
class RotateOutUpRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateOutUpRightAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateOutUpRightAnimation> createState() => _RotateOutUpRightAnimationState();
}

class _RotateOutUpRightAnimationState extends State<RotateOutUpRightAnimation> with SingleTickerProviderStateMixin {
