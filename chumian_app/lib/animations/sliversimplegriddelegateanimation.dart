...
/// Sliver simple grid delegate animation widget
class SliverSimpleGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverSimpleGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverSimpleGridDelegateAnimation> createState() => _SliverSimpleGridDelegateAnimationState();
}

class _SliverSimpleGridDelegateAnimationState extends State<SliverSimpleGridDelegateAnimation> with SingleTickerProviderStateMixin {
