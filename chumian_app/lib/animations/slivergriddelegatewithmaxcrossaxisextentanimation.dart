...
/// Sliver grid delegate with max cross axis extent animation widget
class SliverGridDelegateWithMaxCrossAxisExtentAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverGridDelegateWithMaxCrossAxisExtentAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverGridDelegateWithMaxCrossAxisExtentAnimation> createState() => _SliverGridDelegateWithMaxCrossAxisExtentAnimationState();
}

class _SliverGridDelegateWithMaxCrossAxisExtentAnimationState extends State<SliverGridDelegateWithMaxCrossAxisExtentAnimation> with SingleTickerProviderStateMixin {
