...
class MaterialAnimation extends StatefulWidget {
  ...
  @override
  State<MaterialAnimation> createState() => _MaterialAnimationState();
}

class _MaterialAnimationState extends State<MaterialAnimation> with SingleTickerProviderStateMixin {
