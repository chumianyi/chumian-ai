...
/// Sliver ignore pointer animation widget
class SliverIgnorePointerAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverIgnorePointerAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverIgnorePointerAnimation> createState() => _SliverIgnorePointerAnimationState();
}

class _SliverIgnorePointerAnimationState extends State<SliverIgnorePointerAnimation> with SingleTickerProviderStateMixin {
