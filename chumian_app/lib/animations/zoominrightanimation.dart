...
/// Zoom in right animation widget
class ZoomInRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ZoomInRightAnimation> createState() => _ZoomInRightAnimationState();
}

class _ZoomInRightAnimationState extends State<ZoomInRightAnimation> with SingleTickerProviderStateMixin {
