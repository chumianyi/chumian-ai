...
/// Sliver absorb pointer animation widget
class SliverAbsorbPointerAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAbsorbPointerAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAbsorbPointerAnimation> createState() => _SliverAbsorbPointerAnimationState();
}

class _SliverAbsorbPointerAnimationState extends State<SliverAbsorbPointerAnimation> with SingleTickerProviderStateMixin {
