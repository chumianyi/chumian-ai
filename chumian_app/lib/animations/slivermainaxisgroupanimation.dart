...
/// Sliver main axis group animation widget
class SliverMainAxisGroupAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverMainAxisGroupAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverMainAxisGroupAnimation> createState() => _SliverMainAxisGroupAnimationState();
}

class _SliverMainAxisGroupAnimationState extends State<SliverMainAxisGroupAnimation> with SingleTickerProviderStateMixin {
