...
/// Fade out up animation widget
class FadeOutUpAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutUpAnimation> createState() => _FadeOutUpAnimationState();
}

class _FadeOutUpAnimationState extends State<FadeOutUpAnimation> with SingleTickerProviderStateMixin {
