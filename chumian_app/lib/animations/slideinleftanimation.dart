...
/// Slide in left animation widget
class SlideInLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SlideInLeftAnimation> createState() => _SlideInLeftAnimationState();
}

class _SlideInLeftAnimationState extends State<SlideInLeftAnimation> with SingleTickerProviderStateMixin {
