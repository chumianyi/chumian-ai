...
/// Sliver overlap absorber animation widget
class SliverOverlapAbsorberAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverOverlapAbsorberAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverOverlapAbsorberAnimation> createState() => _SliverOverlapAbsorberAnimationState();
}

class _SliverOverlapAbsorberAnimationState extends State<SliverOverlapAbsorberAnimation> with SingleTickerProviderStateMixin {
