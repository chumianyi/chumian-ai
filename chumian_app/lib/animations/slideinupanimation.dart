...
/// Slide in up animation widget
class SlideInUpAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<SlideInUpAnimation> createState() => _SlideInUpAnimationState();
}

class _SlideInUpAnimationState extends State<SlideInUpAnimation> with SingleTickerProviderStateMixin {
