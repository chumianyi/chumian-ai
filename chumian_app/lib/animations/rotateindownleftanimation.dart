...
/// Rotate in down left animation widget
class RotateInDownLeftAnimation extends StatefulWidget {
  final Widget child;
  ...
  const RotateInDownLeftAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<RotateInDownLeftAnimation> createState() => _RotateInDownLeftAnimationState();
}

class _RotateInDownLeftAnimationState extends State<RotateInDownLeftAnimation> with SingleTickerProviderStateMixin {
