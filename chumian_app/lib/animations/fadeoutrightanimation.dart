...
/// Fade out right animation widget
class FadeOutRightAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<FadeOutRightAnimation> createState() => _FadeOutRightAnimationState();
}

class _FadeOutRightAnimationState extends State<FadeOutRightAnimation> with SingleTickerProviderStateMixin {
