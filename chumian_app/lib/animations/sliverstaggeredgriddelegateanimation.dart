...
/// Sliver staggered grid delegate animation widget
class SliverStaggeredGridDelegateAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverStaggeredGridDelegateAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverStaggeredGridDelegateAnimation> createState() => _SliverStaggeredGridDelegateAnimationState();
}

class _SliverStaggeredGridDelegateAnimationState extends State<SliverStaggeredGridDelegateAnimation> with SingleTickerProviderStateMixin {
