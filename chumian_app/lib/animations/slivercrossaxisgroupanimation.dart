...
/// Sliver cross axis group animation widget
class SliverCrossAxisGroupAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverCrossAxisGroupAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverCrossAxisGroupAnimation> createState() => _SliverCrossAxisGroupAnimationState();
}

class _SliverCrossAxisGroupAnimationState extends State<SliverCrossAxisGroupAnimation> with SingleTickerProviderStateMixin {
