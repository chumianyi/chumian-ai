...
/// Sliver fill remaining overscroll animation widget
class SliverFillRemainingOverscrollAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverFillRemainingOverscrollAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverFillRemainingOverscrollAnimation> createState() => _SliverFillRemainingOverscrollAnimationState();
}

class _SliverFillRemainingOverscrollAnimationState extends State<SliverFillRemainingOverscrollAnimation> with SingleTickerProviderStateMixin {
