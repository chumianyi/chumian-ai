...
/// Sliver app bar builder animation widget
class SliverAppBarBuilderAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverAppBarBuilderAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverAppBarBuilderAnimation> createState() => _SliverAppBarBuilderAnimationState();
}

class _SliverAppBarBuilderAnimationState extends State<SliverAppBarBuilderAnimation> with SingleTickerProviderStateMixin {
