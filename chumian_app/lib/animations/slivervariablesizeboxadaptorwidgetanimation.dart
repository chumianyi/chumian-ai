...
/// Sliver variable size box adaptor widget animation widget
class SliverVariableSizeBoxAdaptorWidgetAnimation extends StatefulWidget {
  final Widget child;
  ...
  const SliverVariableSizeBoxAdaptorWidgetAnimation({
    super.key,
    required this.child,
  ...
  @override
  State<SliverVariableSizeBoxAdaptorWidgetAnimation> createState() => _SliverVariableSizeBoxAdaptorWidgetAnimationState();
}

class _SliverVariableSizeBoxAdaptorWidgetAnimationState extends State<SliverVariableSizeBoxAdaptorWidgetAnimation> with SingleTickerProviderStateMixin {
