...
/// Reorderable animation widget
class ReorderableAnimation extends StatefulWidget {
  final Widget child;
  ...
  @override
  State<ReorderableAnimation> createState() => _ReorderableAnimationState();
}

class _ReorderableAnimationState extends State<ReorderableAnimation> with SingleTickerProviderStateMixin {
