...
/// Pink themed code deployment button
class PinkCodeDeploymentButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDeploymentButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDeploymentButton> createState() => _PinkCodeDeploymentButtonState();
}

class _PinkCodeDeploymentButtonState extends State<PinkCodeDeploymentButton> with SingleTickerProviderStateMixin {
