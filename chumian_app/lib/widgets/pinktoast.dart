...
/// Pink themed toast
class PinkToast extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkToast> createState() => _PinkToastState();
}

class _PinkToastState extends State<PinkToast> with SingleTickerProviderStateMixin {
