...
/// Pink themed code cloud-agnostic search button
class PinkCodeCloudAgnosticSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudAgnosticSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudAgnosticSearchButton> createState() => _PinkCodeCloudAgnosticSearchButtonState();
}

class _PinkCodeCloudAgnosticSearchButtonState extends State<PinkCodeCloudAgnosticSearchButton> with SingleTickerProviderStateMixin {
