...
/// Pink themed code cloud-monitoring search button
class PinkCodeCloudMonitoringSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudMonitoringSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudMonitoringSearchButton> createState() => _PinkCodeCloudMonitoringSearchButtonState();
}

class _PinkCodeCloudMonitoringSearchButtonState extends State<PinkCodeCloudMonitoringSearchButton> with SingleTickerProviderStateMixin {
