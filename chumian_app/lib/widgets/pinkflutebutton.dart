...
/// Pink themed flute button
class PinkFluteButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkFluteButton> createState() => _PinkFluteButtonState();
}

class _PinkFluteButtonState extends State<PinkFluteButton> with SingleTickerProviderStateMixin {
