...
/// Pink themed code refactoring button
class PinkCodeRefactoringButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRefactoringButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRefactoringButton> createState() => _PinkCodeRefactoringButtonState();
}

class _PinkCodeRefactoringButtonState extends State<PinkCodeRefactoringButton> with SingleTickerProviderStateMixin {
