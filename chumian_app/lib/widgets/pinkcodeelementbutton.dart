...
/// Pink themed code element button
class PinkCodeElementButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeElementButton> createState() => _PinkCodeElementButtonState();
}

class _PinkCodeElementButtonState extends State<PinkCodeElementButton> with SingleTickerProviderStateMixin {
