...
/// Pink themed code cloud-data-lineage search button
class PinkCodeCloudDataLineageSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataLineageSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataLineageSearchButton> createState() => _PinkCodeCloudDataLineageSearchButtonState();
}

class _PinkCodeCloudDataLineageSearchButtonState extends State<PinkCodeCloudDataLineageSearchButton> with SingleTickerProviderStateMixin {
