...
/// Pink themed code tracing button
class PinkCodeTracingButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeTracingButton> createState() => _PinkCodeTracingButtonState();
}

class _PinkCodeTracingButtonState extends State<PinkCodeTracingButton> with SingleTickerProviderStateMixin {
