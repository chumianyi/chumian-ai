...
/// Pink themed code load balanced search button
class PinkCodeLoadBalancedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeLoadBalancedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeLoadBalancedSearchButton> createState() => _PinkCodeLoadBalancedSearchButtonState();
}

class _PinkCodeLoadBalancedSearchButtonState extends State<PinkCodeLoadBalancedSearchButton> with SingleTickerProviderStateMixin {
