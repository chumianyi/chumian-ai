...
/// Pink themed code testing automation button
class PinkCodeTestingAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeTestingAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeTestingAutomationButton> createState() => _PinkCodeTestingAutomationButtonState();
}

class _PinkCodeTestingAutomationButtonState extends State<PinkCodeTestingAutomationButton> with SingleTickerProviderStateMixin {
