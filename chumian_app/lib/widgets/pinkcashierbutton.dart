...
/// Pink themed cashier button
class PinkCashierButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCashierButton> createState() => _PinkCashierButtonState();
}

class _PinkCashierButtonState extends State<PinkCashierButton> with SingleTickerProviderStateMixin {
