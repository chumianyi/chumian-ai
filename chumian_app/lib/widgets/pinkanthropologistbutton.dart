...
/// Pink themed anthropologist button
class PinkAnthropologistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkAnthropologistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkAnthropologistButton> createState() => _PinkAnthropologistButtonState();
}

class _PinkAnthropologistButtonState extends State<PinkAnthropologistButton> with SingleTickerProviderStateMixin {
