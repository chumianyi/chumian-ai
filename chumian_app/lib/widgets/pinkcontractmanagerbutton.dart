...
/// Pink themed contract manager button
class PinkContractManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkContractManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkContractManagerButton> createState() => _PinkContractManagerButtonState();
}

class _PinkContractManagerButtonState extends State<PinkContractManagerButton> with SingleTickerProviderStateMixin {
