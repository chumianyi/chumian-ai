...
/// Pink themed code cloud-data-residency search button
class PinkCodeCloudDataResidencySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataResidencySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataResidencySearchButton> createState() => _PinkCodeCloudDataResidencySearchButtonState();
}

class _PinkCodeCloudDataResidencySearchButtonState extends State<PinkCodeCloudDataResidencySearchButton> with SingleTickerProviderStateMixin {
