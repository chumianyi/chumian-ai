...
/// Pink themed network admin button
class PinkNetworkAdminButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNetworkAdminButton> createState() => _PinkNetworkAdminButtonState();
}

class _PinkNetworkAdminButtonState extends State<PinkNetworkAdminButton> with SingleTickerProviderStateMixin {
