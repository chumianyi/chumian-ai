...
/// Pink themed machine learning button
class PinkMachineLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMachineLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMachineLearningButton> createState() => _PinkMachineLearningButtonState();
}

class _PinkMachineLearningButtonState extends State<PinkMachineLearningButton> with SingleTickerProviderStateMixin {
