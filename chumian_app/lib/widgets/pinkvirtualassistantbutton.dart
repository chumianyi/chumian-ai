...
/// Pink themed virtual assistant button
class PinkVirtualAssistantButton extends StatefulWidget {
  final String? text;
  ...
  const PinkVirtualAssistantButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkVirtualAssistantButton> createState() => _PinkVirtualAssistantButtonState();
}

class _PinkVirtualAssistantButtonState extends State<PinkVirtualAssistantButton> with SingleTickerProviderStateMixin {
