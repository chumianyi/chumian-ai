...
/// Pink themed reporter button
class PinkReporterButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkReporterButton> createState() => _PinkReporterButtonState();
}

class _PinkReporterButtonState extends State<PinkReporterButton> with SingleTickerProviderStateMixin {
