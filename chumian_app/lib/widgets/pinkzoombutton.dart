...
/// Pink themed zoom button
class PinkZoomButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkZoomButton> createState() => _PinkZoomButtonState();
}

class _PinkZoomButtonState extends State<PinkZoomButton> with SingleTickerProviderStateMixin {
