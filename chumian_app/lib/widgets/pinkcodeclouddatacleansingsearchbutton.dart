...
/// Pink themed code cloud-data-cleansing search button
class PinkCodeCloudDataCleansingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataCleansingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataCleansingSearchButton> createState() => _PinkCodeCloudDataCleansingSearchButtonState();
}

class _PinkCodeCloudDataCleansingSearchButtonState extends State<PinkCodeCloudDataCleansingSearchButton> with SingleTickerProviderStateMixin {
