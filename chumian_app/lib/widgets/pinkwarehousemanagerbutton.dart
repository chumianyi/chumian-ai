...
/// Pink themed warehouse manager button
class PinkWarehouseManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkWarehouseManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkWarehouseManagerButton> createState() => _PinkWarehouseManagerButtonState();
}

class _PinkWarehouseManagerButtonState extends State<PinkWarehouseManagerButton> with SingleTickerProviderStateMixin {
