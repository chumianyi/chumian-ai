...
/// Pink themed writer button
class PinkWriterButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkWriterButton> createState() => _PinkWriterButtonState();
}

class _PinkWriterButtonState extends State<PinkWriterButton> with SingleTickerProviderStateMixin {
