...
/// Pink themed user researcher button
class PinkUserResearcherButton extends StatefulWidget {
  final String? text;
  ...
  const PinkUserResearcherButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkUserResearcherButton> createState() => _PinkUserResearcherButtonState();
}

class _PinkUserResearcherButtonState extends State<PinkUserResearcherButton> with SingleTickerProviderStateMixin {
