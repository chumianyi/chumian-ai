...
/// Pink themed code cloud-recommendations search button
class PinkCodeCloudRecommendationsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRecommendationsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRecommendationsSearchButton> createState() => _PinkCodeCloudRecommendationsSearchButtonState();
}

class _PinkCodeCloudRecommendationsSearchButtonState extends State<PinkCodeCloudRecommendationsSearchButton> with SingleTickerProviderStateMixin {
