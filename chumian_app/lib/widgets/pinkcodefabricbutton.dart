...
/// Pink themed code fabric button
class PinkCodeFabricButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeFabricButton> createState() => _PinkCodeFabricButtonState();
}

class _PinkCodeFabricButtonState extends State<PinkCodeFabricButton> with SingleTickerProviderStateMixin {
