...
/// Pink themed USB button
class PinkUsbButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkUsbButton> createState() => _PinkUsbButtonState();
}

class _PinkUsbButtonState extends State<PinkUsbButton> with SingleTickerProviderStateMixin {
