...
/// Pink themed image recognition button
class PinkImageRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkImageRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkImageRecognitionButton> createState() => _PinkImageRecognitionButtonState();
}

class _PinkImageRecognitionButtonState extends State<PinkImageRecognitionButton> with SingleTickerProviderStateMixin {
