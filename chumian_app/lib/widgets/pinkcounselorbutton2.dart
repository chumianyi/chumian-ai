...
/// Pink themed counselor button
class PinkCounselorButton2 extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCounselorButton2> createState() => _PinkCounselorButton2State();
}

class _PinkCounselorButton2State extends State<PinkCounselorButton2> with SingleTickerProviderStateMixin {
