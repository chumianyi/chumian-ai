...
/// Pink themed store manager button
class PinkStoreManagerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkStoreManagerButton> createState() => _PinkStoreManagerButtonState();
}

class _PinkStoreManagerButtonState extends State<PinkStoreManagerButton> with SingleTickerProviderStateMixin {
