...
/// Pink themed pose estimation button
class PinkPoseEstimationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPoseEstimationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPoseEstimationButton> createState() => _PinkPoseEstimationButtonState();
}

class _PinkPoseEstimationButtonState extends State<PinkPoseEstimationButton> with SingleTickerProviderStateMixin {
