...
/// Pink themed DJ button
class PinkDjButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDjButton> createState() => _PinkDjButtonState();
}

class _PinkDjButtonState extends State<PinkDjButton> with SingleTickerProviderStateMixin {
