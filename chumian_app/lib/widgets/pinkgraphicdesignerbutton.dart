...
/// Pink themed graphic designer button
class PinkGraphicDesignerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkGraphicDesignerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkGraphicDesignerButton> createState() => _PinkGraphicDesignerButtonState();
}

class _PinkGraphicDesignerButtonState extends State<PinkGraphicDesignerButton> with SingleTickerProviderStateMixin {
