...
/// Pink themed list view
class PinkListView extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkListView> createState() => _PinkListViewState();
}

class _PinkListViewState extends State<PinkListView> with SingleTickerProviderStateMixin {
