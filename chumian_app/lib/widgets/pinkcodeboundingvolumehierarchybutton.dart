...
/// Pink themed code BVH button
class PinkCodeBoundingVolumeHierarchyButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeBoundingVolumeHierarchyButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeBoundingVolumeHierarchyButton> createState() => _PinkCodeBoundingVolumeHierarchyButtonState();
}

class _PinkCodeBoundingVolumeHierarchyButtonState extends State<PinkCodeBoundingVolumeHierarchyButton> with SingleTickerProviderStateMixin {
