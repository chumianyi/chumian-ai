...
/// Pink themed shuffle button
class PinkShuffleButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkShuffleButton> createState() => _PinkShuffleButtonState();
}

class _PinkShuffleButtonState extends State<PinkShuffleButton> with SingleTickerProviderStateMixin {
