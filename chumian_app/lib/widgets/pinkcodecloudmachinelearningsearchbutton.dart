...
/// Pink themed code cloud-machine-learning search button
class PinkCodeCloudMachineLearningSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudMachineLearningSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudMachineLearningSearchButton> createState() => _PinkCodeCloudMachineLearningSearchButtonState();
}

class _PinkCodeCloudMachineLearningSearchButtonState extends State<PinkCodeCloudMachineLearningSearchButton> with SingleTickerProviderStateMixin {
