...
/// Pink themed code bloom filter button
class PinkCodeBloomFilterButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeBloomFilterButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeBloomFilterButton> createState() => _PinkCodeBloomFilterButtonState();
}

class _PinkCodeBloomFilterButtonState extends State<PinkCodeBloomFilterButton> with SingleTickerProviderStateMixin {
