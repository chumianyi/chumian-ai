...
/// Pink themed code cloud-data-alerting search button
class PinkCodeCloudDataAlertingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataAlertingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataAlertingSearchButton> createState() => _PinkCodeCloudDataAlertingSearchButtonState();
}

class _PinkCodeCloudDataAlertingSearchButtonState extends State<PinkCodeCloudDataAlertingSearchButton> with SingleTickerProviderStateMixin {
