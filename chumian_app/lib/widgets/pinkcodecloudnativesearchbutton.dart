...
/// Pink themed code cloud-native search button
class PinkCodeCloudNativeSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudNativeSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudNativeSearchButton> createState() => _PinkCodeCloudNativeSearchButtonState();
}

class _PinkCodeCloudNativeSearchButtonState extends State<PinkCodeCloudNativeSearchButton> with SingleTickerProviderStateMixin {
