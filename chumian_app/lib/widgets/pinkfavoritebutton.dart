...
/// Pink themed favorite button
class PinkFavoriteButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkFavoriteButton> createState() => _PinkFavoriteButtonState();
}

class _PinkFavoriteButtonState extends State<PinkFavoriteButton> with SingleTickerProviderStateMixin {
