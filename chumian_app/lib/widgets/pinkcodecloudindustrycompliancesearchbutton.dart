...
/// Pink themed code cloud-industry-compliance search button
class PinkCodeCloudIndustryComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudIndustryComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudIndustryComplianceSearchButton> createState() => _PinkCodeCloudIndustryComplianceSearchButtonState();
}

class _PinkCodeCloudIndustryComplianceSearchButtonState extends State<PinkCodeCloudIndustryComplianceSearchButton> with SingleTickerProviderStateMixin {
