...
/// Pink themed next button
class PinkNextButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNextButton> createState() => _PinkNextButtonState();
}

class _PinkNextButtonState extends State<PinkNextButton> with SingleTickerProviderStateMixin {
