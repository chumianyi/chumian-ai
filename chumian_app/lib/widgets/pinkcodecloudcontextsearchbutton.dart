...
/// Pink themed code cloud-context search button
class PinkCodeCloudContextSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudContextSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudContextSearchButton> createState() => _PinkCodeCloudContextSearchButtonState();
}

class _PinkCodeCloudContextSearchButtonState extends State<PinkCodeCloudContextSearchButton> with SingleTickerProviderStateMixin {
