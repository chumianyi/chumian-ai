...
/// Pink themed object detection button
class PinkObjectDetectionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkObjectDetectionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkObjectDetectionButton> createState() => _PinkObjectDetectionButtonState();
}

class _PinkObjectDetectionButtonState extends State<PinkObjectDetectionButton> with SingleTickerProviderStateMixin {
