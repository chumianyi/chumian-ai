...
/// Pink themed facial recognition button
class PinkFacialRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFacialRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFacialRecognitionButton> createState() => _PinkFacialRecognitionButtonState();
}

class _PinkFacialRecognitionButtonState extends State<PinkFacialRecognitionButton> with SingleTickerProviderStateMixin {
