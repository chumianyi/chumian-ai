...
/// Pink themed QR button
class PinkQrButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkQrButton> createState() => _PinkQrButtonState();
}

class _PinkQrButtonState extends State<PinkQrButton> with SingleTickerProviderStateMixin {
