...
/// Pink themed code cloud-data-retention search button
class PinkCodeCloudDataRetentionSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataRetentionSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataRetentionSearchButton> createState() => _PinkCodeCloudDataRetentionSearchButtonState();
}

class _PinkCodeCloudDataRetentionSearchButtonState extends State<PinkCodeCloudDataRetentionSearchButton> with SingleTickerProviderStateMixin {
