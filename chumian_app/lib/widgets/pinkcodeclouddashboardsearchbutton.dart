...
/// Pink themed code cloud-dashboard search button
class PinkCodeCloudDashboardSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDashboardSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDashboardSearchButton> createState() => _PinkCodeCloudDashboardSearchButtonState();
}

class _PinkCodeCloudDashboardSearchButtonState extends State<PinkCodeCloudDashboardSearchButton> with SingleTickerProviderStateMixin {
