...
/// Pink themed reporting analyst button
class PinkReportingAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkReportingAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkReportingAnalystButton> createState() => _PinkReportingAnalystButtonState();
}

class _PinkReportingAnalystButtonState extends State<PinkReportingAnalystButton> with SingleTickerProviderStateMixin {
