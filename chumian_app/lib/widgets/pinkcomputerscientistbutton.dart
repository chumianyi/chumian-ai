...
/// Pink themed computer scientist button
class PinkComputerScientistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkComputerScientistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkComputerScientistButton> createState() => _PinkComputerScientistButtonState();
}

class _PinkComputerScientistButtonState extends State<PinkComputerScientistButton> with SingleTickerProviderStateMixin {
