...
/// Pink themed voice call button
class PinkVoiceCallButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkVoiceCallButton> createState() => _PinkVoiceCallButtonState();
}

class _PinkVoiceCallButtonState extends State<PinkVoiceCallButton> with SingleTickerProviderStateMixin {
