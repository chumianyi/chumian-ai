...
/// Pink themed code cloud-anomaly-detection search button
class PinkCodeCloudAnomalyDetectionSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudAnomalyDetectionSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudAnomalyDetectionSearchButton> createState() => _PinkCodeCloudAnomalyDetectionSearchButtonState();
}

class _PinkCodeCloudAnomalyDetectionSearchButtonState extends State<PinkCodeCloudAnomalyDetectionSearchButton> with SingleTickerProviderStateMixin {
