...
/// Pink themed code spatial hash button
class PinkCodeSpatialHashButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSpatialHashButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSpatialHashButton> createState() => _PinkCodeSpatialHashButtonState();
}

class _PinkCodeSpatialHashButtonState extends State<PinkCodeSpatialHashButton> with SingleTickerProviderStateMixin {
