...
/// Pink themed reset button
class PinkResetButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkResetButton> createState() => _PinkResetButtonState();
}

class _PinkResetButtonState extends State<PinkResetButton> with SingleTickerProviderStateMixin {
