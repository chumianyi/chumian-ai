...
/// Pink themed code interpretation button
class PinkCodeInterpretationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeInterpretationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeInterpretationButton> createState() => _PinkCodeInterpretationButtonState();
}

class _PinkCodeInterpretationButtonState extends State<PinkCodeInterpretationButton> with SingleTickerProviderStateMixin {
