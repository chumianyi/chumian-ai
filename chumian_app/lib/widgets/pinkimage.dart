...
/// Pink themed image with fade
class PinkImage extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkImage> createState() => _PinkImageState();
}

class _PinkImageState extends State<PinkImage> with SingleTickerProviderStateMixin {
