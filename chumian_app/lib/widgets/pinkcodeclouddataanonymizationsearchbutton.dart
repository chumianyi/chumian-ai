...
/// Pink themed code cloud-data-anonymization search button
class PinkCodeCloudDataAnonymizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataAnonymizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataAnonymizationSearchButton> createState() => _PinkCodeCloudDataAnonymizationSearchButtonState();
}

class _PinkCodeCloudDataAnonymizationSearchButtonState extends State<PinkCodeCloudDataAnonymizationSearchButton> with SingleTickerProviderStateMixin {
