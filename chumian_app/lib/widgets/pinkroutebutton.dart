...
/// Pink themed route button
class PinkRouteButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRouteButton> createState() => _PinkRouteButtonState();
}

class _PinkRouteButtonState extends State<PinkRouteButton> with SingleTickerProviderStateMixin {
