...
/// Pink themed code retry search button
class PinkCodeRetrySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRetrySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRetrySearchButton> createState() => _PinkCodeRetrySearchButtonState();
}

class _PinkCodeRetrySearchButtonState extends State<PinkCodeRetrySearchButton> with SingleTickerProviderStateMixin {
