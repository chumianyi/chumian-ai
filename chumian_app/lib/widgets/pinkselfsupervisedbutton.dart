...
/// Pink themed self-supervised button
class PinkSelfSupervisedButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSelfSupervisedButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSelfSupervisedButton> createState() => _PinkSelfSupervisedButtonState();
}

class _PinkSelfSupervisedButtonState extends State<PinkSelfSupervisedButton> with SingleTickerProviderStateMixin {
