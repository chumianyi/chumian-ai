...
/// Pink themed active learning button
class PinkActiveLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkActiveLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkActiveLearningButton> createState() => _PinkActiveLearningButtonState();
}

class _PinkActiveLearningButtonState extends State<PinkActiveLearningButton> with SingleTickerProviderStateMixin {
