...
/// Pink themed image-to-text button
class PinkImageToTextButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkImageToTextButton> createState() => _PinkImageToTextButtonState();
}

class _PinkImageToTextButtonState extends State<PinkImageToTextButton> with SingleTickerProviderStateMixin {
