...
/// Pink themed alarm button
class PinkAlarmButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAlarmButton> createState() => _PinkAlarmButtonState();
}

class _PinkAlarmButtonState extends State<PinkAlarmButton> with SingleTickerProviderStateMixin {
