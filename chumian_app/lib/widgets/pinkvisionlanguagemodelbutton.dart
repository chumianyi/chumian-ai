...
/// Pink themed VLM button
class PinkVisionLanguageModelButton extends StatefulWidget {
  final String? text;
  ...
  const PinkVisionLanguageModelButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkVisionLanguageModelButton> createState() => _PinkVisionLanguageModelButtonState();
}

class _PinkVisionLanguageModelButtonState extends State<PinkVisionLanguageModelButton> with SingleTickerProviderStateMixin {
