...
/// Pink themed code cloud-tracing search button
class PinkCodeCloudTracingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudTracingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudTracingSearchButton> createState() => _PinkCodeCloudTracingSearchButtonState();
}

class _PinkCodeCloudTracingSearchButtonState extends State<PinkCodeCloudTracingSearchButton> with SingleTickerProviderStateMixin {
