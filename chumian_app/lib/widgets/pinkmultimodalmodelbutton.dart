...
/// Pink themed multimodal model button
class PinkMultimodalModelButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMultimodalModelButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMultimodalModelButton> createState() => _PinkMultimodalModelButtonState();
}

class _PinkMultimodalModelButtonState extends State<PinkMultimodalModelButton> with SingleTickerProviderStateMixin {
