...
/// Pink themed code cloud-data-catalog search button
class PinkCodeCloudDataCatalogSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataCatalogSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataCatalogSearchButton> createState() => _PinkCodeCloudDataCatalogSearchButtonState();
}

class _PinkCodeCloudDataCatalogSearchButtonState extends State<PinkCodeCloudDataCatalogSearchButton> with SingleTickerProviderStateMixin {
