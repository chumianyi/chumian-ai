...
/// Pink themed code distributed search button
class PinkCodeDistributedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDistributedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDistributedSearchButton> createState() => _PinkCodeDistributedSearchButtonState();
}

class _PinkCodeDistributedSearchButtonState extends State<PinkCodeDistributedSearchButton> with SingleTickerProviderStateMixin {
