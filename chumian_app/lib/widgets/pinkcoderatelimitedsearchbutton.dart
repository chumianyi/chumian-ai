...
/// Pink themed code rate limited search button
class PinkCodeRateLimitedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRateLimitedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRateLimitedSearchButton> createState() => _PinkCodeRateLimitedSearchButtonState();
}

class _PinkCodeRateLimitedSearchButtonState extends State<PinkCodeRateLimitedSearchButton> with SingleTickerProviderStateMixin {
