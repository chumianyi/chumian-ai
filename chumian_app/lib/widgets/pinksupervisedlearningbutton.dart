...
/// Pink themed supervised learning button
class PinkSupervisedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSupervisedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSupervisedLearningButton> createState() => _PinkSupervisedLearningButtonState();
}

class _PinkSupervisedLearningButtonState extends State<PinkSupervisedLearningButton> with SingleTickerProviderStateMixin {
