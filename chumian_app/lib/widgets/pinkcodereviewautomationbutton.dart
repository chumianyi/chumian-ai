...
/// Pink themed code review automation button
class PinkCodeReviewAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeReviewAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeReviewAutomationButton> createState() => _PinkCodeReviewAutomationButtonState();
}

class _PinkCodeReviewAutomationButtonState extends State<PinkCodeReviewAutomationButton> with SingleTickerProviderStateMixin {
