...
/// Pink themed pilot button
class PinkPilotButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPilotButton> createState() => _PinkPilotButtonState();
}

class _PinkPilotButtonState extends State<PinkPilotButton> with SingleTickerProviderStateMixin {
