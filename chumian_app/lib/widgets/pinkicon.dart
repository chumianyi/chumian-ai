...
/// Pink themed icon
class PinkIcon extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkIcon> createState() => _PinkIconState();
}

class _PinkIconState extends State<PinkIcon> with SingleTickerProviderStateMixin {
