...
/// Pink themed code cloud-data-dashboard search button
class PinkCodeCloudDataDashboardSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataDashboardSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataDashboardSearchButton> createState() => _PinkCodeCloudDataDashboardSearchButtonState();
}

class _PinkCodeCloudDataDashboardSearchButtonState extends State<PinkCodeCloudDataDashboardSearchButton> with SingleTickerProviderStateMixin {
