...
/// Pink themed code range tree button
class PinkCodeRangeTreeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeRangeTreeButton> createState() => _PinkCodeRangeTreeButtonState();
}

class _PinkCodeRangeTreeButtonState extends State<PinkCodeRangeTreeButton> with SingleTickerProviderStateMixin {
