...
/// Pink themed scout button
class PinkScoutButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkScoutButton> createState() => _PinkScoutButtonState();
}

class _PinkScoutButtonState extends State<PinkScoutButton> with SingleTickerProviderStateMixin {
