...
/// Pink themed HR button
class PinkHrButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkHrButton> createState() => _PinkHrButtonState();
}

class _PinkHrButtonState extends State<PinkHrButton> with SingleTickerProviderStateMixin {
