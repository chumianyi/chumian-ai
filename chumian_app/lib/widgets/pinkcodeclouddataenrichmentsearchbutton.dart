...
/// Pink themed code cloud-data-enrichment search button
class PinkCodeCloudDataEnrichmentSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataEnrichmentSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataEnrichmentSearchButton> createState() => _PinkCodeCloudDataEnrichmentSearchButtonState();
}

class _PinkCodeCloudDataEnrichmentSearchButtonState extends State<PinkCodeCloudDataEnrichmentSearchButton> with SingleTickerProviderStateMixin {
