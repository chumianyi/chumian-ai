...
/// Pink themed code succinct data structure button
class PinkCodeSuccinctDataStructureButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSuccinctDataStructureButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSuccinctDataStructureButton> createState() => _PinkCodeSuccinctDataStructureButtonState();
}

class _PinkCodeSuccinctDataStructureButtonState extends State<PinkCodeSuccinctDataStructureButton> with SingleTickerProviderStateMixin {
