...
/// Pink themed code hybrid search button
class PinkCodeHybridSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeHybridSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeHybridSearchButton> createState() => _PinkCodeHybridSearchButtonState();
}

class _PinkCodeHybridSearchButtonState extends State<PinkCodeHybridSearchButton> with SingleTickerProviderStateMixin {
