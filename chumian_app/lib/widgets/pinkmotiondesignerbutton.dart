...
/// Pink themed motion designer button
class PinkMotionDesignerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMotionDesignerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMotionDesignerButton> createState() => _PinkMotionDesignerButtonState();
}

class _PinkMotionDesignerButtonState extends State<PinkMotionDesignerButton> with SingleTickerProviderStateMixin {
