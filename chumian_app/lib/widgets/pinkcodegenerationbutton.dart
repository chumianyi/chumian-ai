...
/// Pink themed code generation button
class PinkCodeGenerationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeGenerationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeGenerationButton> createState() => _PinkCodeGenerationButtonState();
}

class _PinkCodeGenerationButtonState extends State<PinkCodeGenerationButton> with SingleTickerProviderStateMixin {
