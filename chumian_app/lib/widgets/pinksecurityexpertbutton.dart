...
/// Pink themed security expert button
class PinkSecurityExpertButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSecurityExpertButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSecurityExpertButton> createState() => _PinkSecurityExpertButtonState();
}

class _PinkSecurityExpertButtonState extends State<PinkSecurityExpertButton> with SingleTickerProviderStateMixin {
