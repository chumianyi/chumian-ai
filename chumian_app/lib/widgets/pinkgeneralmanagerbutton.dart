...
/// Pink themed general manager button
class PinkGeneralManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkGeneralManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkGeneralManagerButton> createState() => _PinkGeneralManagerButtonState();
}

class _PinkGeneralManagerButtonState extends State<PinkGeneralManagerButton> with SingleTickerProviderStateMixin {
