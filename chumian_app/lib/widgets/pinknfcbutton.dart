...
/// Pink themed NFC button
class PinkNfcButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNfcButton> createState() => _PinkNfcButtonState();
}

class _PinkNfcButtonState extends State<PinkNfcButton> with SingleTickerProviderStateMixin {
