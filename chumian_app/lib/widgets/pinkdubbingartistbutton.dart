...
/// Pink themed dubbing artist button
class PinkDubbingArtistButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDubbingArtistButton> createState() => _PinkDubbingArtistButtonState();
}

class _PinkDubbingArtistButtonState extends State<PinkDubbingArtistButton> with SingleTickerProviderStateMixin {
