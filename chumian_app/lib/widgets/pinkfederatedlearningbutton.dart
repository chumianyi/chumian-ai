...
/// Pink themed federated learning button
class PinkFederatedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFederatedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFederatedLearningButton> createState() => _PinkFederatedLearningButtonState();
}

class _PinkFederatedLearningButtonState extends State<PinkFederatedLearningButton> with SingleTickerProviderStateMixin {
