...
/// Pink themed VoC analyst button
class PinkVoiceOfCustomerAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkVoiceOfCustomerAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkVoiceOfCustomerAnalystButton> createState() => _PinkVoiceOfCustomerAnalystButtonState();
}

class _PinkVoiceOfCustomerAnalystButtonState extends State<PinkVoiceOfCustomerAnalystButton> with SingleTickerProviderStateMixin {
