...
/// Pink themed policy analyst button
class PinkPolicyAnalystButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPolicyAnalystButton> createState() => _PinkPolicyAnalystButtonState();
}

class _PinkPolicyAnalystButtonState extends State<PinkPolicyAnalystButton> with SingleTickerProviderStateMixin {
