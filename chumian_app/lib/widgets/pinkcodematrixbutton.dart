...
/// Pink themed code matrix button
class PinkCodeMatrixButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeMatrixButton> createState() => _PinkCodeMatrixButtonState();
}

class _PinkCodeMatrixButtonState extends State<PinkCodeMatrixButton> with SingleTickerProviderStateMixin {
