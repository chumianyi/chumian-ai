...
/// Pink themed market research analyst button
class PinkMarketResearchAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMarketResearchAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMarketResearchAnalystButton> createState() => _PinkMarketResearchAnalystButtonState();
}

class _PinkMarketResearchAnalystButtonState extends State<PinkMarketResearchAnalystButton> with SingleTickerProviderStateMixin {
