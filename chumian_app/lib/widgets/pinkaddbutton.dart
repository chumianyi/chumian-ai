...
/// Pink themed add button
class PinkAddButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAddButton> createState() => _PinkAddButtonState();
}

class _PinkAddButtonState extends State<PinkAddButton> with SingleTickerProviderStateMixin {
