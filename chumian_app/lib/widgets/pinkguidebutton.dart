...
/// Pink themed guide button
class PinkGuideButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkGuideButton> createState() => _PinkGuideButtonState();
}

class _PinkGuideButtonState extends State<PinkGuideButton> with SingleTickerProviderStateMixin {
