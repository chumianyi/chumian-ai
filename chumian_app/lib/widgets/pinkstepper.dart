...
/// Pink themed stepper
class PinkStepper extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkStepper> createState() => _PinkStepperState();
}

class _PinkStepperState extends State<PinkStepper> with SingleTickerProviderStateMixin {
