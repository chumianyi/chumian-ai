...
/// Pink themed code remote search button
class PinkCodeRemoteSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRemoteSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRemoteSearchButton> createState() => _PinkCodeRemoteSearchButtonState();
}

class _PinkCodeRemoteSearchButtonState extends State<PinkCodeRemoteSearchButton> with SingleTickerProviderStateMixin {
