...
/// Pink themed progress indicator
class PinkProgress extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkProgress> createState() => _PinkProgressState();
}

class _PinkProgressState extends State<PinkProgress> with SingleTickerProviderStateMixin {
