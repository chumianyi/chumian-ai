...
/// Pink themed code obfuscation button
class PinkCodeObfuscationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeObfuscationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeObfuscationButton> createState() => _PinkCodeObfuscationButtonState();
}

class _PinkCodeObfuscationButtonState extends State<PinkCodeObfuscationButton> with SingleTickerProviderStateMixin {
