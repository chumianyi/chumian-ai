...
/// Pink themed code cloud-forecasting search button
class PinkCodeCloudForecastingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudForecastingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudForecastingSearchButton> createState() => _PinkCodeCloudForecastingSearchButtonState();
}

class _PinkCodeCloudForecastingSearchButtonState extends State<PinkCodeCloudForecastingSearchButton> with SingleTickerProviderStateMixin {
