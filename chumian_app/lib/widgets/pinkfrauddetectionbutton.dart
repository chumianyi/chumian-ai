...
/// Pink themed fraud detection button
class PinkFraudDetectionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFraudDetectionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFraudDetectionButton> createState() => _PinkFraudDetectionButtonState();
}

class _PinkFraudDetectionButtonState extends State<PinkFraudDetectionButton> with SingleTickerProviderStateMixin {
