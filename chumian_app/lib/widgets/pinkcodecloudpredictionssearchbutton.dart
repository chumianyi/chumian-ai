...
/// Pink themed code cloud-predictions search button
class PinkCodeCloudPredictionsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudPredictionsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudPredictionsSearchButton> createState() => _PinkCodeCloudPredictionsSearchButtonState();
}

class _PinkCodeCloudPredictionsSearchButtonState extends State<PinkCodeCloudPredictionsSearchButton> with SingleTickerProviderStateMixin {
