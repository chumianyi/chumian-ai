...
/// Pink themed prescriptive analytics button
class PinkPrescriptiveAnalyticsButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPrescriptiveAnalyticsButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPrescriptiveAnalyticsButton> createState() => _PinkPrescriptiveAnalyticsButtonState();
}

class _PinkPrescriptiveAnalyticsButtonState extends State<PinkPrescriptiveAnalyticsButton> with SingleTickerProviderStateMixin {
