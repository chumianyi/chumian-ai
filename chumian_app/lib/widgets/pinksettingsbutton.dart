...
/// Pink themed settings button
class PinkSettingsButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSettingsButton> createState() => _PinkSettingsButtonState();
}

class _PinkSettingsButtonState extends State<PinkSettingsButton> with SingleTickerProviderStateMixin {
