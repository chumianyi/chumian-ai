...
/// Pink themed code cloud-regional-compliance search button
class PinkCodeCloudRegionalComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRegionalComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRegionalComplianceSearchButton> createState() => _PinkCodeCloudRegionalComplianceSearchButtonState();
}

class _PinkCodeCloudRegionalComplianceSearchButtonState extends State<PinkCodeCloudRegionalComplianceSearchButton> with SingleTickerProviderStateMixin {
