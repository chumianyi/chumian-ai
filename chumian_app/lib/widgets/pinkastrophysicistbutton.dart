...
/// Pink themed astrophysicist button
class PinkAstrophysicistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkAstrophysicistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkAstrophysicistButton> createState() => _PinkAstrophysicistButtonState();
}

class _PinkAstrophysicistButtonState extends State<PinkAstrophysicistButton> with SingleTickerProviderStateMixin {
