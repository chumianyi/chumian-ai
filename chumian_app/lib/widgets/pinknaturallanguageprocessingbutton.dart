...
/// Pink themed NLP button
class PinkNaturalLanguageProcessingButton extends StatefulWidget {
  final String? text;
  ...
  const PinkNaturalLanguageProcessingButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkNaturalLanguageProcessingButton> createState() => _PinkNaturalLanguageProcessingButtonState();
}

class _PinkNaturalLanguageProcessingButtonState extends State<PinkNaturalLanguageProcessingButton> with SingleTickerProviderStateMixin {
