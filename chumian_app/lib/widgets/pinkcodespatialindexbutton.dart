...
/// Pink themed code spatial index button
class PinkCodeSpatialIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSpatialIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSpatialIndexButton> createState() => _PinkCodeSpatialIndexButtonState();
}

class _PinkCodeSpatialIndexButtonState extends State<PinkCodeSpatialIndexButton> with SingleTickerProviderStateMixin {
