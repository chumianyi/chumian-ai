...
/// Pink themed license manager button
class PinkLicenseManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkLicenseManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkLicenseManagerButton> createState() => _PinkLicenseManagerButtonState();
}

class _PinkLicenseManagerButtonState extends State<PinkLicenseManagerButton> with SingleTickerProviderStateMixin {
