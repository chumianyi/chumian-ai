...
/// Pink themed few-shot learning button
class PinkFewShotLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFewShotLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFewShotLearningButton> createState() => _PinkFewShotLearningButtonState();
}

class _PinkFewShotLearningButtonState extends State<PinkFewShotLearningButton> with SingleTickerProviderStateMixin {
