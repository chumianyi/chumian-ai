...
/// Pink themed cognitive computing button
class PinkCognitiveComputingButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCognitiveComputingButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCognitiveComputingButton> createState() => _PinkCognitiveComputingButtonState();
}

class _PinkCognitiveComputingButtonState extends State<PinkCognitiveComputingButton> with SingleTickerProviderStateMixin {
