...
/// Pink themed code cloud-security search button
class PinkCodeCloudSecuritySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudSecuritySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudSecuritySearchButton> createState() => _PinkCodeCloudSecuritySearchButtonState();
}

class _PinkCodeCloudSecuritySearchButtonState extends State<PinkCodeCloudSecuritySearchButton> with SingleTickerProviderStateMixin {
