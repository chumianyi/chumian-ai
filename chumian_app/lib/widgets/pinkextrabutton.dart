...
/// Pink themed extra button
class PinkExtraButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkExtraButton> createState() => _PinkExtraButtonState();
}

class _PinkExtraButtonState extends State<PinkExtraButton> with SingleTickerProviderStateMixin {
