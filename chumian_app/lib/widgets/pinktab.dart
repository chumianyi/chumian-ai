...
/// Pink themed tab
class PinkTab extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTab> createState() => _PinkTabState();
}

class _PinkTabState extends State<PinkTab> with SingleTickerProviderStateMixin {
