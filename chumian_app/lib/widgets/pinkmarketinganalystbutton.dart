...
/// Pink themed marketing analyst button
class PinkMarketingAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMarketingAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMarketingAnalystButton> createState() => _PinkMarketingAnalystButtonState();
}

class _PinkMarketingAnalystButtonState extends State<PinkMarketingAnalystButton> with SingleTickerProviderStateMixin {
