...
/// Pink themed code cloud-alerting search button
class PinkCodeCloudAlertingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudAlertingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudAlertingSearchButton> createState() => _PinkCodeCloudAlertingSearchButtonState();
}

class _PinkCodeCloudAlertingSearchButtonState extends State<PinkCodeCloudAlertingSearchButton> with SingleTickerProviderStateMixin {
