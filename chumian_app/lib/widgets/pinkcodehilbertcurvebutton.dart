...
/// Pink themed code Hilbert curve button
class PinkCodeHilbertCurveButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeHilbertCurveButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeHilbertCurveButton> createState() => _PinkCodeHilbertCurveButtonState();
}

class _PinkCodeHilbertCurveButtonState extends State<PinkCodeHilbertCurveButton> with SingleTickerProviderStateMixin {
