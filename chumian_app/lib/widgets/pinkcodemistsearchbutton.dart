...
/// Pink themed code mist search button
class PinkCodeMistSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMistSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMistSearchButton> createState() => _PinkCodeMistSearchButtonState();
}

class _PinkCodeMistSearchButtonState extends State<PinkCodeMistSearchButton> with SingleTickerProviderStateMixin {
