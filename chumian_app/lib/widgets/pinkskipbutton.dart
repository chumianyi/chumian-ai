...
/// Pink themed skip button
class PinkSkipButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSkipButton> createState() => _PinkSkipButtonState();
}

class _PinkSkipButtonState extends State<PinkSkipButton> with SingleTickerProviderStateMixin {
