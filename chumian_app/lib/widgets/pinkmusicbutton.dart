...
/// Pink themed music button
class PinkMusicButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMusicButton> createState() => _PinkMusicButtonState();
}

class _PinkMusicButtonState extends State<PinkMusicButton> with SingleTickerProviderStateMixin {
