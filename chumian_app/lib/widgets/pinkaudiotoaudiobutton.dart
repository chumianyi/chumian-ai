...
/// Pink themed audio-to-audio button
class PinkAudioToAudioButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAudioToAudioButton> createState() => _PinkAudioToAudioButtonState();
}

class _PinkAudioToAudioButtonState extends State<PinkAudioToAudioButton> with SingleTickerProviderStateMixin {
