...
/// Pink themed code cloud-data-ingestion search button
class PinkCodeCloudDataIngestionSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataIngestionSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataIngestionSearchButton> createState() => _PinkCodeCloudDataIngestionSearchButtonState();
}

class _PinkCodeCloudDataIngestionSearchButtonState extends State<PinkCodeCloudDataIngestionSearchButton> with SingleTickerProviderStateMixin {
