...
/// Pink themed code self-tuning search button
class PinkCodeSelfTuningSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSelfTuningSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSelfTuningSearchButton> createState() => _PinkCodeSelfTuningSearchButtonState();
}

class _PinkCodeSelfTuningSearchButtonState extends State<PinkCodeSelfTuningSearchButton> with SingleTickerProviderStateMixin {
