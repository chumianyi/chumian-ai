...
/// Pink themed code cloud-threat-modeling search button
class PinkCodeCloudThreatModelingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudThreatModelingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudThreatModelingSearchButton> createState() => _PinkCodeCloudThreatModelingSearchButtonState();
}

class _PinkCodeCloudThreatModelingSearchButtonState extends State<PinkCodeCloudThreatModelingSearchButton> with SingleTickerProviderStateMixin {
