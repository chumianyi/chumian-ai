...
/// Pink themed code cloud-speech-synthesis search button
class PinkCodeCloudSpeechSynthesisSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudSpeechSynthesisSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudSpeechSynthesisSearchButton> createState() => _PinkCodeCloudSpeechSynthesisSearchButtonState();
}

class _PinkCodeCloudSpeechSynthesisSearchButtonState extends State<PinkCodeCloudSpeechSynthesisSearchButton> with SingleTickerProviderStateMixin {
