...
/// Pink themed dentist button
class PinkDentistButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDentistButton> createState() => _PinkDentistButtonState();
}

class _PinkDentistButtonState extends State<PinkDentistButton> with SingleTickerProviderStateMixin {
