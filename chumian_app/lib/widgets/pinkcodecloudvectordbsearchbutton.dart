...
/// Pink themed code cloud-vector-DB search button
class PinkCodeCloudVectorDbSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudVectorDbSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudVectorDbSearchButton> createState() => _PinkCodeCloudVectorDbSearchButtonState();
}

class _PinkCodeCloudVectorDbSearchButtonState extends State<PinkCodeCloudVectorDbSearchButton> with SingleTickerProviderStateMixin {
