...
/// Pink themed retry button
class PinkRetryButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRetryButton> createState() => _PinkRetryButtonState();
}

class _PinkRetryButtonState extends State<PinkRetryButton> with SingleTickerProviderStateMixin {
