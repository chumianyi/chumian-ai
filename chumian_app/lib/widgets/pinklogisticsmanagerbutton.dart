...
/// Pink themed logistics manager button
class PinkLogisticsManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkLogisticsManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkLogisticsManagerButton> createState() => _PinkLogisticsManagerButtonState();
}

class _PinkLogisticsManagerButtonState extends State<PinkLogisticsManagerButton> with SingleTickerProviderStateMixin {
