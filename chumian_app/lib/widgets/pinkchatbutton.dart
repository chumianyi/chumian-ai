...
/// Pink themed chat button
class PinkChatButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkChatButton> createState() => _PinkChatButtonState();
}

class _PinkChatButtonState extends State<PinkChatButton> with SingleTickerProviderStateMixin {
