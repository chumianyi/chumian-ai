...
/// Pink themed code circuit breaker search button
class PinkCodeCircuitBreakerSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCircuitBreakerSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCircuitBreakerSearchButton> createState() => _PinkCodeCircuitBreakerSearchButtonState();
}

class _PinkCodeCircuitBreakerSearchButtonState extends State<PinkCodeCircuitBreakerSearchButton> with SingleTickerProviderStateMixin {
