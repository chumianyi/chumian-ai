...
/// Pink themed code throttled search button
class PinkCodeThrottledSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeThrottledSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeThrottledSearchButton> createState() => _PinkCodeThrottledSearchButtonState();
}

class _PinkCodeThrottledSearchButtonState extends State<PinkCodeThrottledSearchButton> with SingleTickerProviderStateMixin {
