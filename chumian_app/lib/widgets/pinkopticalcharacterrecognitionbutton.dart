...
/// Pink themed OCR button
class PinkOpticalCharacterRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkOpticalCharacterRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkOpticalCharacterRecognitionButton> createState() => _PinkOpticalCharacterRecognitionButtonState();
}

class _PinkOpticalCharacterRecognitionButtonState extends State<PinkOpticalCharacterRecognitionButton> with SingleTickerProviderStateMixin {
