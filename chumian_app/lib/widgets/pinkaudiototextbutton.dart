...
/// Pink themed audio-to-text button
class PinkAudioToTextButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAudioToTextButton> createState() => _PinkAudioToTextButtonState();
}

class _PinkAudioToTextButtonState extends State<PinkAudioToTextButton> with SingleTickerProviderStateMixin {
