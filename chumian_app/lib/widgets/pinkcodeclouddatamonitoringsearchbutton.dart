...
/// Pink themed code cloud-data-monitoring search button
class PinkCodeCloudDataMonitoringSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataMonitoringSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataMonitoringSearchButton> createState() => _PinkCodeCloudDataMonitoringSearchButtonState();
}

class _PinkCodeCloudDataMonitoringSearchButtonState extends State<PinkCodeCloudDataMonitoringSearchButton> with SingleTickerProviderStateMixin {
