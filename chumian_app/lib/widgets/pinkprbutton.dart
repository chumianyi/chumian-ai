...
/// Pink themed PR button
class PinkPrButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPrButton> createState() => _PinkPrButtonState();
}

class _PinkPrButtonState extends State<PinkPrButton> with SingleTickerProviderStateMixin {
