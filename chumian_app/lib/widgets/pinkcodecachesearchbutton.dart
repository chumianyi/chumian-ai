...
/// Pink themed code cache search button
class PinkCodeCacheSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCacheSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCacheSearchButton> createState() => _PinkCodeCacheSearchButtonState();
}

class _PinkCodeCacheSearchButtonState extends State<PinkCodeCacheSearchButton> with SingleTickerProviderStateMixin {
