...
/// Pink themed remote support engineer button
class PinkRemoteSupportEngineerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkRemoteSupportEngineerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkRemoteSupportEngineerButton> createState() => _PinkRemoteSupportEngineerButtonState();
}

class _PinkRemoteSupportEngineerButtonState extends State<PinkRemoteSupportEngineerButton> with SingleTickerProviderStateMixin {
