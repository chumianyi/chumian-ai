...
/// Pink themed advertiser button
class PinkAdvertiserButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAdvertiserButton> createState() => _PinkAdvertiserButtonState();
}

class _PinkAdvertiserButtonState extends State<PinkAdvertiserButton> with SingleTickerProviderStateMixin {
