...
/// Pink themed tag
class PinkTag extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTag> createState() => _PinkTagState();
}

class _PinkTagState extends State<PinkTag> with SingleTickerProviderStateMixin {
