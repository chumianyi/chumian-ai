...
/// Pink themed product analyst button
class PinkProductAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkProductAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkProductAnalystButton> createState() => _PinkProductAnalystButtonState();
}

class _PinkProductAnalystButtonState extends State<PinkProductAnalystButton> with SingleTickerProviderStateMixin {
