...
/// Pink themed zero-shot learning button
class PinkZeroShotLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkZeroShotLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkZeroShotLearningButton> createState() => _PinkZeroShotLearningButtonState();
}

class _PinkZeroShotLearningButtonState extends State<PinkZeroShotLearningButton> with SingleTickerProviderStateMixin {
