...
/// Pink themed personalization engine button
class PinkPersonalizationEngineButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPersonalizationEngineButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPersonalizationEngineButton> createState() => _PinkPersonalizationEngineButtonState();
}

class _PinkPersonalizationEngineButtonState extends State<PinkPersonalizationEngineButton> with SingleTickerProviderStateMixin {
