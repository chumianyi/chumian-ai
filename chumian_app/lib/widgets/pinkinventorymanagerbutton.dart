...
/// Pink themed inventory manager button
class PinkInventoryManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkInventoryManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkInventoryManagerButton> createState() => _PinkInventoryManagerButtonState();
}

class _PinkInventoryManagerButtonState extends State<PinkInventoryManagerButton> with SingleTickerProviderStateMixin {
