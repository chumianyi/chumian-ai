...
/// Pink themed message button
class PinkMessageButton2 extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMessageButton2> createState() => _PinkMessageButton2State();
}

class _PinkMessageButton2State extends State<PinkMessageButton2> with SingleTickerProviderStateMixin {
