...
/// Pink themed like button
class PinkLikeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkLikeButton> createState() => _PinkLikeButtonState();
}

class _PinkLikeButtonState extends State<PinkLikeButton> with SingleTickerProviderStateMixin {
