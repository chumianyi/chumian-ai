...
/// Pink themed foundation model button
class PinkFoundationModelButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFoundationModelButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFoundationModelButton> createState() => _PinkFoundationModelButtonState();
}

class _PinkFoundationModelButtonState extends State<PinkFoundationModelButton> with SingleTickerProviderStateMixin {
