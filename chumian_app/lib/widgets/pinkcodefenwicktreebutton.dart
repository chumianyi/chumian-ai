...
/// Pink themed code Fenwick tree button
class PinkCodeFenwickTreeButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeFenwickTreeButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeFenwickTreeButton> createState() => _PinkCodeFenwickTreeButtonState();
}

class _PinkCodeFenwickTreeButtonState extends State<PinkCodeFenwickTreeButton> with SingleTickerProviderStateMixin {
