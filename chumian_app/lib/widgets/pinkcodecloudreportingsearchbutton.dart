...
/// Pink themed code cloud-reporting search button
class PinkCodeCloudReportingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudReportingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudReportingSearchButton> createState() => _PinkCodeCloudReportingSearchButtonState();
}

class _PinkCodeCloudReportingSearchButtonState extends State<PinkCodeCloudReportingSearchButton> with SingleTickerProviderStateMixin {
