...
/// Pink themed badge
class PinkBadge extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkBadge> createState() => _PinkBadgeState();
}

class _PinkBadgeState extends State<PinkBadge> with SingleTickerProviderStateMixin {
