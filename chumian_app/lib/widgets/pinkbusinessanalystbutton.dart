...
/// Pink themed business analyst button
class PinkBusinessAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkBusinessAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkBusinessAnalystButton> createState() => _PinkBusinessAnalystButtonState();
}

class _PinkBusinessAnalystButtonState extends State<PinkBusinessAnalystButton> with SingleTickerProviderStateMixin {
