...
/// Pink themed code cloud-security-audit search button
class PinkCodeCloudSecurityAuditSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudSecurityAuditSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudSecurityAuditSearchButton> createState() => _PinkCodeCloudSecurityAuditSearchButtonState();
}

class _PinkCodeCloudSecurityAuditSearchButtonState extends State<PinkCodeCloudSecurityAuditSearchButton> with SingleTickerProviderStateMixin {
