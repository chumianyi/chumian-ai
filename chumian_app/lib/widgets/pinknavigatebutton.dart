...
/// Pink themed navigate button
class PinkNavigateButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNavigateButton> createState() => _PinkNavigateButtonState();
}

class _PinkNavigateButtonState extends State<PinkNavigateButton> with SingleTickerProviderStateMixin {
