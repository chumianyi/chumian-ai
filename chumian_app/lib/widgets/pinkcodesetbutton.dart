...
/// Pink themed code set button
class PinkCodeSetButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeSetButton> createState() => _PinkCodeSetButtonState();
}

class _PinkCodeSetButtonState extends State<PinkCodeSetButton> with SingleTickerProviderStateMixin {
