...
/// Pink themed sort button
class PinkSortButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSortButton> createState() => _PinkSortButtonState();
}

class _PinkSortButtonState extends State<PinkSortButton> with SingleTickerProviderStateMixin {
