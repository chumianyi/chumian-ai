...
/// Pink themed URL button
class PinkUrlButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkUrlButton> createState() => _PinkUrlButtonState();
}

class _PinkUrlButtonState extends State<PinkUrlButton> with SingleTickerProviderStateMixin {
