...
/// Pink themed snackbar
class PinkSnackBar extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSnackBar> createState() => _PinkSnackBarState();
}

class _PinkSnackBarState extends State<PinkSnackBar> with SingleTickerProviderStateMixin {
