...
/// Pink themed code parallel search button
class PinkCodeParallelSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeParallelSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeParallelSearchButton> createState() => _PinkCodeParallelSearchButtonState();
}

class _PinkCodeParallelSearchButtonState extends State<PinkCodeParallelSearchButton> with SingleTickerProviderStateMixin {
