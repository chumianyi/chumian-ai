...
/// Pink themed view button
class PinkViewButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkViewButton> createState() => _PinkViewButtonState();
}

class _PinkViewButtonState extends State<PinkViewButton> with SingleTickerProviderStateMixin {
