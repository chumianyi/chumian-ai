...
/// Pink themed code cloud-data-sovereignty search button
class PinkCodeCloudDataSovereigntySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataSovereigntySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataSovereigntySearchButton> createState() => _PinkCodeCloudDataSovereigntySearchButtonState();
}

class _PinkCodeCloudDataSovereigntySearchButtonState extends State<PinkCodeCloudDataSovereigntySearchButton> with SingleTickerProviderStateMixin {
