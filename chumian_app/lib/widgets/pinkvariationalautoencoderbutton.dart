...
/// Pink themed VAE button
class PinkVariationalAutoencoderButton extends StatefulWidget {
  final String? text;
  ...
  const PinkVariationalAutoencoderButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkVariationalAutoencoderButton> createState() => _PinkVariationalAutoencoderButtonState();
}

class _PinkVariationalAutoencoderButtonState extends State<PinkVariationalAutoencoderButton> with SingleTickerProviderStateMixin {
