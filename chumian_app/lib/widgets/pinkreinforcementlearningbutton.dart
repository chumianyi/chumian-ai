...
/// Pink themed reinforcement learning button
class PinkReinforcementLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkReinforcementLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkReinforcementLearningButton> createState() => _PinkReinforcementLearningButtonState();
}

class _PinkReinforcementLearningButtonState extends State<PinkReinforcementLearningButton> with SingleTickerProviderStateMixin {
