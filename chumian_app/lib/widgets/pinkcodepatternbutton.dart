...
/// Pink themed code pattern button
class PinkCodePatternButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodePatternButton> createState() => _PinkCodePatternButtonState();
}

class _PinkCodePatternButtonState extends State<PinkCodePatternButton> with SingleTickerProviderStateMixin {
