...
/// Pink themed timeline
class PinkTimeline extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTimeline> createState() => _PinkTimelineState();
}

class _PinkTimelineState extends State<PinkTimeline> with SingleTickerProviderStateMixin {
