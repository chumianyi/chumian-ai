...
/// Pink themed code cloud-optimization search button
class PinkCodeCloudOptimizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudOptimizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudOptimizationSearchButton> createState() => _PinkCodeCloudOptimizationSearchButtonState();
}

class _PinkCodeCloudOptimizationSearchButtonState extends State<PinkCodeCloudOptimizationSearchButton> with SingleTickerProviderStateMixin {
