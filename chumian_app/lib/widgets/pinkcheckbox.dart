...
/// Pink themed checkbox
class PinkCheckbox extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCheckbox> createState() => _PinkCheckboxState();
}

class _PinkCheckboxState extends State<PinkCheckbox> with SingleTickerProviderStateMixin {
