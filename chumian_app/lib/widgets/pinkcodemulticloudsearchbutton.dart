...
/// Pink themed code multi-cloud search button
class PinkCodeMultiCloudSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMultiCloudSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMultiCloudSearchButton> createState() => _PinkCodeMultiCloudSearchButtonState();
}

class _PinkCodeMultiCloudSearchButtonState extends State<PinkCodeMultiCloudSearchButton> with SingleTickerProviderStateMixin {
