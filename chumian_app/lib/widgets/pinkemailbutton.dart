...
/// Pink themed email button
class PinkEmailButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkEmailButton> createState() => _PinkEmailButtonState();
}

class _PinkEmailButtonState extends State<PinkEmailButton> with SingleTickerProviderStateMixin {
