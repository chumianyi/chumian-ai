...
/// Pink themed code cloud-RAG search button
class PinkCodeCloudRagSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRagSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRagSearchButton> createState() => _PinkCodeCloudRagSearchButtonState();
}

class _PinkCodeCloudRagSearchButtonState extends State<PinkCodeCloudRagSearchButton> with SingleTickerProviderStateMixin {
