...
/// Pink themed IT support specialist button
class PinkItSupportSpecialistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkItSupportSpecialistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkItSupportSpecialistButton> createState() => _PinkItSupportSpecialistButtonState();
}

class _PinkItSupportSpecialistButtonState extends State<PinkItSupportSpecialistButton> with SingleTickerProviderStateMixin {
