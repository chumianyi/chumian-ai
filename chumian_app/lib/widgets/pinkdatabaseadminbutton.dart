...
/// Pink themed database admin button
class PinkDatabaseAdminButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDatabaseAdminButton> createState() => _PinkDatabaseAdminButtonState();
}

class _PinkDatabaseAdminButtonState extends State<PinkDatabaseAdminButton> with SingleTickerProviderStateMixin {
