...
/// Pink themed code cloud-NLP search button
class PinkCodeCloudNlpSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudNlpSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudNlpSearchButton> createState() => _PinkCodeCloudNlpSearchButtonState();
}

class _PinkCodeCloudNlpSearchButtonState extends State<PinkCodeCloudNlpSearchButton> with SingleTickerProviderStateMixin {
