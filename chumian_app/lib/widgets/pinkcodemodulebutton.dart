...
/// Pink themed code module button
class PinkCodeModuleButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeModuleButton> createState() => _PinkCodeModuleButtonState();
}

class _PinkCodeModuleButtonState extends State<PinkCodeModuleButton> with SingleTickerProviderStateMixin {
