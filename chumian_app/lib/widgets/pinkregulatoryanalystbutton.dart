...
/// Pink themed regulatory analyst button
class PinkRegulatoryAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkRegulatoryAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkRegulatoryAnalystButton> createState() => _PinkRegulatoryAnalystButtonState();
}

class _PinkRegulatoryAnalystButtonState extends State<PinkRegulatoryAnalystButton> with SingleTickerProviderStateMixin {
