...
/// Pink themed page view
class PinkPageView extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPageView> createState() => _PinkPageViewState();
}

class _PinkPageViewState extends State<PinkPageView> with SingleTickerProviderStateMixin {
