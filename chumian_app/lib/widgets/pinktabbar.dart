...
/// Pink themed tab bar
class PinkTabBar extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTabBar> createState() => _PinkTabBarState();
}

class _PinkTabBarState extends State<PinkTabBar> with SingleTickerProviderStateMixin {
