...
/// Pink themed call button
class PinkCallButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCallButton> createState() => _PinkCallButtonState();
}

class _PinkCallButtonState extends State<PinkCallButton> with SingleTickerProviderStateMixin {
