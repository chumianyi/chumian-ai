...
/// Pink themed code cloud-data-analytics search button
class PinkCodeCloudDataAnalyticsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataAnalyticsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataAnalyticsSearchButton> createState() => _PinkCodeCloudDataAnalyticsSearchButtonState();
}

class _PinkCodeCloudDataAnalyticsSearchButtonState extends State<PinkCodeCloudDataAnalyticsSearchButton> with SingleTickerProviderStateMixin {
