...
/// Pink themed code list button
class PinkCodeListButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeListButton> createState() => _PinkCodeListButtonState();
}

class _PinkCodeListButtonState extends State<PinkCodeListButton> with SingleTickerProviderStateMixin {
