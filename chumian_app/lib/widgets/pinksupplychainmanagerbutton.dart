...
/// Pink themed supply chain manager button
class PinkSupplyChainManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSupplyChainManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSupplyChainManagerButton> createState() => _PinkSupplyChainManagerButtonState();
}

class _PinkSupplyChainManagerButtonState extends State<PinkSupplyChainManagerButton> with SingleTickerProviderStateMixin {
