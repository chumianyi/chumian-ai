...
/// Pink themed distributed learning button
class PinkDistributedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDistributedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDistributedLearningButton> createState() => _PinkDistributedLearningButtonState();
}

class _PinkDistributedLearningButtonState extends State<PinkDistributedLearningButton> with SingleTickerProviderStateMixin {
