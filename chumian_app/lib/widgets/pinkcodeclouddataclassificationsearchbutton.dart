...
/// Pink themed code cloud-data-classification search button
class PinkCodeCloudDataClassificationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataClassificationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataClassificationSearchButton> createState() => _PinkCodeCloudDataClassificationSearchButtonState();
}

class _PinkCodeCloudDataClassificationSearchButtonState extends State<PinkCodeCloudDataClassificationSearchButton> with SingleTickerProviderStateMixin {
