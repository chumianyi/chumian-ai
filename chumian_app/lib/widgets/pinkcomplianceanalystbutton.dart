...
/// Pink themed compliance analyst button
class PinkComplianceAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkComplianceAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkComplianceAnalystButton> createState() => _PinkComplianceAnalystButtonState();
}

class _PinkComplianceAnalystButtonState extends State<PinkComplianceAnalystButton> with SingleTickerProviderStateMixin {
