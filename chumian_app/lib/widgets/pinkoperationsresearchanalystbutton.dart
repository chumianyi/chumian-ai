...
/// Pink themed OR analyst button
class PinkOperationsResearchAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkOperationsResearchAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkOperationsResearchAnalystButton> createState() => _PinkOperationsResearchAnalystButtonState();
}

class _PinkOperationsResearchAnalystButtonState extends State<PinkOperationsResearchAnalystButton> with SingleTickerProviderStateMixin {
