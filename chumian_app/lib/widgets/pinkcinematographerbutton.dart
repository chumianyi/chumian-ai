...
/// Pink themed cinematographer button
class PinkCinematographerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCinematographerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCinematographerButton> createState() => _PinkCinematographerButtonState();
}

class _PinkCinematographerButtonState extends State<PinkCinematographerButton> with SingleTickerProviderStateMixin {
