...
/// Pink themed file button
class PinkFileButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkFileButton> createState() => _PinkFileButtonState();
}

class _PinkFileButtonState extends State<PinkFileButton> with SingleTickerProviderStateMixin {
