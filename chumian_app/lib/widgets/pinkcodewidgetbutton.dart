...
/// Pink themed code widget button
class PinkCodeWidgetButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeWidgetButton> createState() => _PinkCodeWidgetButtonState();
}

class _PinkCodeWidgetButtonState extends State<PinkCodeWidgetButton> with SingleTickerProviderStateMixin {
