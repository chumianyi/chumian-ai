...
/// Pink themed TV button
class PinkTvButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTvButton> createState() => _PinkTvButtonState();
}

class _PinkTvButtonState extends State<PinkTvButton> with SingleTickerProviderStateMixin {
