...
/// Pink themed risk analyst button
class PinkRiskAnalystButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRiskAnalystButton> createState() => _PinkRiskAnalystButtonState();
}

class _PinkRiskAnalystButtonState extends State<PinkRiskAnalystButton> with SingleTickerProviderStateMixin {
