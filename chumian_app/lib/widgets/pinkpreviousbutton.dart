...
/// Pink themed previous button
class PinkPreviousButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPreviousButton> createState() => _PinkPreviousButtonState();
}

class _PinkPreviousButtonState extends State<PinkPreviousButton> with SingleTickerProviderStateMixin {
