...
/// Pink themed code queue button
class PinkCodeQueueButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeQueueButton> createState() => _PinkCodeQueueButtonState();
}

class _PinkCodeQueueButtonState extends State<PinkCodeQueueButton> with SingleTickerProviderStateMixin {
