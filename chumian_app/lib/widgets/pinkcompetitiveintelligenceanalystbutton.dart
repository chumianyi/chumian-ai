...
/// Pink themed competitive intelligence analyst button
class PinkCompetitiveIntelligenceAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCompetitiveIntelligenceAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCompetitiveIntelligenceAnalystButton> createState() => _PinkCompetitiveIntelligenceAnalystButtonState();
}

class _PinkCompetitiveIntelligenceAnalystButtonState extends State<PinkCompetitiveIntelligenceAnalystButton> with SingleTickerProviderStateMixin {
