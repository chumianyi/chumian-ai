...
/// Pink themed scan button
class PinkScanButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkScanButton> createState() => _PinkScanButtonState();
}

class _PinkScanButtonState extends State<PinkScanButton> with SingleTickerProviderStateMixin {
