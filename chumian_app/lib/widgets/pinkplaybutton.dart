...
/// Pink themed play button
class PinkPlayButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPlayButton> createState() => _PinkPlayButtonState();
}

class _PinkPlayButtonState extends State<PinkPlayButton> with SingleTickerProviderStateMixin {
