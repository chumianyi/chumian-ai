...
/// Pink themed set designer button
class PinkSetDesignerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSetDesignerButton> createState() => _PinkSetDesignerButtonState();
}

class _PinkSetDesignerButtonState extends State<PinkSetDesignerButton> with SingleTickerProviderStateMixin {
