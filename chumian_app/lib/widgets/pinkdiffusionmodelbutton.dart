...
/// Pink themed diffusion model button
class PinkDiffusionModelButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDiffusionModelButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDiffusionModelButton> createState() => _PinkDiffusionModelButtonState();
}

class _PinkDiffusionModelButtonState extends State<PinkDiffusionModelButton> with SingleTickerProviderStateMixin {
