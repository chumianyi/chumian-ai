...
/// Pink themed escalation manager button
class PinkEscalationManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkEscalationManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkEscalationManagerButton> createState() => _PinkEscalationManagerButtonState();
}

class _PinkEscalationManagerButtonState extends State<PinkEscalationManagerButton> with SingleTickerProviderStateMixin {
