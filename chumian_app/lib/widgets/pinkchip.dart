...
/// Pink themed chip
class PinkChip extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkChip> createState() => _PinkChipState();
}

class _PinkChipState extends State<PinkChip> with SingleTickerProviderStateMixin {
