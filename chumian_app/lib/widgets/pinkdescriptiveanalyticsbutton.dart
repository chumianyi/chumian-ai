...
/// Pink themed descriptive analytics button
class PinkDescriptiveAnalyticsButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDescriptiveAnalyticsButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDescriptiveAnalyticsButton> createState() => _PinkDescriptiveAnalyticsButtonState();
}

class _PinkDescriptiveAnalyticsButtonState extends State<PinkDescriptiveAnalyticsButton> with SingleTickerProviderStateMixin {
