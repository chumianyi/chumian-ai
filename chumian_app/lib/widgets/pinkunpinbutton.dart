...
/// Pink themed unpin button
class PinkUnpinButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkUnpinButton> createState() => _PinkUnpinButtonState();
}

class _PinkUnpinButtonState extends State<PinkUnpinButton> with SingleTickerProviderStateMixin {
