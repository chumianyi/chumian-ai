...
/// Pink themed code backpressure search button
class PinkCodeBackpressureSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeBackpressureSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeBackpressureSearchButton> createState() => _PinkCodeBackpressureSearchButtonState();
}

class _PinkCodeBackpressureSearchButtonState extends State<PinkCodeBackpressureSearchButton> with SingleTickerProviderStateMixin {
