...
/// Pink themed text-to-image button
class PinkTextToImageButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTextToImageButton> createState() => _PinkTextToImageButtonState();
}

class _PinkTextToImageButtonState extends State<PinkTextToImageButton> with SingleTickerProviderStateMixin {
