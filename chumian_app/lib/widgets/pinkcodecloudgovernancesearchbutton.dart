...
/// Pink themed code cloud-governance search button
class PinkCodeCloudGovernanceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudGovernanceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudGovernanceSearchButton> createState() => _PinkCodeCloudGovernanceSearchButtonState();
}

class _PinkCodeCloudGovernanceSearchButtonState extends State<PinkCodeCloudGovernanceSearchButton> with SingleTickerProviderStateMixin {
