...
/// Pink themed regional manager button
class PinkRegionalManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkRegionalManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkRegionalManagerButton> createState() => _PinkRegionalManagerButtonState();
}

class _PinkRegionalManagerButtonState extends State<PinkRegionalManagerButton> with SingleTickerProviderStateMixin {
