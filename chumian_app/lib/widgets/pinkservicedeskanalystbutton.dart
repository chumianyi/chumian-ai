...
/// Pink themed service desk analyst button
class PinkServiceDeskAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkServiceDeskAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkServiceDeskAnalystButton> createState() => _PinkServiceDeskAnalystButtonState();
}

class _PinkServiceDeskAnalystButtonState extends State<PinkServiceDeskAnalystButton> with SingleTickerProviderStateMixin {
