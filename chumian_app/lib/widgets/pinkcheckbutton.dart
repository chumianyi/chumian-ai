...
/// Pink themed check button
class PinkCheckButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCheckButton> createState() => _PinkCheckButtonState();
}

class _PinkCheckButtonState extends State<PinkCheckButton> with SingleTickerProviderStateMixin {
