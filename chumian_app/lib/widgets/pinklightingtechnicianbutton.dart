...
/// Pink themed lighting technician button
class PinkLightingTechnicianButton extends StatefulWidget {
  final String? text;
  ...
  const PinkLightingTechnicianButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkLightingTechnicianButton> createState() => _PinkLightingTechnicianButtonState();
}

class _PinkLightingTechnicianButtonState extends State<PinkLightingTechnicianButton> with SingleTickerProviderStateMixin {
