...
/// Pink themed bacteriologist button
class PinkBacteriologistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkBacteriologistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkBacteriologistButton> createState() => _PinkBacteriologistButtonState();
}

class _PinkBacteriologistButtonState extends State<PinkBacteriologistButton> with SingleTickerProviderStateMixin {
