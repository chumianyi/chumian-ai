...
/// Pink themed code failover search button
class PinkCodeFailoverSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeFailoverSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeFailoverSearchButton> createState() => _PinkCodeFailoverSearchButtonState();
}

class _PinkCodeFailoverSearchButtonState extends State<PinkCodeFailoverSearchButton> with SingleTickerProviderStateMixin {
