...
/// Pink themed code architecture button
class PinkCodeArchitectureButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeArchitectureButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeArchitectureButton> createState() => _PinkCodeArchitectureButtonState();
}

class _PinkCodeArchitectureButtonState extends State<PinkCodeArchitectureButton> with SingleTickerProviderStateMixin {
