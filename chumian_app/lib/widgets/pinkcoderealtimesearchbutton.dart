...
/// Pink themed code realtime search button
class PinkCodeRealtimeSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRealtimeSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRealtimeSearchButton> createState() => _PinkCodeRealtimeSearchButtonState();
}

class _PinkCodeRealtimeSearchButtonState extends State<PinkCodeRealtimeSearchButton> with SingleTickerProviderStateMixin {
