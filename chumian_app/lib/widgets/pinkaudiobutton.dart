...
/// Pink themed audio button
class PinkAudioButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAudioButton> createState() => _PinkAudioButtonState();
}

class _PinkAudioButtonState extends State<PinkAudioButton> with SingleTickerProviderStateMixin {
