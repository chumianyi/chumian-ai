...
/// Pink themed self-supervised learning button
class PinkSelfSupervisedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSelfSupervisedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSelfSupervisedLearningButton> createState() => _PinkSelfSupervisedLearningButtonState();
}

class _PinkSelfSupervisedLearningButtonState extends State<PinkSelfSupervisedLearningButton> with SingleTickerProviderStateMixin {
