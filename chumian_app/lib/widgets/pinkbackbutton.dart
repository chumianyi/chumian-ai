...
/// Pink themed back button
class PinkBackButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkBackButton> createState() => _PinkBackButtonState();
}

class _PinkBackButtonState extends State<PinkBackButton> with SingleTickerProviderStateMixin {
