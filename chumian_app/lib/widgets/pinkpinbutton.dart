...
/// Pink themed pin button
class PinkPinButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPinButton> createState() => _PinkPinButtonState();
}

class _PinkPinButtonState extends State<PinkPinButton> with SingleTickerProviderStateMixin {
