...
/// Pink themed code security button
class PinkCodeSecurityButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeSecurityButton> createState() => _PinkCodeSecurityButtonState();
}

class _PinkCodeSecurityButtonState extends State<PinkCodeSecurityButton> with SingleTickerProviderStateMixin {
