...
/// Pink themed behavior analysis button
class PinkBehaviorAnalysisButton extends StatefulWidget {
  final String? text;
  ...
  const PinkBehaviorAnalysisButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkBehaviorAnalysisButton> createState() => _PinkBehaviorAnalysisButtonState();
}

class _PinkBehaviorAnalysisButtonState extends State<PinkBehaviorAnalysisButton> with SingleTickerProviderStateMixin {
