...
/// Pink themed generative AI button
class PinkGenerativeAiButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkGenerativeAiButton> createState() => _PinkGenerativeAiButtonState();
}

class _PinkGenerativeAiButtonState extends State<PinkGenerativeAiButton> with SingleTickerProviderStateMixin {
