...
/// Pink themed recommendation engine button
class PinkRecommendationEngineButton extends StatefulWidget {
  final String? text;
  ...
  const PinkRecommendationEngineButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkRecommendationEngineButton> createState() => _PinkRecommendationEngineButtonState();
}

class _PinkRecommendationEngineButtonState extends State<PinkRecommendationEngineButton> with SingleTickerProviderStateMixin {
