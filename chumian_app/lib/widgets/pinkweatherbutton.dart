...
/// Pink themed weather button
class PinkWeatherButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkWeatherButton> createState() => _PinkWeatherButtonState();
}

class _PinkWeatherButtonState extends State<PinkWeatherButton> with SingleTickerProviderStateMixin {
