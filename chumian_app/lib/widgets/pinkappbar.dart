...
/// Pink themed app bar
class PinkAppBar extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAppBar> createState() => _PinkAppBarState();
}

class _PinkAppBarState extends State<PinkAppBar> with SingleTickerProviderStateMixin {
