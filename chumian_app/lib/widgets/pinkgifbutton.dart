...
/// Pink themed gif button
class PinkGifButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkGifButton> createState() => _PinkGifButtonState();
}

class _PinkGifButtonState extends State<PinkGifButton> with SingleTickerProviderStateMixin {
