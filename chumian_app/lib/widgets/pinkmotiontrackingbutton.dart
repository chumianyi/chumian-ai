...
/// Pink themed motion tracking button
class PinkMotionTrackingButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMotionTrackingButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMotionTrackingButton> createState() => _PinkMotionTrackingButtonState();
}

class _PinkMotionTrackingButtonState extends State<PinkMotionTrackingButton> with SingleTickerProviderStateMixin {
