...
/// Pink themed semi-supervised learning button
class PinkSemiSupervisedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSemiSupervisedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSemiSupervisedLearningButton> createState() => _PinkSemiSupervisedLearningButtonState();
}

class _PinkSemiSupervisedLearningButtonState extends State<PinkSemiSupervisedLearningButton> with SingleTickerProviderStateMixin {
