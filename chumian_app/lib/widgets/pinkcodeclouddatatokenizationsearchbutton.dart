...
/// Pink themed code cloud-data-tokenization search button
class PinkCodeCloudDataTokenizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataTokenizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataTokenizationSearchButton> createState() => _PinkCodeCloudDataTokenizationSearchButtonState();
}

class _PinkCodeCloudDataTokenizationSearchButtonState extends State<PinkCodeCloudDataTokenizationSearchButton> with SingleTickerProviderStateMixin {
