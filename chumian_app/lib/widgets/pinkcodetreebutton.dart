...
/// Pink themed code tree button
class PinkCodeTreeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeTreeButton> createState() => _PinkCodeTreeButtonState();
}

class _PinkCodeTreeButtonState extends State<PinkCodeTreeButton> with SingleTickerProviderStateMixin {
