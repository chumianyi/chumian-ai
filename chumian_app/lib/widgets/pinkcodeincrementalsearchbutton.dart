...
/// Pink themed code incremental search button
class PinkCodeIncrementalSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeIncrementalSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeIncrementalSearchButton> createState() => _PinkCodeIncrementalSearchButtonState();
}

class _PinkCodeIncrementalSearchButtonState extends State<PinkCodeIncrementalSearchButton> with SingleTickerProviderStateMixin {
