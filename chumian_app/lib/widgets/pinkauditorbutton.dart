...
/// Pink themed auditor button
class PinkAuditorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAuditorButton> createState() => _PinkAuditorButtonState();
}

class _PinkAuditorButtonState extends State<PinkAuditorButton> with SingleTickerProviderStateMixin {
