...
/// Pink themed code timeout search button
class PinkCodeTimeoutSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeTimeoutSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeTimeoutSearchButton> createState() => _PinkCodeTimeoutSearchButtonState();
}

class _PinkCodeTimeoutSearchButtonState extends State<PinkCodeTimeoutSearchButton> with SingleTickerProviderStateMixin {
