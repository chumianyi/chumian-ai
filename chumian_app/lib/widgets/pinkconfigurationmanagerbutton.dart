...
/// Pink themed configuration manager button
class PinkConfigurationManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkConfigurationManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkConfigurationManagerButton> createState() => _PinkConfigurationManagerButtonState();
}

class _PinkConfigurationManagerButtonState extends State<PinkConfigurationManagerButton> with SingleTickerProviderStateMixin {
