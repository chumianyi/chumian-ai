...
/// Pink themed code cloud-data-validation search button
class PinkCodeCloudDataValidationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataValidationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataValidationSearchButton> createState() => _PinkCodeCloudDataValidationSearchButtonState();
}

class _PinkCodeCloudDataValidationSearchButtonState extends State<PinkCodeCloudDataValidationSearchButton> with SingleTickerProviderStateMixin {
