...
/// Pink themed release manager button
class PinkReleaseManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkReleaseManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkReleaseManagerButton> createState() => _PinkReleaseManagerButtonState();
}

class _PinkReleaseManagerButtonState extends State<PinkReleaseManagerButton> with SingleTickerProviderStateMixin {
