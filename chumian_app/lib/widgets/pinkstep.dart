...
/// Pink themed step
class PinkStep extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkStep> createState() => _PinkStepState();
}

class _PinkStepState extends State<PinkStep> with SingleTickerProviderStateMixin {
