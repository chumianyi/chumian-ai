...
/// Pink themed code similarity search button
class PinkCodeSimilaritySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSimilaritySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSimilaritySearchButton> createState() => _PinkCodeSimilaritySearchButtonState();
}

class _PinkCodeSimilaritySearchButtonState extends State<PinkCodeSimilaritySearchButton> with SingleTickerProviderStateMixin {
