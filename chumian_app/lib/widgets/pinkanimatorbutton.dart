...
/// Pink themed animator button
class PinkAnimatorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAnimatorButton> createState() => _PinkAnimatorButtonState();
}

class _PinkAnimatorButtonState extends State<PinkAnimatorButton> with SingleTickerProviderStateMixin {
