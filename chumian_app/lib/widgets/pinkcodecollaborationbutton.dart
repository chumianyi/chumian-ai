...
/// Pink themed code collaboration button
class PinkCodeCollaborationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCollaborationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCollaborationButton> createState() => _PinkCodeCollaborationButtonState();
}

class _PinkCodeCollaborationButtonState extends State<PinkCodeCollaborationButton> with SingleTickerProviderStateMixin {
