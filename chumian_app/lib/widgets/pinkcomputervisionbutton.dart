...
/// Pink themed computer vision button
class PinkComputerVisionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkComputerVisionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkComputerVisionButton> createState() => _PinkComputerVisionButtonState();
}

class _PinkComputerVisionButtonState extends State<PinkComputerVisionButton> with SingleTickerProviderStateMixin {
