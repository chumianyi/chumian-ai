...
/// Pink themed edit button
class PinkEditButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkEditButton> createState() => _PinkEditButtonState();
}

class _PinkEditButtonState extends State<PinkEditButton> with SingleTickerProviderStateMixin {
