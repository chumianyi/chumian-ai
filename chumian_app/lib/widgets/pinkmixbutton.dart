...
/// Pink themed mix button
class PinkMixButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMixButton> createState() => _PinkMixButtonState();
}

class _PinkMixButtonState extends State<PinkMixButton> with SingleTickerProviderStateMixin {
