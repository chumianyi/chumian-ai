...
/// Pink themed code cloud-data-lifecycle search button
class PinkCodeCloudDataLifecycleSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataLifecycleSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataLifecycleSearchButton> createState() => _PinkCodeCloudDataLifecycleSearchButtonState();
}

class _PinkCodeCloudDataLifecycleSearchButtonState extends State<PinkCodeCloudDataLifecycleSearchButton> with SingleTickerProviderStateMixin {
