...
/// Pink themed video-to-text button
class PinkVideoToTextButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkVideoToTextButton> createState() => _PinkVideoToTextButtonState();
}

class _PinkVideoToTextButtonState extends State<PinkVideoToTextButton> with SingleTickerProviderStateMixin {
