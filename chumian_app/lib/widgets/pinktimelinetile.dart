...
/// Pink themed timeline tile
class PinkTimelineTile extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTimelineTile> createState() => _PinkTimelineTileState();
}

class _PinkTimelineTileState extends State<PinkTimelineTile> with SingleTickerProviderStateMixin {
