...
/// Pink themed download button
class PinkDownloadButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDownloadButton> createState() => _PinkDownloadButtonState();
}

class _PinkDownloadButtonState extends State<PinkDownloadButton> with SingleTickerProviderStateMixin {
