...
/// Pink themed code optimization button
class PinkCodeOptimizationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeOptimizationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeOptimizationButton> createState() => _PinkCodeOptimizationButtonState();
}

class _PinkCodeOptimizationButtonState extends State<PinkCodeOptimizationButton> with SingleTickerProviderStateMixin {
