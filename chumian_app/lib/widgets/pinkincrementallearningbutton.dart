...
/// Pink themed incremental learning button
class PinkIncrementalLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkIncrementalLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkIncrementalLearningButton> createState() => _PinkIncrementalLearningButtonState();
}

class _PinkIncrementalLearningButtonState extends State<PinkIncrementalLearningButton> with SingleTickerProviderStateMixin {
