...
/// Pink themed code library button
class PinkCodeLibraryButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeLibraryButton> createState() => _PinkCodeLibraryButtonState();
}

class _PinkCodeLibraryButtonState extends State<PinkCodeLibraryButton> with SingleTickerProviderStateMixin {
