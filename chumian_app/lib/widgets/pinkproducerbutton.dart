...
/// Pink themed producer button
class PinkProducerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkProducerButton> createState() => _PinkProducerButtonState();
}

class _PinkProducerButtonState extends State<PinkProducerButton> with SingleTickerProviderStateMixin {
