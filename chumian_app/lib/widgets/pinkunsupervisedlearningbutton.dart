...
/// Pink themed unsupervised learning button
class PinkUnsupervisedLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkUnsupervisedLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkUnsupervisedLearningButton> createState() => _PinkUnsupervisedLearningButtonState();
}

class _PinkUnsupervisedLearningButtonState extends State<PinkUnsupervisedLearningButton> with SingleTickerProviderStateMixin {
