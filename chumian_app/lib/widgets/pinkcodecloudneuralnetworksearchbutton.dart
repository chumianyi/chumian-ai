...
/// Pink themed code cloud-neural-network search button
class PinkCodeCloudNeuralNetworkSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudNeuralNetworkSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudNeuralNetworkSearchButton> createState() => _PinkCodeCloudNeuralNetworkSearchButtonState();
}

class _PinkCodeCloudNeuralNetworkSearchButtonState extends State<PinkCodeCloudNeuralNetworkSearchButton> with SingleTickerProviderStateMixin {
