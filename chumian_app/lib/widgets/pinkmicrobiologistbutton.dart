...
/// Pink themed microbiologist button
class PinkMicrobiologistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkMicrobiologistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkMicrobiologistButton> createState() => _PinkMicrobiologistButtonState();
}

class _PinkMicrobiologistButtonState extends State<PinkMicrobiologistButton> with SingleTickerProviderStateMixin {
