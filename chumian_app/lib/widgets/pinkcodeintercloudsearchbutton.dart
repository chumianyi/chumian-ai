...
/// Pink themed code inter-cloud search button
class PinkCodeInterCloudSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeInterCloudSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeInterCloudSearchButton> createState() => _PinkCodeInterCloudSearchButtonState();
}

class _PinkCodeInterCloudSearchButtonState extends State<PinkCodeInterCloudSearchButton> with SingleTickerProviderStateMixin {
