...
/// Pink themed code cloud-data-normalization search button
class PinkCodeCloudDataNormalizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataNormalizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataNormalizationSearchButton> createState() => _PinkCodeCloudDataNormalizationSearchButtonState();
}

class _PinkCodeCloudDataNormalizationSearchButtonState extends State<PinkCodeCloudDataNormalizationSearchButton> with SingleTickerProviderStateMixin {
