...
/// Pink themed actor button
class PinkActorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkActorButton> createState() => _PinkActorButtonState();
}

class _PinkActorButtonState extends State<PinkActorButton> with SingleTickerProviderStateMixin {
