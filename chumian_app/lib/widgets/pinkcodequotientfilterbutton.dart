...
/// Pink themed code quotient filter button
class PinkCodeQuotientFilterButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeQuotientFilterButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeQuotientFilterButton> createState() => _PinkCodeQuotientFilterButtonState();
}

class _PinkCodeQuotientFilterButtonState extends State<PinkCodeQuotientFilterButton> with SingleTickerProviderStateMixin {
