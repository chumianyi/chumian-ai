...
/// Pink themed code cloud-migration search button
class PinkCodeCloudMigrationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudMigrationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudMigrationSearchButton> createState() => _PinkCodeCloudMigrationSearchButtonState();
}

class _PinkCodeCloudMigrationSearchButtonState extends State<PinkCodeCloudMigrationSearchButton> with SingleTickerProviderStateMixin {
