...
/// Pink themed financial analyst button
class PinkFinancialAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFinancialAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFinancialAnalystButton> createState() => _PinkFinancialAnalystButtonState();
}

class _PinkFinancialAnalystButtonState extends State<PinkFinancialAnalystButton> with SingleTickerProviderStateMixin {
