...
/// Pink themed gesture recognition button
class PinkGestureRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkGestureRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkGestureRecognitionButton> createState() => _PinkGestureRecognitionButtonState();
}

class _PinkGestureRecognitionButtonState extends State<PinkGestureRecognitionButton> with SingleTickerProviderStateMixin {
