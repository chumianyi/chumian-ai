...
/// Pink themed arrow button
class PinkArrowButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkArrowButton> createState() => _PinkArrowButtonState();
}

class _PinkArrowButtonState extends State<PinkArrowButton> with SingleTickerProviderStateMixin {
