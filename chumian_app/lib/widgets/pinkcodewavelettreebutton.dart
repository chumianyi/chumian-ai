...
/// Pink themed code wavelet tree button
class PinkCodeWaveletTreeButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeWaveletTreeButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeWaveletTreeButton> createState() => _PinkCodeWaveletTreeButtonState();
}

class _PinkCodeWaveletTreeButtonState extends State<PinkCodeWaveletTreeButton> with SingleTickerProviderStateMixin {
