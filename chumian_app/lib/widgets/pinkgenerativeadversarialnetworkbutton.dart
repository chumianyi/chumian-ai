...
/// Pink themed GAN button
class PinkGenerativeAdversarialNetworkButton extends StatefulWidget {
  final String? text;
  ...
  const PinkGenerativeAdversarialNetworkButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkGenerativeAdversarialNetworkButton> createState() => _PinkGenerativeAdversarialNetworkButtonState();
}

class _PinkGenerativeAdversarialNetworkButtonState extends State<PinkGenerativeAdversarialNetworkButton> with SingleTickerProviderStateMixin {
