...
/// Pink themed database developer button
class PinkDatabaseDeveloperButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDatabaseDeveloperButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDatabaseDeveloperButton> createState() => _PinkDatabaseDeveloperButtonState();
}

class _PinkDatabaseDeveloperButtonState extends State<PinkDatabaseDeveloperButton> with SingleTickerProviderStateMixin {
