...
/// Pink themed admin manager button
class PinkAdminManagerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAdminManagerButton> createState() => _PinkAdminManagerButtonState();
}

class _PinkAdminManagerButtonState extends State<PinkAdminManagerButton> with SingleTickerProviderStateMixin {
