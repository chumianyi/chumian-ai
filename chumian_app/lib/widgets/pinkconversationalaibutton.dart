...
/// Pink themed conversational AI button
class PinkConversationalAiButton extends StatefulWidget {
  final String? text;
  ...
  const PinkConversationalAiButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkConversationalAiButton> createState() => _PinkConversationalAiButtonState();
}

class _PinkConversationalAiButtonState extends State<PinkConversationalAiButton> with SingleTickerProviderStateMixin {
