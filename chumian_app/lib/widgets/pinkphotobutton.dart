...
/// Pink themed photo button
class PinkPhotoButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPhotoButton> createState() => _PinkPhotoButtonState();
}

class _PinkPhotoButtonState extends State<PinkPhotoButton> with SingleTickerProviderStateMixin {
