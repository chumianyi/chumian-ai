...
/// Pink themed text-to-audio button
class PinkTextToAudioButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTextToAudioButton> createState() => _PinkTextToAudioButtonState();
}

class _PinkTextToAudioButtonState extends State<PinkTextToAudioButton> with SingleTickerProviderStateMixin {
