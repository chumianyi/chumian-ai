...
/// Pink themed code cloud-LLM search button
class PinkCodeCloudLlmSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudLlmSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudLlmSearchButton> createState() => _PinkCodeCloudLlmSearchButtonState();
}

class _PinkCodeCloudLlmSearchButtonState extends State<PinkCodeCloudLlmSearchButton> with SingleTickerProviderStateMixin {
