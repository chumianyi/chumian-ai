...
/// Pink themed code cloud-deep-learning search button
class PinkCodeCloudDeepLearningSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDeepLearningSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDeepLearningSearchButton> createState() => _PinkCodeCloudDeepLearningSearchButtonState();
}

class _PinkCodeCloudDeepLearningSearchButtonState extends State<PinkCodeCloudDeepLearningSearchButton> with SingleTickerProviderStateMixin {
