...
/// Pink themed code cloud-global-compliance search button
class PinkCodeCloudGlobalComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudGlobalComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudGlobalComplianceSearchButton> createState() => _PinkCodeCloudGlobalComplianceSearchButtonState();
}

class _PinkCodeCloudGlobalComplianceSearchButtonState extends State<PinkCodeCloudGlobalComplianceSearchButton> with SingleTickerProviderStateMixin {
