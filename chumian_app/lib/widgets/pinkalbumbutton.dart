...
/// Pink themed album button
class PinkAlbumButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAlbumButton> createState() => _PinkAlbumButtonState();
}

class _PinkAlbumButtonState extends State<PinkAlbumButton> with SingleTickerProviderStateMixin {
