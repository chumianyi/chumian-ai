...
/// Pink themed pause button
class PinkPauseButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPauseButton> createState() => _PinkPauseButtonState();
}

class _PinkPauseButtonState extends State<PinkPauseButton> with SingleTickerProviderStateMixin {
