...
/// Pink themed cast button
class PinkCastButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCastButton> createState() => _PinkCastButtonState();
}

class _PinkCastButtonState extends State<PinkCastButton> with SingleTickerProviderStateMixin {
