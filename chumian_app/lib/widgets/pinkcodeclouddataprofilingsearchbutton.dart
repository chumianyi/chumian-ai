...
/// Pink themed code cloud-data-profiling search button
class PinkCodeCloudDataProfilingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataProfilingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataProfilingSearchButton> createState() => _PinkCodeCloudDataProfilingSearchButtonState();
}

class _PinkCodeCloudDataProfilingSearchButtonState extends State<PinkCodeCloudDataProfilingSearchButton> with SingleTickerProviderStateMixin {
