...
/// Pink themed emoji button
class PinkEmojiButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkEmojiButton> createState() => _PinkEmojiButtonState();
}

class _PinkEmojiButtonState extends State<PinkEmojiButton> with SingleTickerProviderStateMixin {
