...
/// Pink themed code metrics button
class PinkCodeMetricsButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeMetricsButton> createState() => _PinkCodeMetricsButtonState();
}

class _PinkCodeMetricsButtonState extends State<PinkCodeMetricsButton> with SingleTickerProviderStateMixin {
