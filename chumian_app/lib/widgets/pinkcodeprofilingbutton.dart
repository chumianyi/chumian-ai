...
/// Pink themed code profiling button
class PinkCodeProfilingButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeProfilingButton> createState() => _PinkCodeProfilingButtonState();
}

class _PinkCodeProfilingButtonState extends State<PinkCodeProfilingButton> with SingleTickerProviderStateMixin {
