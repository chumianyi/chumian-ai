...
/// Pink themed stop button
class PinkStopButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkStopButton> createState() => _PinkStopButtonState();
}

class _PinkStopButtonState extends State<PinkStopButton> with SingleTickerProviderStateMixin {
