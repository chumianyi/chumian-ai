...
/// Pink themed one-shot learning button
class PinkOneShotLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkOneShotLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkOneShotLearningButton> createState() => _PinkOneShotLearningButtonState();
}

class _PinkOneShotLearningButtonState extends State<PinkOneShotLearningButton> with SingleTickerProviderStateMixin {
