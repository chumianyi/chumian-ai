...
/// Pink themed switch
class PinkSwitch extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSwitch> createState() => _PinkSwitchState();
}

class _PinkSwitchState extends State<PinkSwitch> with SingleTickerProviderStateMixin {
