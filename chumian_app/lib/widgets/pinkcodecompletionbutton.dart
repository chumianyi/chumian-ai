...
/// Pink themed code completion button
class PinkCodeCompletionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCompletionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCompletionButton> createState() => _PinkCodeCompletionButtonState();
}

class _PinkCodeCompletionButtonState extends State<PinkCodeCompletionButton> with SingleTickerProviderStateMixin {
