...
/// Pink themed code federated search button
class PinkCodeFederatedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeFederatedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeFederatedSearchButton> createState() => _PinkCodeFederatedSearchButtonState();
}

class _PinkCodeFederatedSearchButtonState extends State<PinkCodeFederatedSearchButton> with SingleTickerProviderStateMixin {
