...
/// Pink themed anomaly detection button
class PinkAnomalyDetectionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkAnomalyDetectionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkAnomalyDetectionButton> createState() => _PinkAnomalyDetectionButtonState();
}

class _PinkAnomalyDetectionButtonState extends State<PinkAnomalyDetectionButton> with SingleTickerProviderStateMixin {
