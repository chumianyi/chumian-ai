...
/// Pink themed web button
class PinkWebButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkWebButton> createState() => _PinkWebButtonState();
}

class _PinkWebButtonState extends State<PinkWebButton> with SingleTickerProviderStateMixin {
