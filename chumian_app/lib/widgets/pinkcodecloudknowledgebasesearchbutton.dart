...
/// Pink themed code cloud-knowledge-base search button
class PinkCodeCloudKnowledgeBaseSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudKnowledgeBaseSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudKnowledgeBaseSearchButton> createState() => _PinkCodeCloudKnowledgeBaseSearchButtonState();
}

class _PinkCodeCloudKnowledgeBaseSearchButtonState extends State<PinkCodeCloudKnowledgeBaseSearchButton> with SingleTickerProviderStateMixin {
