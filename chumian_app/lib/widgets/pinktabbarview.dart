...
/// Pink themed tab bar view
class PinkTabBarView extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTabBarView> createState() => _PinkTabBarViewState();
}

class _PinkTabBarViewState extends State<PinkTabBarView> with SingleTickerProviderStateMixin {
