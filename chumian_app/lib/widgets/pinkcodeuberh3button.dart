...
/// Pink themed code Uber H3 button
class PinkCodeUberH3Button extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeUberH3Button> createState() => _PinkCodeUberH3ButtonState();
}

class _PinkCodeUberH3ButtonState extends State<PinkCodeUberH3Button> with SingleTickerProviderStateMixin {
