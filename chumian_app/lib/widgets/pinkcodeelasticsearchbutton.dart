...
/// Pink themed code elastic search button
class PinkCodeElasticSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeElasticSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeElasticSearchButton> createState() => _PinkCodeElasticSearchButtonState();
}

class _PinkCodeElasticSearchButtonState extends State<PinkCodeElasticSearchButton> with SingleTickerProviderStateMixin {
