...
/// Pink themed costume designer button
class PinkCostumeDesignerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCostumeDesignerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCostumeDesignerButton> createState() => _PinkCostumeDesignerButtonState();
}

class _PinkCostumeDesignerButtonState extends State<PinkCostumeDesignerButton> with SingleTickerProviderStateMixin {
