...
/// Pink themed sliver list
class PinkSliverList extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSliverList> createState() => _PinkSliverListState();
}

class _PinkSliverListState extends State<PinkSliverList> with SingleTickerProviderStateMixin {
