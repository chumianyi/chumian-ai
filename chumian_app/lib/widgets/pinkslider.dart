...
/// Pink themed slider
class PinkSlider extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSlider> createState() => _PinkSliderState();
}

class _PinkSliderState extends State<PinkSlider> with SingleTickerProviderStateMixin {
