...
/// Pink themed code compliance button
class PinkCodeComplianceButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeComplianceButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeComplianceButton> createState() => _PinkCodeComplianceButtonState();
}

class _PinkCodeComplianceButtonState extends State<PinkCodeComplianceButton> with SingleTickerProviderStateMixin {
