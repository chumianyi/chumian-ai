...
/// Pink themed code cloud-impact-analysis search button
class PinkCodeCloudImpactAnalysisSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudImpactAnalysisSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudImpactAnalysisSearchButton> createState() => _PinkCodeCloudImpactAnalysisSearchButtonState();
}

class _PinkCodeCloudImpactAnalysisSearchButtonState extends State<PinkCodeCloudImpactAnalysisSearchButton> with SingleTickerProviderStateMixin {
