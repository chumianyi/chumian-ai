...
/// Pink themed executive assistant button
class PinkExecutiveAssistantButton extends StatefulWidget {
  final String? text;
  ...
  const PinkExecutiveAssistantButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkExecutiveAssistantButton> createState() => _PinkExecutiveAssistantButtonState();
}

class _PinkExecutiveAssistantButtonState extends State<PinkExecutiveAssistantButton> with SingleTickerProviderStateMixin {
