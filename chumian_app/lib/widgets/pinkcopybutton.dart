...
/// Pink themed copy button
class PinkCopyButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCopyButton> createState() => _PinkCopyButtonState();
}

class _PinkCopyButtonState extends State<PinkCopyButton> with SingleTickerProviderStateMixin {
