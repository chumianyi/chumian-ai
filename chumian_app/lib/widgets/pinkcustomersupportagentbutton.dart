...
/// Pink themed support agent button
class PinkCustomerSupportAgentButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCustomerSupportAgentButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCustomerSupportAgentButton> createState() => _PinkCustomerSupportAgentButtonState();
}

class _PinkCustomerSupportAgentButtonState extends State<PinkCustomerSupportAgentButton> with SingleTickerProviderStateMixin {
