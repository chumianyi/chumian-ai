...
/// Pink themed contrastive learning button
class PinkContrastiveLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkContrastiveLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkContrastiveLearningButton> createState() => _PinkContrastiveLearningButtonState();
}

class _PinkContrastiveLearningButtonState extends State<PinkContrastiveLearningButton> with SingleTickerProviderStateMixin {
