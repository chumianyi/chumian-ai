...
/// Pink themed code cloud-portable search button
class PinkCodeCloudPortableSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudPortableSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudPortableSearchButton> createState() => _PinkCodeCloudPortableSearchButtonState();
}

class _PinkCodeCloudPortableSearchButtonState extends State<PinkCodeCloudPortableSearchButton> with SingleTickerProviderStateMixin {
