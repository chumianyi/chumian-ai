...
/// Pink themed link button
class PinkLinkButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkLinkButton> createState() => _PinkLinkButtonState();
}

class _PinkLinkButtonState extends State<PinkLinkButton> with SingleTickerProviderStateMixin {
