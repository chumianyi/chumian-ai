...
/// Pink themed elevated button
class PinkElevatedButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkElevatedButton> createState() => _PinkElevatedButtonState();
}

class _PinkElevatedButtonState extends State<PinkElevatedButton> with SingleTickerProviderStateMixin {
