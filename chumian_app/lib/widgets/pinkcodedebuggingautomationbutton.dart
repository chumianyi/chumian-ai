...
/// Pink themed code debugging automation button
class PinkCodeDebuggingAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDebuggingAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDebuggingAutomationButton> createState() => _PinkCodeDebuggingAutomationButtonState();
}

class _PinkCodeDebuggingAutomationButtonState extends State<PinkCodeDebuggingAutomationButton> with SingleTickerProviderStateMixin {
