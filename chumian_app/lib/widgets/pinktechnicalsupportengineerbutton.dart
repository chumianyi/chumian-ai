...
/// Pink themed tech support engineer button
class PinkTechnicalSupportEngineerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkTechnicalSupportEngineerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkTechnicalSupportEngineerButton> createState() => _PinkTechnicalSupportEngineerButtonState();
}

class _PinkTechnicalSupportEngineerButtonState extends State<PinkTechnicalSupportEngineerButton> with SingleTickerProviderStateMixin {
