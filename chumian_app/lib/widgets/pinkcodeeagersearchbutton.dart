...
/// Pink themed code eager search button
class PinkCodeEagerSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeEagerSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeEagerSearchButton> createState() => _PinkCodeEagerSearchButtonState();
}

class _PinkCodeEagerSearchButtonState extends State<PinkCodeEagerSearchButton> with SingleTickerProviderStateMixin {
