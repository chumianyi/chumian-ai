...
/// Pink themed LLM button
class PinkLargeLanguageModelButton extends StatefulWidget {
  final String? text;
  ...
  const PinkLargeLanguageModelButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkLargeLanguageModelButton> createState() => _PinkLargeLanguageModelButtonState();
}

class _PinkLargeLanguageModelButtonState extends State<PinkLargeLanguageModelButton> with SingleTickerProviderStateMixin {
