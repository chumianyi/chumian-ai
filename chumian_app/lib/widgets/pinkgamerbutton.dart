...
/// Pink themed gamer button
class PinkGamerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkGamerButton> createState() => _PinkGamerButtonState();
}

class _PinkGamerButtonState extends State<PinkGamerButton> with SingleTickerProviderStateMixin {
