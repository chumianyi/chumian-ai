...
/// Pink themed carousel
class PinkCarousel extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCarousel> createState() => _PinkCarouselState();
}

class _PinkCarouselState extends State<PinkCarousel> with SingleTickerProviderStateMixin {
