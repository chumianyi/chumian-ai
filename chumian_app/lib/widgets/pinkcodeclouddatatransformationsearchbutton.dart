...
/// Pink themed code cloud-data-transformation search button
class PinkCodeCloudDataTransformationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataTransformationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataTransformationSearchButton> createState() => _PinkCodeCloudDataTransformationSearchButtonState();
}

class _PinkCodeCloudDataTransformationSearchButtonState extends State<PinkCodeCloudDataTransformationSearchButton> with SingleTickerProviderStateMixin {
