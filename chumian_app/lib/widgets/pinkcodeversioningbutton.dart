...
/// Pink themed code versioning button
class PinkCodeVersioningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeVersioningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeVersioningButton> createState() => _PinkCodeVersioningButtonState();
}

class _PinkCodeVersioningButtonState extends State<PinkCodeVersioningButton> with SingleTickerProviderStateMixin {
