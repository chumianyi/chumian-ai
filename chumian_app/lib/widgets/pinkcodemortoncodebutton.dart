...
/// Pink themed code Morton code button
class PinkCodeMortonCodeButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMortonCodeButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMortonCodeButton> createState() => _PinkCodeMortonCodeButtonState();
}

class _PinkCodeMortonCodeButtonState extends State<PinkCodeMortonCodeButton> with SingleTickerProviderStateMixin {
