...
/// Pink themed code cloud-data-visualization search button
class PinkCodeCloudDataVisualizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataVisualizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataVisualizationSearchButton> createState() => _PinkCodeCloudDataVisualizationSearchButtonState();
}

class _PinkCodeCloudDataVisualizationSearchButtonState extends State<PinkCodeCloudDataVisualizationSearchButton> with SingleTickerProviderStateMixin {
