...
/// Pink themed TTS button
class PinkTextToSpeechButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTextToSpeechButton> createState() => _PinkTextToSpeechButtonState();
}

class _PinkTextToSpeechButtonState extends State<PinkTextToSpeechButton> with SingleTickerProviderStateMixin {
