...
/// Pink themed procurement manager button
class PinkProcurementManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkProcurementManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkProcurementManagerButton> createState() => _PinkProcurementManagerButtonState();
}

class _PinkProcurementManagerButtonState extends State<PinkProcurementManagerButton> with SingleTickerProviderStateMixin {
