...
/// Pink themed phone button
class PinkPhoneButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPhoneButton> createState() => _PinkPhoneButtonState();
}

class _PinkPhoneButtonState extends State<PinkPhoneButton> with SingleTickerProviderStateMixin {
