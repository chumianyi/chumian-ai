...
/// Pink themed change manager button
class PinkChangeManagerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkChangeManagerButton> createState() => _PinkChangeManagerButtonState();
}

class _PinkChangeManagerButtonState extends State<PinkChangeManagerButton> with SingleTickerProviderStateMixin {
