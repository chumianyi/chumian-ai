...
/// Pink themed customer insights analyst button
class PinkCustomerInsightsAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCustomerInsightsAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCustomerInsightsAnalystButton> createState() => _PinkCustomerInsightsAnalystButtonState();
}

class _PinkCustomerInsightsAnalystButtonState extends State<PinkCustomerInsightsAnalystButton> with SingleTickerProviderStateMixin {
