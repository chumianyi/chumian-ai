...
/// Pink themed code replicated search button
class PinkCodeReplicatedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeReplicatedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeReplicatedSearchButton> createState() => _PinkCodeReplicatedSearchButtonState();
}

class _PinkCodeReplicatedSearchButtonState extends State<PinkCodeReplicatedSearchButton> with SingleTickerProviderStateMixin {
