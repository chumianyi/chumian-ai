...
/// Pink themed code semantic search button
class PinkCodeSemanticSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSemanticSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSemanticSearchButton> createState() => _PinkCodeSemanticSearchButtonState();
}

class _PinkCodeSemanticSearchButtonState extends State<PinkCodeSemanticSearchButton> with SingleTickerProviderStateMixin {
