...
/// Pink themed dropdown
class PinkDropdown extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDropdown> createState() => _PinkDropdownState();
}

class _PinkDropdownState extends State<PinkDropdown> with SingleTickerProviderStateMixin {
