...
/// Pink themed code cloud-speech-recognition search button
class PinkCodeCloudSpeechRecognitionSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudSpeechRecognitionSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudSpeechRecognitionSearchButton> createState() => _PinkCodeCloudSpeechRecognitionSearchButtonState();
}

class _PinkCodeCloudSpeechRecognitionSearchButtonState extends State<PinkCodeCloudSpeechRecognitionSearchButton> with SingleTickerProviderStateMixin {
