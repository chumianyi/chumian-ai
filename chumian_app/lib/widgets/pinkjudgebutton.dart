...
/// Pink themed judge button
class PinkJudgeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkJudgeButton> createState() => _PinkJudgeButtonState();
}

class _PinkJudgeButtonState extends State<PinkJudgeButton> with SingleTickerProviderStateMixin {
