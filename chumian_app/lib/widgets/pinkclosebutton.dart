...
/// Pink themed close button
class PinkCloseButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCloseButton> createState() => _PinkCloseButtonState();
}

class _PinkCloseButtonState extends State<PinkCloseButton> with SingleTickerProviderStateMixin {
