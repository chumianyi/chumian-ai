...
/// Pink themed code octree button
class PinkCodeOctreeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeOctreeButton> createState() => _PinkCodeOctreeButtonState();
}

class _PinkCodeOctreeButtonState extends State<PinkCodeOctreeButton> with SingleTickerProviderStateMixin {
