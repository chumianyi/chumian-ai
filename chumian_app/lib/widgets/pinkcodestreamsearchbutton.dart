...
/// Pink themed code stream search button
class PinkCodeStreamSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeStreamSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeStreamSearchButton> createState() => _PinkCodeStreamSearchButtonState();
}

class _PinkCodeStreamSearchButtonState extends State<PinkCodeStreamSearchButton> with SingleTickerProviderStateMixin {
