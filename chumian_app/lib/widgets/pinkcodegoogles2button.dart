...
/// Pink themed code Google S2 button
class PinkCodeGoogleS2Button extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeGoogleS2Button> createState() => _PinkCodeGoogleS2ButtonState();
}

class _PinkCodeGoogleS2ButtonState extends State<PinkCodeGoogleS2Button> with SingleTickerProviderStateMixin {
