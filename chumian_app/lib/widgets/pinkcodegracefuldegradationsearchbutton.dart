...
/// Pink themed code graceful degradation search button
class PinkCodeGracefulDegradationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeGracefulDegradationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeGracefulDegradationSearchButton> createState() => _PinkCodeGracefulDegradationSearchButtonState();
}

class _PinkCodeGracefulDegradationSearchButtonState extends State<PinkCodeGracefulDegradationSearchButton> with SingleTickerProviderStateMixin {
