...
/// Pink themed code spatiotemporal index button
class PinkCodeSpatiotemporalIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSpatiotemporalIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSpatiotemporalIndexButton> createState() => _PinkCodeSpatiotemporalIndexButtonState();
}

class _PinkCodeSpatiotemporalIndexButtonState extends State<PinkCodeSpatiotemporalIndexButton> with SingleTickerProviderStateMixin {
