...
/// Pink themed personal assistant button
class PinkPersonalAssistantButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPersonalAssistantButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPersonalAssistantButton> createState() => _PinkPersonalAssistantButtonState();
}

class _PinkPersonalAssistantButtonState extends State<PinkPersonalAssistantButton> with SingleTickerProviderStateMixin {
