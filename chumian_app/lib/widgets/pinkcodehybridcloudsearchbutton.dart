...
/// Pink themed code hybrid cloud search button
class PinkCodeHybridCloudSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeHybridCloudSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeHybridCloudSearchButton> createState() => _PinkCodeHybridCloudSearchButtonState();
}

class _PinkCodeHybridCloudSearchButtonState extends State<PinkCodeHybridCloudSearchButton> with SingleTickerProviderStateMixin {
