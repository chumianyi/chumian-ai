...
/// Pink themed code explanation button
class PinkCodeExplanationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeExplanationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeExplanationButton> createState() => _PinkCodeExplanationButtonState();
}

class _PinkCodeExplanationButtonState extends State<PinkCodeExplanationButton> with SingleTickerProviderStateMixin {
