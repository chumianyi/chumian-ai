...
/// Pink themed code debounced search button
class PinkCodeDebouncedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDebouncedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDebouncedSearchButton> createState() => _PinkCodeDebouncedSearchButtonState();
}

class _PinkCodeDebouncedSearchButtonState extends State<PinkCodeDebouncedSearchButton> with SingleTickerProviderStateMixin {
