...
/// Pink themed notification button
class PinkNotificationButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNotificationButton> createState() => _PinkNotificationButtonState();
}

class _PinkNotificationButtonState extends State<PinkNotificationButton> with SingleTickerProviderStateMixin {
