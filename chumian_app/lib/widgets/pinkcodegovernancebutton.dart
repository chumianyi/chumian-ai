...
/// Pink themed code governance button
class PinkCodeGovernanceButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeGovernanceButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeGovernanceButton> createState() => _PinkCodeGovernanceButtonState();
}

class _PinkCodeGovernanceButtonState extends State<PinkCodeGovernanceButton> with SingleTickerProviderStateMixin {
