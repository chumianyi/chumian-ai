...
/// Pink themed content creator button
class PinkContentCreatorButton extends StatefulWidget {
  final String? text;
  ...
  const PinkContentCreatorButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkContentCreatorButton> createState() => _PinkContentCreatorButtonState();
}

class _PinkContentCreatorButtonState extends State<PinkContentCreatorButton> with SingleTickerProviderStateMixin {
