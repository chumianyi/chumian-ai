...
/// Pink themed code methodology button
class PinkCodeMethodologyButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMethodologyButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMethodologyButton> createState() => _PinkCodeMethodologyButtonState();
}

class _PinkCodeMethodologyButtonState extends State<PinkCodeMethodologyButton> with SingleTickerProviderStateMixin {
