...
/// Pink themed code cuckoo filter button
class PinkCodeCuckooFilterButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCuckooFilterButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCuckooFilterButton> createState() => _PinkCodeCuckooFilterButtonState();
}

class _PinkCodeCuckooFilterButtonState extends State<PinkCodeCuckooFilterButton> with SingleTickerProviderStateMixin {
