...
/// Pink themed code cloud-compliance search button
class PinkCodeCloudComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudComplianceSearchButton> createState() => _PinkCodeCloudComplianceSearchButtonState();
}

class _PinkCodeCloudComplianceSearchButtonState extends State<PinkCodeCloudComplianceSearchButton> with SingleTickerProviderStateMixin {
