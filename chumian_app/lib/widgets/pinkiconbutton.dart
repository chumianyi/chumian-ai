...
/// Pink themed icon button
class PinkIconButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkIconButton> createState() => _PinkIconButtonState();
}

class _PinkIconButtonState extends State<PinkIconButton> with SingleTickerProviderStateMixin {
