...
/// Pink themed code principle button
class PinkCodePrincipleButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodePrincipleButton> createState() => _PinkCodePrincipleButtonState();
}

class _PinkCodePrincipleButtonState extends State<PinkCodePrincipleButton> with SingleTickerProviderStateMixin {
