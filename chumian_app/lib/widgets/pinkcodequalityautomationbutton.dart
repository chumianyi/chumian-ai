...
/// Pink themed code quality automation button
class PinkCodeQualityAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeQualityAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeQualityAutomationButton> createState() => _PinkCodeQualityAutomationButtonState();
}

class _PinkCodeQualityAutomationButtonState extends State<PinkCodeQualityAutomationButton> with SingleTickerProviderStateMixin {
