...
/// Pink themed code cloud-CV search button
class PinkCodeCloudCvSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudCvSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudCvSearchButton> createState() => _PinkCodeCloudCvSearchButtonState();
}

class _PinkCodeCloudCvSearchButtonState extends State<PinkCodeCloudCvSearchButton> with SingleTickerProviderStateMixin {
