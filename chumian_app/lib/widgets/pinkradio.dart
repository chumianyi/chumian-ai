...
/// Pink themed radio
class PinkRadio extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRadio> createState() => _PinkRadioState();
}

class _PinkRadioState extends State<PinkRadio> with SingleTickerProviderStateMixin {
