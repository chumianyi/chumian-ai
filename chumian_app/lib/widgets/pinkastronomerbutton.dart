...
/// Pink themed astronomer button
class PinkAstronomerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAstronomerButton> createState() => _PinkAstronomerButtonState();
}

class _PinkAstronomerButtonState extends State<PinkAstronomerButton> with SingleTickerProviderStateMixin {
