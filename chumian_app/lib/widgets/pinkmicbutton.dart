...
/// Pink themed mic button
class PinkMicButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMicButton> createState() => _PinkMicButtonState();
}

class _PinkMicButtonState extends State<PinkMicButton> with SingleTickerProviderStateMixin {
