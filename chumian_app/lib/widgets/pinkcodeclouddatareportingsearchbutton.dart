...
/// Pink themed code cloud-data-reporting search button
class PinkCodeCloudDataReportingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataReportingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataReportingSearchButton> createState() => _PinkCodeCloudDataReportingSearchButtonState();
}

class _PinkCodeCloudDataReportingSearchButtonState extends State<PinkCodeCloudDataReportingSearchButton> with SingleTickerProviderStateMixin {
