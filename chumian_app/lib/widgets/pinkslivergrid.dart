...
/// Pink themed sliver grid
class PinkSliverGrid extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSliverGrid> createState() => _PinkSliverGridState();
}

class _PinkSliverGridState extends State<PinkSliverGrid> with SingleTickerProviderStateMixin {
