...
/// Pink themed code offline search button
class PinkCodeOfflineSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeOfflineSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeOfflineSearchButton> createState() => _PinkCodeOfflineSearchButtonState();
}

class _PinkCodeOfflineSearchButtonState extends State<PinkCodeOfflineSearchButton> with SingleTickerProviderStateMixin {
