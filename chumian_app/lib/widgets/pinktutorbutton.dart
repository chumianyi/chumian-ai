...
/// Pink themed tutor button
class PinkTutorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTutorButton> createState() => _PinkTutorButtonState();
}

class _PinkTutorButtonState extends State<PinkTutorButton> with SingleTickerProviderStateMixin {
