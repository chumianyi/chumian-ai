...
/// Pink themed text button
class PinkTextButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTextButton> createState() => _PinkTextButtonState();
}

class _PinkTextButtonState extends State<PinkTextButton> with SingleTickerProviderStateMixin {
