...
/// Pink themed area manager button
class PinkAreaManagerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAreaManagerButton> createState() => _PinkAreaManagerButtonState();
}

class _PinkAreaManagerButtonState extends State<PinkAreaManagerButton> with SingleTickerProviderStateMixin {
