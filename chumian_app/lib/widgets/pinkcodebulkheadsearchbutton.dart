...
/// Pink themed code bulkhead search button
class PinkCodeBulkheadSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeBulkheadSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeBulkheadSearchButton> createState() => _PinkCodeBulkheadSearchButtonState();
}

class _PinkCodeBulkheadSearchButtonState extends State<PinkCodeBulkheadSearchButton> with SingleTickerProviderStateMixin {
