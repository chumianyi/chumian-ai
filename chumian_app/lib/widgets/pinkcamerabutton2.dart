...
/// Pink themed camera button
class PinkCameraButton2 extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCameraButton2> createState() => _PinkCameraButton2State();
}

class _PinkCameraButton2State extends State<PinkCameraButton2> with SingleTickerProviderStateMixin {
