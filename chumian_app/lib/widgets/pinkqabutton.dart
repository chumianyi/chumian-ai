...
/// Pink themed QA button
class PinkQaButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkQaButton> createState() => _PinkQaButtonState();
}

class _PinkQaButtonState extends State<PinkQaButton> with SingleTickerProviderStateMixin {
