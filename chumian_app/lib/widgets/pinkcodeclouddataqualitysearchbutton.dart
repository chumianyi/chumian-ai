...
/// Pink themed code cloud-data-quality search button
class PinkCodeCloudDataQualitySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataQualitySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataQualitySearchButton> createState() => _PinkCodeCloudDataQualitySearchButtonState();
}

class _PinkCodeCloudDataQualitySearchButtonState extends State<PinkCodeCloudDataQualitySearchButton> with SingleTickerProviderStateMixin {
