...
/// Pink themed equalizer button
class PinkEqualizerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkEqualizerButton> createState() => _PinkEqualizerButtonState();
}

class _PinkEqualizerButtonState extends State<PinkEqualizerButton> with SingleTickerProviderStateMixin {
