...
/// Pink themed code graph button
class PinkCodeGraphButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeGraphButton> createState() => _PinkCodeGraphButtonState();
}

class _PinkCodeGraphButtonState extends State<PinkCodeGraphButton> with SingleTickerProviderStateMixin {
