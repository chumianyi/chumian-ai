...
/// Pink themed code alerting button
class PinkCodeAlertingButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeAlertingButton> createState() => _PinkCodeAlertingButtonState();
}

class _PinkCodeAlertingButtonState extends State<PinkCodeAlertingButton> with SingleTickerProviderStateMixin {
