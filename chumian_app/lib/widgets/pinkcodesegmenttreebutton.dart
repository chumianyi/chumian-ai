...
/// Pink themed code segment tree button
class PinkCodeSegmentTreeButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSegmentTreeButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSegmentTreeButton> createState() => _PinkCodeSegmentTreeButtonState();
}

class _PinkCodeSegmentTreeButtonState extends State<PinkCodeSegmentTreeButton> with SingleTickerProviderStateMixin {
