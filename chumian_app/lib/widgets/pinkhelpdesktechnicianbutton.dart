...
/// Pink themed helpdesk technician button
class PinkHelpdeskTechnicianButton extends StatefulWidget {
  final String? text;
  ...
  const PinkHelpdeskTechnicianButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkHelpdeskTechnicianButton> createState() => _PinkHelpdeskTechnicianButtonState();
}

class _PinkHelpdeskTechnicianButtonState extends State<PinkHelpdeskTechnicianButton> with SingleTickerProviderStateMixin {
