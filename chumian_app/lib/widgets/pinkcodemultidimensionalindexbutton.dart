...
/// Pink themed code multidimensional index button
class PinkCodeMultidimensionalIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMultidimensionalIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMultidimensionalIndexButton> createState() => _PinkCodeMultidimensionalIndexButtonState();
}

class _PinkCodeMultidimensionalIndexButtonState extends State<PinkCodeMultidimensionalIndexButton> with SingleTickerProviderStateMixin {
