...
/// Pink themed code prefetch search button
class PinkCodePrefetchSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodePrefetchSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodePrefetchSearchButton> createState() => _PinkCodePrefetchSearchButtonState();
}

class _PinkCodePrefetchSearchButtonState extends State<PinkCodePrefetchSearchButton> with SingleTickerProviderStateMixin {
