...
/// Pink themed minimize button
class PinkMinimizeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMinimizeButton> createState() => _PinkMinimizeButtonState();
}

class _PinkMinimizeButtonState extends State<PinkMinimizeButton> with SingleTickerProviderStateMixin {
