...
/// Pink themed diagnostic analytics button
class PinkDiagnosticAnalyticsButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDiagnosticAnalyticsButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDiagnosticAnalyticsButton> createState() => _PinkDiagnosticAnalyticsButtonState();
}

class _PinkDiagnosticAnalyticsButtonState extends State<PinkDiagnosticAnalyticsButton> with SingleTickerProviderStateMixin {
