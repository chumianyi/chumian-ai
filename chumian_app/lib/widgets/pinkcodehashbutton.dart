...
/// Pink themed code hash button
class PinkCodeHashButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeHashButton> createState() => _PinkCodeHashButtonState();
}

class _PinkCodeHashButtonState extends State<PinkCodeHashButton> with SingleTickerProviderStateMixin {
