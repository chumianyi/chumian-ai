...
/// Pink themed code embedding search button
class PinkCodeEmbeddingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeEmbeddingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeEmbeddingSearchButton> createState() => _PinkCodeEmbeddingSearchButtonState();
}

class _PinkCodeEmbeddingSearchButtonState extends State<PinkCodeEmbeddingSearchButton> with SingleTickerProviderStateMixin {
