...
/// Pink themed save button
class PinkSaveButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSaveButton> createState() => _PinkSaveButtonState();
}

class _PinkSaveButtonState extends State<PinkSaveButton> with SingleTickerProviderStateMixin {
