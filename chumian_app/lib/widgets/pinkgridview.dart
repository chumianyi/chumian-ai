...
/// Pink themed grid view
class PinkGridView extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkGridView> createState() => _PinkGridViewState();
}

class _PinkGridViewState extends State<PinkGridView> with SingleTickerProviderStateMixin {
