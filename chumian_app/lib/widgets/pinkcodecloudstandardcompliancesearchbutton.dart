...
/// Pink themed code cloud-standard-compliance search button
class PinkCodeCloudStandardComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudStandardComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudStandardComplianceSearchButton> createState() => _PinkCodeCloudStandardComplianceSearchButtonState();
}

class _PinkCodeCloudStandardComplianceSearchButtonState extends State<PinkCodeCloudStandardComplianceSearchButton> with SingleTickerProviderStateMixin {
