...
/// Pink themed code high-dimensional index button
class PinkCodeHighDimensionalIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeHighDimensionalIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeHighDimensionalIndexButton> createState() => _PinkCodeHighDimensionalIndexButtonState();
}

class _PinkCodeHighDimensionalIndexButtonState extends State<PinkCodeHighDimensionalIndexButton> with SingleTickerProviderStateMixin {
