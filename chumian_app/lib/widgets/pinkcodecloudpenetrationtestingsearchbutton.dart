...
/// Pink themed code cloud-penetration-testing search button
class PinkCodeCloudPenetrationTestingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudPenetrationTestingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudPenetrationTestingSearchButton> createState() => _PinkCodeCloudPenetrationTestingSearchButtonState();
}

class _PinkCodeCloudPenetrationTestingSearchButtonState extends State<PinkCodeCloudPenetrationTestingSearchButton> with SingleTickerProviderStateMixin {
