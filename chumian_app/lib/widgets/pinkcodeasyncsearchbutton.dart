...
/// Pink themed code async search button
class PinkCodeAsyncSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeAsyncSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeAsyncSearchButton> createState() => _PinkCodeAsyncSearchButtonState();
}

class _PinkCodeAsyncSearchButtonState extends State<PinkCodeAsyncSearchButton> with SingleTickerProviderStateMixin {
