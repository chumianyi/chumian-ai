...
/// Pink themed code neural search button
class PinkCodeNeuralSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeNeuralSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeNeuralSearchButton> createState() => _PinkCodeNeuralSearchButtonState();
}

class _PinkCodeNeuralSearchButtonState extends State<PinkCodeNeuralSearchButton> with SingleTickerProviderStateMixin {
