...
/// Pink themed code cloud-cost search button
class PinkCodeCloudCostSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudCostSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudCostSearchButton> createState() => _PinkCodeCloudCostSearchButtonState();
}

class _PinkCodeCloudCostSearchButtonState extends State<PinkCodeCloudCostSearchButton> with SingleTickerProviderStateMixin {
