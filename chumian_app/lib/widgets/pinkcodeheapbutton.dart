...
/// Pink themed code heap button
class PinkCodeHeapButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeHeapButton> createState() => _PinkCodeHeapButtonState();
}

class _PinkCodeHeapButtonState extends State<PinkCodeHeapButton> with SingleTickerProviderStateMixin {
