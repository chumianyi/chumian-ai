...
/// Pink themed neuroscientist button
class PinkNeuroscientistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkNeuroscientistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkNeuroscientistButton> createState() => _PinkNeuroscientistButtonState();
}

class _PinkNeuroscientistButtonState extends State<PinkNeuroscientistButton> with SingleTickerProviderStateMixin {
