...
/// Pink themed code cloud-memory-AI search button
class PinkCodeCloudMemoryAiSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudMemoryAiSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudMemoryAiSearchButton> createState() => _PinkCodeCloudMemoryAiSearchButtonState();
}

class _PinkCodeCloudMemoryAiSearchButtonState extends State<PinkCodeCloudMemoryAiSearchButton> with SingleTickerProviderStateMixin {
