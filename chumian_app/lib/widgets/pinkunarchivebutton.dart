...
/// Pink themed unarchive button
class PinkUnarchiveButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkUnarchiveButton> createState() => _PinkUnarchiveButtonState();
}

class _PinkUnarchiveButtonState extends State<PinkUnarchiveButton> with SingleTickerProviderStateMixin {
