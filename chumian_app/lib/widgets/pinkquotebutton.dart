...
/// Pink themed quote button
class PinkQuoteButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkQuoteButton> createState() => _PinkQuoteButtonState();
}

class _PinkQuoteButtonState extends State<PinkQuoteButton> with SingleTickerProviderStateMixin {
