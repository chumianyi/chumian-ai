...
/// Pink themed code deployment automation button
class PinkCodeDeploymentAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDeploymentAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDeploymentAutomationButton> createState() => _PinkCodeDeploymentAutomationButtonState();
}

class _PinkCodeDeploymentAutomationButtonState extends State<PinkCodeDeploymentAutomationButton> with SingleTickerProviderStateMixin {
