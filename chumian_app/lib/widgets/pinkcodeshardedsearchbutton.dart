...
/// Pink themed code sharded search button
class PinkCodeShardedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeShardedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeShardedSearchButton> createState() => _PinkCodeShardedSearchButtonState();
}

class _PinkCodeShardedSearchButtonState extends State<PinkCodeShardedSearchButton> with SingleTickerProviderStateMixin {
