...
/// Pink themed code interval tree button
class PinkCodeIntervalTreeButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeIntervalTreeButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeIntervalTreeButton> createState() => _PinkCodeIntervalTreeButtonState();
}

class _PinkCodeIntervalTreeButtonState extends State<PinkCodeIntervalTreeButton> with SingleTickerProviderStateMixin {
