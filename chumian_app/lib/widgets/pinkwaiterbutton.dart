...
/// Pink themed waiter button
class PinkWaiterButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkWaiterButton> createState() => _PinkWaiterButtonState();
}

class _PinkWaiterButtonState extends State<PinkWaiterButton> with SingleTickerProviderStateMixin {
