...
/// Pink themed code minification button
class PinkCodeMinificationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMinificationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMinificationButton> createState() => _PinkCodeMinificationButtonState();
}

class _PinkCodeMinificationButtonState extends State<PinkCodeMinificationButton> with SingleTickerProviderStateMixin {
