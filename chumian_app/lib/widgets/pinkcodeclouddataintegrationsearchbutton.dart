...
/// Pink themed code cloud-data-integration search button
class PinkCodeCloudDataIntegrationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataIntegrationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataIntegrationSearchButton> createState() => _PinkCodeCloudDataIntegrationSearchButtonState();
}

class _PinkCodeCloudDataIntegrationSearchButtonState extends State<PinkCodeCloudDataIntegrationSearchButton> with SingleTickerProviderStateMixin {
