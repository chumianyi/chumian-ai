...
/// Pink themed transfer learning button
class PinkTransferLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkTransferLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkTransferLearningButton> createState() => _PinkTransferLearningButtonState();
}

class _PinkTransferLearningButtonState extends State<PinkTransferLearningButton> with SingleTickerProviderStateMixin {
