...
/// Pink themed code monitoring button
class PinkCodeMonitoringButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeMonitoringButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeMonitoringButton> createState() => _PinkCodeMonitoringButtonState();
}

class _PinkCodeMonitoringButtonState extends State<PinkCodeMonitoringButton> with SingleTickerProviderStateMixin {
