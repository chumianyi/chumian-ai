...
/// Pink themed code organization button
class PinkCodeOrganizationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeOrganizationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeOrganizationButton> createState() => _PinkCodeOrganizationButtonState();
}

class _PinkCodeOrganizationButtonState extends State<PinkCodeOrganizationButton> with SingleTickerProviderStateMixin {
