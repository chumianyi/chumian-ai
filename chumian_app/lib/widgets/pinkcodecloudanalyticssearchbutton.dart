...
/// Pink themed code cloud-analytics search button
class PinkCodeCloudAnalyticsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudAnalyticsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudAnalyticsSearchButton> createState() => _PinkCodeCloudAnalyticsSearchButtonState();
}

class _PinkCodeCloudAnalyticsSearchButtonState extends State<PinkCodeCloudAnalyticsSearchButton> with SingleTickerProviderStateMixin {
