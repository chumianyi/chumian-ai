...
/// Pink themed code cloud-data-federation search button
class PinkCodeCloudDataFederationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataFederationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataFederationSearchButton> createState() => _PinkCodeCloudDataFederationSearchButtonState();
}

class _PinkCodeCloudDataFederationSearchButtonState extends State<PinkCodeCloudDataFederationSearchButton> with SingleTickerProviderStateMixin {
