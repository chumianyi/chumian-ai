...
/// Pink themed code ANN button
class PinkCodeApproximateNearestNeighborButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeApproximateNearestNeighborButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeApproximateNearestNeighborButton> createState() => _PinkCodeApproximateNearestNeighborButtonState();
}

class _PinkCodeApproximateNearestNeighborButtonState extends State<PinkCodeApproximateNearestNeighborButton> with SingleTickerProviderStateMixin {
