...
/// Pink themed code cloud-governance-framework search button
class PinkCodeCloudGovernanceFrameworkSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudGovernanceFrameworkSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudGovernanceFrameworkSearchButton> createState() => _PinkCodeCloudGovernanceFrameworkSearchButtonState();
}

class _PinkCodeCloudGovernanceFrameworkSearchButtonState extends State<PinkCodeCloudGovernanceFrameworkSearchButton> with SingleTickerProviderStateMixin {
