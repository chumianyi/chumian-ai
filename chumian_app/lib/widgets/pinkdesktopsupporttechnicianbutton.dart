...
/// Pink themed desktop support technician button
class PinkDesktopSupportTechnicianButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDesktopSupportTechnicianButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDesktopSupportTechnicianButton> createState() => _PinkDesktopSupportTechnicianButtonState();
}

class _PinkDesktopSupportTechnicianButtonState extends State<PinkDesktopSupportTechnicianButton> with SingleTickerProviderStateMixin {
