...
/// Pink themed code cloud-data-masking search button
class PinkCodeCloudDataMaskingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataMaskingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataMaskingSearchButton> createState() => _PinkCodeCloudDataMaskingSearchButtonState();
}

class _PinkCodeCloudDataMaskingSearchButtonState extends State<PinkCodeCloudDataMaskingSearchButton> with SingleTickerProviderStateMixin {
