...
/// Pink themed mechanic button
class PinkMechanicButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMechanicButton> createState() => _PinkMechanicButtonState();
}

class _PinkMechanicButtonState extends State<PinkMechanicButton> with SingleTickerProviderStateMixin {
