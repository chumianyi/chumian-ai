...
/// Pink themed ensemble learning button
class PinkEnsembleLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkEnsembleLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkEnsembleLearningButton> createState() => _PinkEnsembleLearningButtonState();
}

class _PinkEnsembleLearningButtonState extends State<PinkEnsembleLearningButton> with SingleTickerProviderStateMixin {
