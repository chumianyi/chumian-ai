...
/// Pink themed code compilation button
class PinkCodeCompilationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCompilationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCompilationButton> createState() => _PinkCodeCompilationButtonState();
}

class _PinkCodeCompilationButtonState extends State<PinkCodeCompilationButton> with SingleTickerProviderStateMixin {
