...
/// Pink themed code quality button
class PinkCodeQualityButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeQualityButton> createState() => _PinkCodeQualityButtonState();
}

class _PinkCodeQualityButtonState extends State<PinkCodeQualityButton> with SingleTickerProviderStateMixin {
