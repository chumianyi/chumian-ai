...
/// Pink themed problem manager button
class PinkProblemManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkProblemManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkProblemManagerButton> createState() => _PinkProblemManagerButtonState();
}

class _PinkProblemManagerButtonState extends State<PinkProblemManagerButton> with SingleTickerProviderStateMixin {
