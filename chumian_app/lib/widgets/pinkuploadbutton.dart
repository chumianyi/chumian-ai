...
/// Pink themed upload button
class PinkUploadButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkUploadButton> createState() => _PinkUploadButtonState();
}

class _PinkUploadButtonState extends State<PinkUploadButton> with SingleTickerProviderStateMixin {
