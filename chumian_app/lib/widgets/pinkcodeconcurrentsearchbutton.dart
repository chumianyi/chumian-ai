...
/// Pink themed code concurrent search button
class PinkCodeConcurrentSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeConcurrentSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeConcurrentSearchButton> createState() => _PinkCodeConcurrentSearchButtonState();
}

class _PinkCodeConcurrentSearchButtonState extends State<PinkCodeConcurrentSearchButton> with SingleTickerProviderStateMixin {
