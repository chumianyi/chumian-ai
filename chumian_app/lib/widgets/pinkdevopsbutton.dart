...
/// Pink themed DevOps button
class PinkDevopsButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDevopsButton> createState() => _PinkDevopsButtonState();
}

class _PinkDevopsButtonState extends State<PinkDevopsButton> with SingleTickerProviderStateMixin {
