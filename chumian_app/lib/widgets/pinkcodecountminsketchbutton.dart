...
/// Pink themed code count-min sketch button
class PinkCodeCountMinSketchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCountMinSketchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCountMinSketchButton> createState() => _PinkCodeCountMinSketchButtonState();
}

class _PinkCodeCountMinSketchButtonState extends State<PinkCodeCountMinSketchButton> with SingleTickerProviderStateMixin {
