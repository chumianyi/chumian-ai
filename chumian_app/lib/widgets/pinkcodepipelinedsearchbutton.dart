...
/// Pink themed code pipelined search button
class PinkCodePipelinedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodePipelinedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodePipelinedSearchButton> createState() => _PinkCodePipelinedSearchButtonState();
}

class _PinkCodePipelinedSearchButtonState extends State<PinkCodePipelinedSearchButton> with SingleTickerProviderStateMixin {
