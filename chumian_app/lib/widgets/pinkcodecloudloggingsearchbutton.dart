...
/// Pink themed code cloud-logging search button
class PinkCodeCloudLoggingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudLoggingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudLoggingSearchButton> createState() => _PinkCodeCloudLoggingSearchButtonState();
}

class _PinkCodeCloudLoggingSearchButtonState extends State<PinkCodeCloudLoggingSearchButton> with SingleTickerProviderStateMixin {
