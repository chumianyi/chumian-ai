...
/// Pink themed code cloud-policy-management search button
class PinkCodeCloudPolicyManagementSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudPolicyManagementSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudPolicyManagementSearchButton> createState() => _PinkCodeCloudPolicyManagementSearchButtonState();
}

class _PinkCodeCloudPolicyManagementSearchButtonState extends State<PinkCodeCloudPolicyManagementSearchButton> with SingleTickerProviderStateMixin {
