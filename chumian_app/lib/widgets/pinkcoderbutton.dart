...
/// Pink themed coder button
class PinkCoderButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCoderButton> createState() => _PinkCoderButtonState();
}

class _PinkCoderButtonState extends State<PinkCoderButton> with SingleTickerProviderStateMixin {
