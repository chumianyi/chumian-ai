...
/// Pink themed facilities manager button
class PinkFacilitiesManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFacilitiesManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFacilitiesManagerButton> createState() => _PinkFacilitiesManagerButtonState();
}

class _PinkFacilitiesManagerButtonState extends State<PinkFacilitiesManagerButton> with SingleTickerProviderStateMixin {
