...
/// Pink themed data scientist button
class PinkDataScientistButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDataScientistButton> createState() => _PinkDataScientistButtonState();
}

class _PinkDataScientistButtonState extends State<PinkDataScientistButton> with SingleTickerProviderStateMixin {
