...
/// Pink themed text-to-video button
class PinkTextToVideoButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTextToVideoButton> createState() => _PinkTextToVideoButtonState();
}

class _PinkTextToVideoButtonState extends State<PinkTextToVideoButton> with SingleTickerProviderStateMixin {
