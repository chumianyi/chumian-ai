...
/// Pink themed cognitive scientist button
class PinkCognitiveScientistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCognitiveScientistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCognitiveScientistButton> createState() => _PinkCognitiveScientistButtonState();
}

class _PinkCognitiveScientistButtonState extends State<PinkCognitiveScientistButton> with SingleTickerProviderStateMixin {
