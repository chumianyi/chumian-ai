...
/// Pink themed piano button
class PinkPianoButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPianoButton> createState() => _PinkPianoButtonState();
}

class _PinkPianoButtonState extends State<PinkPianoButton> with SingleTickerProviderStateMixin {
