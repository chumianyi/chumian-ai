...
/// Pink themed project manager button
class PinkProjectManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkProjectManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkProjectManagerButton> createState() => _PinkProjectManagerButtonState();
}

class _PinkProjectManagerButtonState extends State<PinkProjectManagerButton> with SingleTickerProviderStateMixin {
