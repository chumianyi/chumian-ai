...
/// Pink themed code cloud-data-standardization search button
class PinkCodeCloudDataStandardizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataStandardizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataStandardizationSearchButton> createState() => _PinkCodeCloudDataStandardizationSearchButtonState();
}

class _PinkCodeCloudDataStandardizationSearchButtonState extends State<PinkCodeCloudDataStandardizationSearchButton> with SingleTickerProviderStateMixin {
