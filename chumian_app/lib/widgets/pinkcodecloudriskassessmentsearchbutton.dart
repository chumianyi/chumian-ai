...
/// Pink themed code cloud-risk-assessment search button
class PinkCodeCloudRiskAssessmentSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRiskAssessmentSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRiskAssessmentSearchButton> createState() => _PinkCodeCloudRiskAssessmentSearchButtonState();
}

class _PinkCodeCloudRiskAssessmentSearchButtonState extends State<PinkCodeCloudRiskAssessmentSearchButton> with SingleTickerProviderStateMixin {
