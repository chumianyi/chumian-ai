...
/// Pink themed code vector search button
class PinkCodeVectorSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeVectorSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeVectorSearchButton> createState() => _PinkCodeVectorSearchButtonState();
}

class _PinkCodeVectorSearchButtonState extends State<PinkCodeVectorSearchButton> with SingleTickerProviderStateMixin {
