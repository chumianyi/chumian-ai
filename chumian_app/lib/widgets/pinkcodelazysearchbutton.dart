...
/// Pink themed code lazy search button
class PinkCodeLazySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeLazySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeLazySearchButton> createState() => _PinkCodeLazySearchButtonState();
}

class _PinkCodeLazySearchButtonState extends State<PinkCodeLazySearchButton> with SingleTickerProviderStateMixin {
