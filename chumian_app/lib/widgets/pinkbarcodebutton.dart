...
/// Pink themed barcode button
class PinkBarcodeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkBarcodeButton> createState() => _PinkBarcodeButtonState();
}

class _PinkBarcodeButtonState extends State<PinkBarcodeButton> with SingleTickerProviderStateMixin {
