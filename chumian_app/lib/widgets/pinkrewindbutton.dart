...
/// Pink themed rewind button
class PinkRewindButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRewindButton> createState() => _PinkRewindButtonState();
}

class _PinkRewindButtonState extends State<PinkRewindButton> with SingleTickerProviderStateMixin {
