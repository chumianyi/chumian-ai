...
/// Pink themed dialog
class PinkDialog extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDialog> createState() => _PinkDialogState();
}

class _PinkDialogState extends State<PinkDialog> with SingleTickerProviderStateMixin {
