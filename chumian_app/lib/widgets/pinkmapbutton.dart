...
/// Pink themed map button
class PinkMapButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMapButton> createState() => _PinkMapButtonState();
}

class _PinkMapButtonState extends State<PinkMapButton> with SingleTickerProviderStateMixin {
