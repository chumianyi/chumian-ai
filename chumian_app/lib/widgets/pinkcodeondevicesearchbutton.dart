...
/// Pink themed code on-device search button
class PinkCodeOnDeviceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeOnDeviceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeOnDeviceSearchButton> createState() => _PinkCodeOnDeviceSearchButtonState();
}

class _PinkCodeOnDeviceSearchButtonState extends State<PinkCodeOnDeviceSearchButton> with SingleTickerProviderStateMixin {
