...
/// Pink themed event button
class PinkEventButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkEventButton> createState() => _PinkEventButtonState();
}

class _PinkEventButtonState extends State<PinkEventButton> with SingleTickerProviderStateMixin {
