...
/// Pink themed data viz expert button
class PinkDataVisualizationExpertButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDataVisualizationExpertButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDataVisualizationExpertButton> createState() => _PinkDataVisualizationExpertButtonState();
}

class _PinkDataVisualizationExpertButtonState extends State<PinkDataVisualizationExpertButton> with SingleTickerProviderStateMixin {
