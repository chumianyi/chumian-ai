...
/// Pink themed countdown button
class PinkCountdownButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCountdownButton> createState() => _PinkCountdownButtonState();
}

class _PinkCountdownButtonState extends State<PinkCountdownButton> with SingleTickerProviderStateMixin {
