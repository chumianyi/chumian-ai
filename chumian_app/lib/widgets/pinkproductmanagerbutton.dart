...
/// Pink themed product manager button
class PinkProductManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkProductManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkProductManagerButton> createState() => _PinkProductManagerButtonState();
}

class _PinkProductManagerButtonState extends State<PinkProductManagerButton> with SingleTickerProviderStateMixin {
