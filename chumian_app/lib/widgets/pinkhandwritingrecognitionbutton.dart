...
/// Pink themed handwriting recognition button
class PinkHandwritingRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkHandwritingRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkHandwritingRecognitionButton> createState() => _PinkHandwritingRecognitionButtonState();
}

class _PinkHandwritingRecognitionButtonState extends State<PinkHandwritingRecognitionButton> with SingleTickerProviderStateMixin {
