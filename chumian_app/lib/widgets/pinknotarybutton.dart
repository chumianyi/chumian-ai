...
/// Pink themed notary button
class PinkNotaryButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkNotaryButton> createState() => _PinkNotaryButtonState();
}

class _PinkNotaryButtonState extends State<PinkNotaryButton> with SingleTickerProviderStateMixin {
