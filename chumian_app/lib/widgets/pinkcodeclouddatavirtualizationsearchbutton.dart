...
/// Pink themed code cloud-data-virtualization search button
class PinkCodeCloudDataVirtualizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataVirtualizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataVirtualizationSearchButton> createState() => _PinkCodeCloudDataVirtualizationSearchButtonState();
}

class _PinkCodeCloudDataVirtualizationSearchButtonState extends State<PinkCodeCloudDataVirtualizationSearchButton> with SingleTickerProviderStateMixin {
