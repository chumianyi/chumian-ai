...
/// Pink themed code cloud-compliance-assessment search button
class PinkCodeCloudComplianceAssessmentSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudComplianceAssessmentSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudComplianceAssessmentSearchButton> createState() => _PinkCodeCloudComplianceAssessmentSearchButtonState();
}

class _PinkCodeCloudComplianceAssessmentSearchButtonState extends State<PinkCodeCloudComplianceAssessmentSearchButton> with SingleTickerProviderStateMixin {
