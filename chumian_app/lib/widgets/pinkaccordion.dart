...
/// Pink themed accordion
class PinkAccordion extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAccordion> createState() => _PinkAccordionState();
}

class _PinkAccordionState extends State<PinkAccordion> with SingleTickerProviderStateMixin {
