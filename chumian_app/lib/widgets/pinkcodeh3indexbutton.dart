...
/// Pink themed code H3 index button
class PinkCodeH3IndexButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeH3IndexButton> createState() => _PinkCodeH3IndexButtonState();
}

class _PinkCodeH3IndexButtonState extends State<PinkCodeH3IndexButton> with SingleTickerProviderStateMixin {
