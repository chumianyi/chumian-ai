...
/// Pink themed speech recognition button
class PinkSpeechRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkSpeechRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkSpeechRecognitionButton> createState() => _PinkSpeechRecognitionButtonState();
}

class _PinkSpeechRecognitionButtonState extends State<PinkSpeechRecognitionButton> with SingleTickerProviderStateMixin {
