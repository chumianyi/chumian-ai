...
/// Pink themed code security automation button
class PinkCodeSecurityAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeSecurityAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeSecurityAutomationButton> createState() => _PinkCodeSecurityAutomationButtonState();
}

class _PinkCodeSecurityAutomationButtonState extends State<PinkCodeSecurityAutomationButton> with SingleTickerProviderStateMixin {
