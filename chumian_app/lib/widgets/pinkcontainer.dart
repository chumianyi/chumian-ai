...
class PinkContainer extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkContainer> createState() => _PinkContainerState();
}

class _PinkContainerState extends State<PinkContainer> with SingleTickerProviderStateMixin {
