...
/// Pink themed minus button
class PinkMinusButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMinusButton> createState() => _PinkMinusButtonState();
}

class _PinkMinusButtonState extends State<PinkMinusButton> with SingleTickerProviderStateMixin {
