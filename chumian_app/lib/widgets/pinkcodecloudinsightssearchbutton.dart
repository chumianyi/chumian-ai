...
/// Pink themed code cloud-insights search button
class PinkCodeCloudInsightsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudInsightsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudInsightsSearchButton> createState() => _PinkCodeCloudInsightsSearchButtonState();
}

class _PinkCodeCloudInsightsSearchButtonState extends State<PinkCodeCloudInsightsSearchButton> with SingleTickerProviderStateMixin {
