...
/// Pink themed BI analyst button
class PinkBusinessIntelligenceAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkBusinessIntelligenceAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkBusinessIntelligenceAnalystButton> createState() => _PinkBusinessIntelligenceAnalystButtonState();
}

class _PinkBusinessIntelligenceAnalystButtonState extends State<PinkBusinessIntelligenceAnalystButton> with SingleTickerProviderStateMixin {
