...
/// Pink themed code management button
class PinkCodeManagementButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeManagementButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeManagementButton> createState() => _PinkCodeManagementButtonState();
}

class _PinkCodeManagementButtonState extends State<PinkCodeManagementButton> with SingleTickerProviderStateMixin {
