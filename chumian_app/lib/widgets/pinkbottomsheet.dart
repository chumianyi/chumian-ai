...
/// Pink themed bottom sheet
class PinkBottomSheet extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkBottomSheet> createState() => _PinkBottomSheetState();
}

class _PinkBottomSheetState extends State<PinkBottomSheet> with SingleTickerProviderStateMixin {
