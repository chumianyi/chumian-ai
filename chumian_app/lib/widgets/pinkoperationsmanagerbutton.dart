...
/// Pink themed operations manager button
class PinkOperationsManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkOperationsManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkOperationsManagerButton> createState() => _PinkOperationsManagerButtonState();
}

class _PinkOperationsManagerButtonState extends State<PinkOperationsManagerButton> with SingleTickerProviderStateMixin {
