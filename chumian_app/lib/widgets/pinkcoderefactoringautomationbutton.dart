...
/// Pink themed code refactoring automation button
class PinkCodeRefactoringAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeRefactoringAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeRefactoringAutomationButton> createState() => _PinkCodeRefactoringAutomationButtonState();
}

class _PinkCodeRefactoringAutomationButtonState extends State<PinkCodeRefactoringAutomationButton> with SingleTickerProviderStateMixin {
