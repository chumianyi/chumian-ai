...
/// Pink themed activity recognition button
class PinkActivityRecognitionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkActivityRecognitionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkActivityRecognitionButton> createState() => _PinkActivityRecognitionButtonState();
}

class _PinkActivityRecognitionButtonState extends State<PinkActivityRecognitionButton> with SingleTickerProviderStateMixin {
