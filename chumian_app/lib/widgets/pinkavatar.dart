...
/// Pink themed avatar
class PinkAvatar extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAvatar> createState() => _PinkAvatarState();
}

class _PinkAvatarState extends State<PinkAvatar> with SingleTickerProviderStateMixin {
