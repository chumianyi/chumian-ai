...
/// Pink themed code cloud-data-deletion search button
class PinkCodeCloudDataDeletionSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataDeletionSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataDeletionSearchButton> createState() => _PinkCodeCloudDataDeletionSearchButtonState();
}

class _PinkCodeCloudDataDeletionSearchButtonState extends State<PinkCodeCloudDataDeletionSearchButton> with SingleTickerProviderStateMixin {
