...
/// Pink themed code intra-cloud search button
class PinkCodeIntraCloudSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeIntraCloudSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeIntraCloudSearchButton> createState() => _PinkCodeIntraCloudSearchButtonState();
}

class _PinkCodeIntraCloudSearchButtonState extends State<PinkCodeIntraCloudSearchButton> with SingleTickerProviderStateMixin {
