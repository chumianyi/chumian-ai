...
/// Pink themed code cloud-data-science search button
class PinkCodeCloudDataScienceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataScienceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataScienceSearchButton> createState() => _PinkCodeCloudDataScienceSearchButtonState();
}

class _PinkCodeCloudDataScienceSearchButtonState extends State<PinkCodeCloudDataScienceSearchButton> with SingleTickerProviderStateMixin {
