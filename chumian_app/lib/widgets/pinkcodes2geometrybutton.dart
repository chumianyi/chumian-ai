...
/// Pink themed code S2 geometry button
class PinkCodeS2GeometryButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeS2GeometryButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeS2GeometryButton> createState() => _PinkCodeS2GeometryButtonState();
}

class _PinkCodeS2GeometryButtonState extends State<PinkCodeS2GeometryButton> with SingleTickerProviderStateMixin {
