...
/// Pink themed code cloud-regulatory-compliance search button
class PinkCodeCloudRegulatoryComplianceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRegulatoryComplianceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRegulatoryComplianceSearchButton> createState() => _PinkCodeCloudRegulatoryComplianceSearchButtonState();
}

class _PinkCodeCloudRegulatoryComplianceSearchButtonState extends State<PinkCodeCloudRegulatoryComplianceSearchButton> with SingleTickerProviderStateMixin {
