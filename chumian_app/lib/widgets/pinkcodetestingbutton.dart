...
/// Pink themed code testing button
class PinkCodeTestingButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeTestingButton> createState() => _PinkCodeTestingButtonState();
}

class _PinkCodeTestingButtonState extends State<PinkCodeTestingButton> with SingleTickerProviderStateMixin {
