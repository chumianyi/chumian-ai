...
/// Pink themed code formatting button
class PinkCodeFormattingButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeFormattingButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeFormattingButton> createState() => _PinkCodeFormattingButtonState();
}

class _PinkCodeFormattingButtonState extends State<PinkCodeFormattingButton> with SingleTickerProviderStateMixin {
