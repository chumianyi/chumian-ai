...
/// Pink themed code network button
class PinkCodeNetworkButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeNetworkButton> createState() => _PinkCodeNetworkButtonState();
}

class _PinkCodeNetworkButtonState extends State<PinkCodeNetworkButton> with SingleTickerProviderStateMixin {
