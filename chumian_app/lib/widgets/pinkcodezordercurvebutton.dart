...
/// Pink themed code Z-order curve button
class PinkCodeZOrderCurveButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeZOrderCurveButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeZOrderCurveButton> createState() => _PinkCodeZOrderCurveButtonState();
}

class _PinkCodeZOrderCurveButtonState extends State<PinkCodeZOrderCurveButton> with SingleTickerProviderStateMixin {
