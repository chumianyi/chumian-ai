...
/// Pink themed code fallback search button
class PinkCodeFallbackSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeFallbackSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeFallbackSearchButton> createState() => _PinkCodeFallbackSearchButtonState();
}

class _PinkCodeFallbackSearchButtonState extends State<PinkCodeFallbackSearchButton> with SingleTickerProviderStateMixin {
