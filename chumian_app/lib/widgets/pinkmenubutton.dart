...
/// Pink themed menu button
class PinkMenuButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMenuButton> createState() => _PinkMenuButtonState();
}

class _PinkMenuButtonState extends State<PinkMenuButton> with SingleTickerProviderStateMixin {
