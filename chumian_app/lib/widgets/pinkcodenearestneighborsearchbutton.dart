...
/// Pink themed code NNS button
class PinkCodeNearestNeighborSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeNearestNeighborSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeNearestNeighborSearchButton> createState() => _PinkCodeNearestNeighborSearchButtonState();
}

class _PinkCodeNearestNeighborSearchButtonState extends State<PinkCodeNearestNeighborSearchButton> with SingleTickerProviderStateMixin {
