...
/// Pink themed code HyperLogLog button
class PinkCodeHyperLogLogButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeHyperLogLogButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeHyperLogLogButton> createState() => _PinkCodeHyperLogLogButtonState();
}

class _PinkCodeHyperLogLogButtonState extends State<PinkCodeHyperLogLogButton> with SingleTickerProviderStateMixin {
