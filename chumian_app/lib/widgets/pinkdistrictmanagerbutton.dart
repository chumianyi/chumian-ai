...
/// Pink themed district manager button
class PinkDistrictManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkDistrictManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkDistrictManagerButton> createState() => _PinkDistrictManagerButtonState();
}

class _PinkDistrictManagerButtonState extends State<PinkDistrictManagerButton> with SingleTickerProviderStateMixin {
