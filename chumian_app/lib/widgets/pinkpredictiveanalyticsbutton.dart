...
/// Pink themed predictive analytics button
class PinkPredictiveAnalyticsButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPredictiveAnalyticsButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPredictiveAnalyticsButton> createState() => _PinkPredictiveAnalyticsButtonState();
}

class _PinkPredictiveAnalyticsButtonState extends State<PinkPredictiveAnalyticsButton> with SingleTickerProviderStateMixin {
