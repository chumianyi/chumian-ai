...
/// Pink themed code adaptive search button
class PinkCodeAdaptiveSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeAdaptiveSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeAdaptiveSearchButton> createState() => _PinkCodeAdaptiveSearchButtonState();
}

class _PinkCodeAdaptiveSearchButtonState extends State<PinkCodeAdaptiveSearchButton> with SingleTickerProviderStateMixin {
