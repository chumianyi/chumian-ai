...
/// Pink themed code translation button
class PinkCodeTranslationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeTranslationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeTranslationButton> createState() => _PinkCodeTranslationButtonState();
}

class _PinkCodeTranslationButtonState extends State<PinkCodeTranslationButton> with SingleTickerProviderStateMixin {
