...
/// Pink themed code cloud-data-deduplication search button
class PinkCodeCloudDataDeduplicationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataDeduplicationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataDeduplicationSearchButton> createState() => _PinkCodeCloudDataDeduplicationSearchButtonState();
}

class _PinkCodeCloudDataDeduplicationSearchButtonState extends State<PinkCodeCloudDataDeduplicationSearchButton> with SingleTickerProviderStateMixin {
