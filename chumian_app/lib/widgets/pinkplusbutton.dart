...
/// Pink themed plus button
class PinkPlusButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPlusButton> createState() => _PinkPlusButtonState();
}

class _PinkPlusButtonState extends State<PinkPlusButton> with SingleTickerProviderStateMixin {
