...
/// Pink themed investment analyst button
class PinkInvestmentAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkInvestmentAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkInvestmentAnalystButton> createState() => _PinkInvestmentAnalystButtonState();
}

class _PinkInvestmentAnalystButtonState extends State<PinkInvestmentAnalystButton> with SingleTickerProviderStateMixin {
