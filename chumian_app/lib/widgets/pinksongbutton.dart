...
/// Pink themed song button
class PinkSongButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkSongButton> createState() => _PinkSongButtonState();
}

class _PinkSongButtonState extends State<PinkSongButton> with SingleTickerProviderStateMixin {
