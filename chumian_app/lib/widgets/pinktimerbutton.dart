...
/// Pink themed timer button
class PinkTimerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTimerButton> createState() => _PinkTimerButtonState();
}

class _PinkTimerButtonState extends State<PinkTimerButton> with SingleTickerProviderStateMixin {
