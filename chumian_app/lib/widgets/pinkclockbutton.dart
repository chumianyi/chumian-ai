...
/// Pink themed clock button
class PinkClockButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkClockButton> createState() => _PinkClockButtonState();
}

class _PinkClockButtonState extends State<PinkClockButton> with SingleTickerProviderStateMixin {
