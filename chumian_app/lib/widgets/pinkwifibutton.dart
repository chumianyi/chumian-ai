...
/// Pink themed wifi button
class PinkWifiButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkWifiButton> createState() => _PinkWifiButtonState();
}

class _PinkWifiButtonState extends State<PinkWifiButton> with SingleTickerProviderStateMixin {
