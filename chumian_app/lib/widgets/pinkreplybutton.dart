...
/// Pink themed reply button
class PinkReplyButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkReplyButton> createState() => _PinkReplyButtonState();
}

class _PinkReplyButtonState extends State<PinkReplyButton> with SingleTickerProviderStateMixin {
