...
/// Pink themed open button
class PinkOpenButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkOpenButton> createState() => _PinkOpenButtonState();
}

class _PinkOpenButtonState extends State<PinkOpenButton> with SingleTickerProviderStateMixin {
