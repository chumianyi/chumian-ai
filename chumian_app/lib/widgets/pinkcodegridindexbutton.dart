...
/// Pink themed code grid index button
class PinkCodeGridIndexButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeGridIndexButton> createState() => _PinkCodeGridIndexButtonState();
}

class _PinkCodeGridIndexButtonState extends State<PinkCodeGridIndexButton> with SingleTickerProviderStateMixin {
