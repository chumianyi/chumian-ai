...
/// Pink themed research analyst button
class PinkResearchAnalystButton extends StatefulWidget {
  final String? text;
  ...
  const PinkResearchAnalystButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkResearchAnalystButton> createState() => _PinkResearchAnalystButtonState();
}

class _PinkResearchAnalystButtonState extends State<PinkResearchAnalystButton> with SingleTickerProviderStateMixin {
