...
/// Pink themed code cloud-language-model search button
class PinkCodeCloudLanguageModelSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudLanguageModelSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudLanguageModelSearchButton> createState() => _PinkCodeCloudLanguageModelSearchButtonState();
}

class _PinkCodeCloudLanguageModelSearchButtonState extends State<PinkCodeCloudLanguageModelSearchButton> with SingleTickerProviderStateMixin {
