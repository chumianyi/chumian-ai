...
/// Pink themed radio button
class PinkRadioButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRadioButton> createState() => _PinkRadioButtonState();
}

class _PinkRadioButtonState extends State<PinkRadioButton> with SingleTickerProviderStateMixin {
