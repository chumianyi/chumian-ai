...
/// Pink themed popup menu
class PinkPopupMenu extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkPopupMenu> createState() => _PinkPopupMenuState();
}

class _PinkPopupMenuState extends State<PinkPopupMenu> with SingleTickerProviderStateMixin {
