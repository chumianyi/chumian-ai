...
/// Pink themed code documentation button
class PinkCodeDocumentationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeDocumentationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeDocumentationButton> createState() => _PinkCodeDocumentationButtonState();
}

class _PinkCodeDocumentationButtonState extends State<PinkCodeDocumentationButton> with SingleTickerProviderStateMixin {
