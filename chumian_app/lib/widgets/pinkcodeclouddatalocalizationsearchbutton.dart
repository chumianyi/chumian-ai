...
/// Pink themed code cloud-data-localization search button
class PinkCodeCloudDataLocalizationSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataLocalizationSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataLocalizationSearchButton> createState() => _PinkCodeCloudDataLocalizationSearchButtonState();
}

class _PinkCodeCloudDataLocalizationSearchButtonState extends State<PinkCodeCloudDataLocalizationSearchButton> with SingleTickerProviderStateMixin {
