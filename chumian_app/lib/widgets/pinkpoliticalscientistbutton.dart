...
/// Pink themed political scientist button
class PinkPoliticalScientistButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPoliticalScientistButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPoliticalScientistButton> createState() => _PinkPoliticalScientistButtonState();
}

class _PinkPoliticalScientistButtonState extends State<PinkPoliticalScientistButton> with SingleTickerProviderStateMixin {
