...
/// Pink themed incident manager button
class PinkIncidentManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkIncidentManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkIncidentManagerButton> createState() => _PinkIncidentManagerButtonState();
}

class _PinkIncidentManagerButtonState extends State<PinkIncidentManagerButton> with SingleTickerProviderStateMixin {
