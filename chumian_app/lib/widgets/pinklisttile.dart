...
/// Pink themed list tile
class PinkListTile extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkListTile> createState() => _PinkListTileState();
}

class _PinkListTileState extends State<PinkListTile> with SingleTickerProviderStateMixin {
