...
/// Pink themed translator button
class PinkTranslatorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTranslatorButton> createState() => _PinkTranslatorButtonState();
}

class _PinkTranslatorButtonState extends State<PinkTranslatorButton> with SingleTickerProviderStateMixin {
