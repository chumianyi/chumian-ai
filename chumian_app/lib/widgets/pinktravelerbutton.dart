...
/// Pink themed traveler button
class PinkTravelerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkTravelerButton> createState() => _PinkTravelerButtonState();
}

class _PinkTravelerButtonState extends State<PinkTravelerButton> with SingleTickerProviderStateMixin {
