...
/// Pink themed menu
class PinkMenu extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMenu> createState() => _PinkMenuState();
}

class _PinkMenuState extends State<PinkMenu> with SingleTickerProviderStateMixin {
