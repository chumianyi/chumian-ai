...
/// Pink themed rating bar
class PinkRatingBar extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRatingBar> createState() => _PinkRatingBarState();
}

class _PinkRatingBarState extends State<PinkRatingBar> with SingleTickerProviderStateMixin {
