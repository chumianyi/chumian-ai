...
/// Pink themed maximize button
class PinkMaximizeButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMaximizeButton> createState() => _PinkMaximizeButtonState();
}

class _PinkMaximizeButtonState extends State<PinkMaximizeButton> with SingleTickerProviderStateMixin {
