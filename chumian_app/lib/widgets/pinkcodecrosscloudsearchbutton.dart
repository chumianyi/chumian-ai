...
/// Pink themed code cross-cloud search button
class PinkCodeCrossCloudSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCrossCloudSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCrossCloudSearchButton> createState() => _PinkCodeCrossCloudSearchButtonState();
}

class _PinkCodeCrossCloudSearchButtonState extends State<PinkCodeCrossCloudSearchButton> with SingleTickerProviderStateMixin {
