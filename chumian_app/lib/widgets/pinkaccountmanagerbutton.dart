...
/// Pink themed account manager button
class PinkAccountManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkAccountManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkAccountManagerButton> createState() => _PinkAccountManagerButtonState();
}

class _PinkAccountManagerButtonState extends State<PinkAccountManagerButton> with SingleTickerProviderStateMixin {
