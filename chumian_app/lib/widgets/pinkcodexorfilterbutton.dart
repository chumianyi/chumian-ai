...
/// Pink themed code XOR filter button
class PinkCodeXorFilterButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeXorFilterButton> createState() => _PinkCodeXorFilterButtonState();
}

class _PinkCodeXorFilterButtonState extends State<PinkCodeXorFilterButton> with SingleTickerProviderStateMixin {
