...
/// Pink themed code map button
class PinkCodeMapButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeMapButton> createState() => _PinkCodeMapButtonState();
}

class _PinkCodeMapButtonState extends State<PinkCodeMapButton> with SingleTickerProviderStateMixin {
