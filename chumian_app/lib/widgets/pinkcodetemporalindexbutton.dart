...
/// Pink themed code temporal index button
class PinkCodeTemporalIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeTemporalIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeTemporalIndexButton> createState() => _PinkCodeTemporalIndexButtonState();
}

class _PinkCodeTemporalIndexButtonState extends State<PinkCodeTemporalIndexButton> with SingleTickerProviderStateMixin {
