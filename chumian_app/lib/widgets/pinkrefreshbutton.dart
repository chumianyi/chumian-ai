...
/// Pink themed refresh button
class PinkRefreshButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkRefreshButton> createState() => _PinkRefreshButtonState();
}

class _PinkRefreshButtonState extends State<PinkRefreshButton> with SingleTickerProviderStateMixin {
