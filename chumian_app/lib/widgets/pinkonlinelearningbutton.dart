...
/// Pink themed online learning button
class PinkOnlineLearningButton extends StatefulWidget {
  final String? text;
  ...
  const PinkOnlineLearningButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkOnlineLearningButton> createState() => _PinkOnlineLearningButtonState();
}

class _PinkOnlineLearningButtonState extends State<PinkOnlineLearningButton> with SingleTickerProviderStateMixin {
