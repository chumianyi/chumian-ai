...
/// Pink themed airplay button
class PinkAirplayButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAirplayButton> createState() => _PinkAirplayButtonState();
}

class _PinkAirplayButtonState extends State<PinkAirplayButton> with SingleTickerProviderStateMixin {
