...
/// Pink themed code generation automation button
class PinkCodeGenerationAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeGenerationAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeGenerationAutomationButton> createState() => _PinkCodeGenerationAutomationButtonState();
}

class _PinkCodeGenerationAutomationButtonState extends State<PinkCodeGenerationAutomationButton> with SingleTickerProviderStateMixin {
