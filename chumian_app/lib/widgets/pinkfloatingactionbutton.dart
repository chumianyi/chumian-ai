...
/// Pink themed FAB
class PinkFloatingActionButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFloatingActionButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFloatingActionButton> createState() => _PinkFloatingActionButtonState();
}

class _PinkFloatingActionButtonState extends State<PinkFloatingActionButton> with SingleTickerProviderStateMixin {
