...
/// Pink themed code local search button
class PinkCodeLocalSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeLocalSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeLocalSearchButton> createState() => _PinkCodeLocalSearchButtonState();
}

class _PinkCodeLocalSearchButtonState extends State<PinkCodeLocalSearchButton> with SingleTickerProviderStateMixin {
