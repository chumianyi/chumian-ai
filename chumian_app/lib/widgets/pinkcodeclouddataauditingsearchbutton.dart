...
/// Pink themed code cloud-data-auditing search button
class PinkCodeCloudDataAuditingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataAuditingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataAuditingSearchButton> createState() => _PinkCodeCloudDataAuditingSearchButtonState();
}

class _PinkCodeCloudDataAuditingSearchButtonState extends State<PinkCodeCloudDataAuditingSearchButton> with SingleTickerProviderStateMixin {
