...
/// Pink themed more button
class PinkMoreButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMoreButton> createState() => _PinkMoreButtonState();
}

class _PinkMoreButtonState extends State<PinkMoreButton> with SingleTickerProviderStateMixin {
