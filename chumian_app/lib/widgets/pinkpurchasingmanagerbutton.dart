...
/// Pink themed purchasing manager button
class PinkPurchasingManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkPurchasingManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkPurchasingManagerButton> createState() => _PinkPurchasingManagerButtonState();
}

class _PinkPurchasingManagerButtonState extends State<PinkPurchasingManagerButton> with SingleTickerProviderStateMixin {
