...
/// Pink themed doctor button
class PinkDoctorButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDoctorButton> createState() => _PinkDoctorButtonState();
}

class _PinkDoctorButtonState extends State<PinkDoctorButton> with SingleTickerProviderStateMixin {
