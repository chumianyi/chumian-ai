...
/// Pink themed code geospatial index button
class PinkCodeGeospatialIndexButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeGeospatialIndexButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeGeospatialIndexButton> createState() => _PinkCodeGeospatialIndexButtonState();
}

class _PinkCodeGeospatialIndexButtonState extends State<PinkCodeGeospatialIndexButton> with SingleTickerProviderStateMixin {
