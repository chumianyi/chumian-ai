...
/// Pink themed filter button
class PinkFilterButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkFilterButton> createState() => _PinkFilterButtonState();
}

class _PinkFilterButtonState extends State<PinkFilterButton> with SingleTickerProviderStateMixin {
