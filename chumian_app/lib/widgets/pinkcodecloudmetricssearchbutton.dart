...
/// Pink themed code cloud-metrics search button
class PinkCodeCloudMetricsSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudMetricsSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudMetricsSearchButton> createState() => _PinkCodeCloudMetricsSearchButtonState();
}

class _PinkCodeCloudMetricsSearchButtonState extends State<PinkCodeCloudMetricsSearchButton> with SingleTickerProviderStateMixin {
