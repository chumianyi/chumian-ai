...
/// Pink themed code cloud-audit search button
class PinkCodeCloudAuditSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudAuditSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudAuditSearchButton> createState() => _PinkCodeCloudAuditSearchButtonState();
}

class _PinkCodeCloudAuditSearchButtonState extends State<PinkCodeCloudAuditSearchButton> with SingleTickerProviderStateMixin {
