...
/// Pink themed drum button
class PinkDrumButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDrumButton> createState() => _PinkDrumButtonState();
}

class _PinkDrumButtonState extends State<PinkDrumButton> with SingleTickerProviderStateMixin {
