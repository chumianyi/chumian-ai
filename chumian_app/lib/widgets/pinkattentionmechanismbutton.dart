...
/// Pink themed attention mechanism button
class PinkAttentionMechanismButton extends StatefulWidget {
  final String? text;
  ...
  const PinkAttentionMechanismButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkAttentionMechanismButton> createState() => _PinkAttentionMechanismButtonState();
}

class _PinkAttentionMechanismButtonState extends State<PinkAttentionMechanismButton> with SingleTickerProviderStateMixin {
