...
/// Pink themed brightness down button
class PinkBrightnessDownButton extends StatefulWidget {
  final String? text;
  ...
  const PinkBrightnessDownButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkBrightnessDownButton> createState() => _PinkBrightnessDownButtonState();
}

class _PinkBrightnessDownButtonState extends State<PinkBrightnessDownButton> with SingleTickerProviderStateMixin {
