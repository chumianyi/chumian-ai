...
/// Pink themed code cloud-root-cause-analysis search button
class PinkCodeCloudRootCauseAnalysisSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudRootCauseAnalysisSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudRootCauseAnalysisSearchButton> createState() => _PinkCodeCloudRootCauseAnalysisSearchButtonState();
}

class _PinkCodeCloudRootCauseAnalysisSearchButtonState extends State<PinkCodeCloudRootCauseAnalysisSearchButton> with SingleTickerProviderStateMixin {
