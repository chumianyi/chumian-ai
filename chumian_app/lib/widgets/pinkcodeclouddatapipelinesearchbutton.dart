...
/// Pink themed code cloud-data-pipeline search button
class PinkCodeCloudDataPipelineSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataPipelineSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataPipelineSearchButton> createState() => _PinkCodeCloudDataPipelineSearchButtonState();
}

class _PinkCodeCloudDataPipelineSearchButtonState extends State<PinkCodeCloudDataPipelineSearchButton> with SingleTickerProviderStateMixin {
