...
/// Pink themed code edge search button
class PinkCodeEdgeSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeEdgeSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeEdgeSearchButton> createState() => _PinkCodeEdgeSearchButtonState();
}

class _PinkCodeEdgeSearchButtonState extends State<PinkCodeEdgeSearchButton> with SingleTickerProviderStateMixin {
