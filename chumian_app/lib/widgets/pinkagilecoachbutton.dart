...
/// Pink themed agile coach button
class PinkAgileCoachButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkAgileCoachButton> createState() => _PinkAgileCoachButtonState();
}

class _PinkAgileCoachButtonState extends State<PinkAgileCoachButton> with SingleTickerProviderStateMixin {
