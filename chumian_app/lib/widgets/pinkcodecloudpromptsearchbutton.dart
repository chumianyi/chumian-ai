...
/// Pink themed code cloud-prompt search button
class PinkCodeCloudPromptSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudPromptSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudPromptSearchButton> createState() => _PinkCodeCloudPromptSearchButtonState();
}

class _PinkCodeCloudPromptSearchButtonState extends State<PinkCodeCloudPromptSearchButton> with SingleTickerProviderStateMixin {
