...
/// Pink themed HDMI button
class PinkHdmiButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkHdmiButton> createState() => _PinkHdmiButtonState();
}

class _PinkHdmiButtonState extends State<PinkHdmiButton> with SingleTickerProviderStateMixin {
