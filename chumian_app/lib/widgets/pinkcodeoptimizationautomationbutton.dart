...
/// Pink themed code optimization automation button
class PinkCodeOptimizationAutomationButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeOptimizationAutomationButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeOptimizationAutomationButton> createState() => _PinkCodeOptimizationAutomationButtonState();
}

class _PinkCodeOptimizationAutomationButtonState extends State<PinkCodeOptimizationAutomationButton> with SingleTickerProviderStateMixin {
