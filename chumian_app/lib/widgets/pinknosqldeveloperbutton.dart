...
/// Pink themed NoSQL developer button
class PinkNosqlDeveloperButton extends StatefulWidget {
  final String? text;
  ...
  const PinkNosqlDeveloperButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkNosqlDeveloperButton> createState() => _PinkNosqlDeveloperButtonState();
}

class _PinkNosqlDeveloperButtonState extends State<PinkNosqlDeveloperButton> with SingleTickerProviderStateMixin {
