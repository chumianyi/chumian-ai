...
/// Pink themed financial advisor button
class PinkFinancialAdvisorButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFinancialAdvisorButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFinancialAdvisorButton> createState() => _PinkFinancialAdvisorButtonState();
}

class _PinkFinancialAdvisorButtonState extends State<PinkFinancialAdvisorButton> with SingleTickerProviderStateMixin {
