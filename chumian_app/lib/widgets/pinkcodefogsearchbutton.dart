...
/// Pink themed code fog search button
class PinkCodeFogSearchButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeFogSearchButton> createState() => _PinkCodeFogSearchButtonState();
}

class _PinkCodeFogSearchButtonState extends State<PinkCodeFogSearchButton> with SingleTickerProviderStateMixin {
