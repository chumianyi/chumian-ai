...
/// Pink themed code cloud-data-dictionary search button
class PinkCodeCloudDataDictionarySearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataDictionarySearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataDictionarySearchButton> createState() => _PinkCodeCloudDataDictionarySearchButtonState();
}

class _PinkCodeCloudDataDictionarySearchButtonState extends State<PinkCodeCloudDataDictionarySearchButton> with SingleTickerProviderStateMixin {
