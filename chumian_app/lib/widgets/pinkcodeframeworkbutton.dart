...
/// Pink themed code framework button
class PinkCodeFrameworkButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkCodeFrameworkButton> createState() => _PinkCodeFrameworkButtonState();
}

class _PinkCodeFrameworkButtonState extends State<PinkCodeFrameworkButton> with SingleTickerProviderStateMixin {
