...
/// Pink themed code auto-scaling search button
class PinkCodeAutoScalingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeAutoScalingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeAutoScalingSearchButton> createState() => _PinkCodeAutoScalingSearchButtonState();
}

class _PinkCodeAutoScalingSearchButtonState extends State<PinkCodeAutoScalingSearchButton> with SingleTickerProviderStateMixin {
