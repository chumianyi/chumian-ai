...
/// Pink themed CSM button
class PinkCustomerSuccessManagerButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCustomerSuccessManagerButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCustomerSuccessManagerButton> createState() => _PinkCustomerSuccessManagerButtonState();
}

class _PinkCustomerSuccessManagerButtonState extends State<PinkCustomerSuccessManagerButton> with SingleTickerProviderStateMixin {
