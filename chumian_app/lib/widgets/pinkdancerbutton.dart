...
/// Pink themed dancer button
class PinkDancerButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkDancerButton> createState() => _PinkDancerButtonState();
}

class _PinkDancerButtonState extends State<PinkDancerButton> with SingleTickerProviderStateMixin {
