...
/// Pink themed code cloud-data-governance search button
class PinkCodeCloudDataGovernanceSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudDataGovernanceSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudDataGovernanceSearchButton> createState() => _PinkCodeCloudDataGovernanceSearchButtonState();
}

class _PinkCodeCloudDataGovernanceSearchButtonState extends State<PinkCodeCloudDataGovernanceSearchButton> with SingleTickerProviderStateMixin {
