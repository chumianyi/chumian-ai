...
/// Pink themed code cloud-embedding search button
class PinkCodeCloudEmbeddingSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeCloudEmbeddingSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeCloudEmbeddingSearchButton> createState() => _PinkCodeCloudEmbeddingSearchButtonState();
}

class _PinkCodeCloudEmbeddingSearchButtonState extends State<PinkCodeCloudEmbeddingSearchButton> with SingleTickerProviderStateMixin {
