...
/// Pink themed code serverless search button
class PinkCodeServerlessSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeServerlessSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeServerlessSearchButton> createState() => _PinkCodeServerlessSearchButtonState();
}

class _PinkCodeServerlessSearchButtonState extends State<PinkCodeServerlessSearchButton> with SingleTickerProviderStateMixin {
