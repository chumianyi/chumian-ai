...
/// Pink themed mute button
class PinkMuteButton extends StatefulWidget {
  final String? text;
  ...
  @override
  State<PinkMuteButton> createState() => _PinkMuteButtonState();
}

class _PinkMuteButtonState extends State<PinkMuteButton> with SingleTickerProviderStateMixin {
