...
/// Pink themed code batched search button
class PinkCodeBatchedSearchButton extends StatefulWidget {
  final String? text;
  ...
  const PinkCodeBatchedSearchButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkCodeBatchedSearchButton> createState() => _PinkCodeBatchedSearchButtonState();
}

class _PinkCodeBatchedSearchButtonState extends State<PinkCodeBatchedSearchButton> with SingleTickerProviderStateMixin {
