...
/// Pink themed field service technician button
class PinkFieldServiceTechnicianButton extends StatefulWidget {
  final String? text;
  ...
  const PinkFieldServiceTechnicianButton({
    super.key,
    this.text,
    this.subtitle,
    this.icon,
  ...
  @override
  State<PinkFieldServiceTechnicianButton> createState() => _PinkFieldServiceTechnicianButtonState();
}

class _PinkFieldServiceTechnicianButtonState extends State<PinkFieldServiceTechnicianButton> with SingleTickerProviderStateMixin {
