...
class NotificationSetting {
  ...
  NotificationSetting clone() => NotificationSetting.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is NotificationSetting && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'NotificationSetting(id: $id)';
}
