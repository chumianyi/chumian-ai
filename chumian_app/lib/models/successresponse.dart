...
class SuccessResponse {
  ...
  SuccessResponse clone() => SuccessResponse.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is SuccessResponse && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'SuccessResponse(id: $id)';
}
