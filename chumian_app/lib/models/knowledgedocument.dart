...
class KnowledgeDocument {
  ...
  KnowledgeDocument clone() => KnowledgeDocument.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is KnowledgeDocument && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'KnowledgeDocument(id: $id)';
}
