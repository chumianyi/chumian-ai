...
class ConnectedAccount {
  ...
  ConnectedAccount clone() => ConnectedAccount.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is ConnectedAccount && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'ConnectedAccount(id: $id)';
}
