...
class PointsTransaction {
  ...
  PointsTransaction clone() => PointsTransaction.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is PointsTransaction && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'PointsTransaction(id: $id)';
}
