...
class LoginRecord {
  ...
  LoginRecord clone() => LoginRecord.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is LoginRecord && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'LoginRecord(id: $id)';
}
