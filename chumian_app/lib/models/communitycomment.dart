...
class CommunityComment {
  ...
  CommunityComment clone() => CommunityComment.fromJson(toJson());
  bool get isEmpty => id.isEmpty;
  bool get isNotEmpty => id.isNotEmpty;

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is CommunityComment && id == other.id;

  @override
  int get hashCode => id.hashCode;

  @override
  String toString() => 'CommunityComment(id: $id)';
}
