...
/// Incited page
class IncitedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<IncitedPage> createState() => _IncitedPageState();
}

class _IncitedPageState extends State<IncitedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('IncitedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'IncitedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'IncitedPage', style: AppTextStyles.headlineLarge),
