...
class EnhancedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<EnhancedPage> createState() => _EnhancedPageState();
}

class _EnhancedPageState extends State<EnhancedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('EnhancedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'EnhancedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'EnhancedPage', style: AppTextStyles.headlineLarge),
