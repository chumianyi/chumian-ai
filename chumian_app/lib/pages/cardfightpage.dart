...
/// Cardfight page
class CardfightPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<CardfightPage> createState() => _CardfightPageState();
}

class _CardfightPageState extends State<CardfightPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('CardfightPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'CardfightPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'CardfightPage', style: AppTextStyles.headlineLarge),
