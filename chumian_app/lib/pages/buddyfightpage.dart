...
/// Buddyfight page
class BuddyfightPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<BuddyfightPage> createState() => _BuddyfightPageState();
}

class _BuddyfightPageState extends State<BuddyfightPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('BuddyfightPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'BuddyfightPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'BuddyfightPage', style: AppTextStyles.headlineLarge),
