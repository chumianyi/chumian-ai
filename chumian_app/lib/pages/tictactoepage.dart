      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('TicTacToePage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'TicTacToePage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'TicTacToePage', style: AppTextStyles.headlineLarge),
