...
class AccountBindingPage extends StatefulWidget {
  ...
  @override
  State<AccountBindingPage> createState() => _AccountBindingPageState();
}

class _AccountBindingPageState extends State<AccountBindingPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        _items.add({
          ...
          'title': 'AccountBindingPage Item $i',
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'AccountBindingPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('AccountBindingPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'AccountBindingPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'AccountBindingPage', style: AppTextStyles.headlineLarge),
