...
/// Reloaded content page
class ReloadedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ReloadedPage> createState() => _ReloadedPageState();
}

class _ReloadedPageState extends State<ReloadedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ReloadedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ReloadedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ReloadedPage', style: AppTextStyles.headlineLarge),
