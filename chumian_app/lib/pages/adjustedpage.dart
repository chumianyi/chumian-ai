...
/// Adjusted content page
class AdjustedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<AdjustedPage> createState() => _AdjustedPageState();
}

class _AdjustedPageState extends State<AdjustedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('AdjustedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'AdjustedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'AdjustedPage', style: AppTextStyles.headlineLarge),
