...
/// Oldest page
class OldestPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<OldestPage> createState() => _OldestPageState();
}

class _OldestPageState extends State<OldestPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('OldestPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'OldestPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'OldestPage', style: AppTextStyles.headlineLarge),
