...
/// Terminated page
class TerminatedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<TerminatedPage> createState() => _TerminatedPageState();
}

class _TerminatedPageState extends State<TerminatedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('TerminatedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'TerminatedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'TerminatedPage', style: AppTextStyles.headlineLarge),
