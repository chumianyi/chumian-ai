...
/// Wixoss page
class WixossPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<WixossPage> createState() => _WixossPageState();
}

class _WixossPageState extends State<WixossPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('WixossPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'WixossPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'WixossPage', style: AppTextStyles.headlineLarge),
