...
/// Unpinned page
class UnpinnedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<UnpinnedPage> createState() => _UnpinnedPageState();
}

class _UnpinnedPageState extends State<UnpinnedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('UnpinnedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'UnpinnedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'UnpinnedPage', style: AppTextStyles.headlineLarge),
