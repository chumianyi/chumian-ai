...
/// Calibrated content page
class CalibratedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<CalibratedPage> createState() => _CalibratedPageState();
}

class _CalibratedPageState extends State<CalibratedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('CalibratedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'CalibratedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'CalibratedPage', style: AppTextStyles.headlineLarge),
