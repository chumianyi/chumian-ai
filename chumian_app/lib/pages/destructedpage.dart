...
/// Destructed page
class DestructedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<DestructedPage> createState() => _DestructedPageState();
}

class _DestructedPageState extends State<DestructedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('DestructedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'DestructedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'DestructedPage', style: AppTextStyles.headlineLarge),
