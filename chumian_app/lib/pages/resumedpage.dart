...
/// Resumed content page
class ResumedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ResumedPage> createState() => _ResumedPageState();
}

class _ResumedPageState extends State<ResumedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ResumedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ResumedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ResumedPage', style: AppTextStyles.headlineLarge),
