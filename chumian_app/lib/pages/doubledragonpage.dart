...
/// Double dragon page
class DoubleDragonPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<DoubleDragonPage> createState() => _DoubleDragonPageState();
}

class _DoubleDragonPageState extends State<DoubleDragonPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'DoubleDragonPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('DoubleDragonPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'DoubleDragonPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'DoubleDragonPage', style: AppTextStyles.headlineLarge),
