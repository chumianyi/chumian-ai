...
/// Paused content page
class PausedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<PausedPage> createState() => _PausedPageState();
}

class _PausedPageState extends State<PausedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('PausedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'PausedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'PausedPage', style: AppTextStyles.headlineLarge),
