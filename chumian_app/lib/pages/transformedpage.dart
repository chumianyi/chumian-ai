...
/// Transformed content page
class TransformedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<TransformedPage> createState() => _TransformedPageState();
}

class _TransformedPageState extends State<TransformedPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'TransformedPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('TransformedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'TransformedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'TransformedPage', style: AppTextStyles.headlineLarge),
