...
/// Donkey kong page
class DonkeyKongPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<DonkeyKongPage> createState() => _DonkeyKongPageState();
}

class _DonkeyKongPageState extends State<DonkeyKongPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('DonkeyKongPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'DonkeyKongPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'DonkeyKongPage', style: AppTextStyles.headlineLarge),
