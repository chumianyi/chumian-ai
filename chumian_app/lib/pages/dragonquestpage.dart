...
/// Dragon quest page
class DragonQuestPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<DragonQuestPage> createState() => _DragonQuestPageState();
}

class _DragonQuestPageState extends State<DragonQuestPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'DragonQuestPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('DragonQuestPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'DragonQuestPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'DragonQuestPage', style: AppTextStyles.headlineLarge),
