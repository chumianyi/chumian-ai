...
/// Upgraded content page
class UpgradedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<UpgradedPage> createState() => _UpgradedPageState();
}

class _UpgradedPageState extends State<UpgradedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('UpgradedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'UpgradedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'UpgradedPage', style: AppTextStyles.headlineLarge),
