...
/// Tailored content page
class TailoredPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<TailoredPage> createState() => _TailoredPageState();
}

class _TailoredPageState extends State<TailoredPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('TailoredPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'TailoredPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'TailoredPage', style: AppTextStyles.headlineLarge),
