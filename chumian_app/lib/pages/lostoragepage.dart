...
/// Lostorage page
class LostoragePage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<LostoragePage> createState() => _LostoragePageState();
}

class _LostoragePageState extends State<LostoragePage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('LostoragePage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'LostoragePage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'LostoragePage', style: AppTextStyles.headlineLarge),
