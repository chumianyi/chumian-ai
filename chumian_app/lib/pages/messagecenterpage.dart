...
class _MessageCenterPageState extends State<MessageCenterPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        _items.add({
          ...
          'title': 'MessageCenterPage Item $i',
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'MessageCenterPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('MessageCenterPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'MessageCenterPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'MessageCenterPage', style: AppTextStyles.headlineLarge),
