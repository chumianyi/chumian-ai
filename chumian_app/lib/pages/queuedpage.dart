...
/// Queued page
class QueuedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<QueuedPage> createState() => _QueuedPageState();
}

class _QueuedPageState extends State<QueuedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('QueuedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'QueuedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'QueuedPage', style: AppTextStyles.headlineLarge),
