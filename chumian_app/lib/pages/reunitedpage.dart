...
/// Reunited page
class ReunitedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ReunitedPage> createState() => _ReunitedPageState();
}

class _ReunitedPageState extends State<ReunitedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ReunitedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ReunitedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ReunitedPage', style: AppTextStyles.headlineLarge),
