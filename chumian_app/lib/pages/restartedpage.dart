...
/// Restarted content page
class RestartedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<RestartedPage> createState() => _RestartedPageState();
}

class _RestartedPageState extends State<RestartedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('RestartedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'RestartedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'RestartedPage', style: AppTextStyles.headlineLarge),
