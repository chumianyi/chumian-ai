...
/// Metroid page
class MetroidPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<MetroidPage> createState() => _MetroidPageState();
}

class _MetroidPageState extends State<MetroidPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('MetroidPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'MetroidPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'MetroidPage', style: AppTextStyles.headlineLarge),
