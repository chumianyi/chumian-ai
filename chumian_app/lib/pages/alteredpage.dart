...
/// Altered content page
class AlteredPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<AlteredPage> createState() => _AlteredPageState();
}

class _AlteredPageState extends State<AlteredPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('AlteredPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'AlteredPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'AlteredPage', style: AppTextStyles.headlineLarge),
