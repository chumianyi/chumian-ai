...
class ImprovedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ImprovedPage> createState() => _ImprovedPageState();
}

class _ImprovedPageState extends State<ImprovedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ImprovedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ImprovedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ImprovedPage', style: AppTextStyles.headlineLarge),
