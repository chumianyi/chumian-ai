...
/// Perfected content page
class PerfectedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<PerfectedPage> createState() => _PerfectedPageState();
}

class _PerfectedPageState extends State<PerfectedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('PerfectedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'PerfectedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'PerfectedPage', style: AppTextStyles.headlineLarge),
