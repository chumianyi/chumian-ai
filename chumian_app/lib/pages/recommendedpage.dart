    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'RecommendedPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('RecommendedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'RecommendedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'RecommendedPage', style: AppTextStyles.headlineLarge),
