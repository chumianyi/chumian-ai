...
class RefinedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<RefinedPage> createState() => _RefinedPageState();
}

class _RefinedPageState extends State<RefinedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('RefinedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'RefinedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'RefinedPage', style: AppTextStyles.headlineLarge),
