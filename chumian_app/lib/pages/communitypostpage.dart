...
class _CommunityPostPageState extends State<CommunityPostPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        _items.add({
          ...
          'title': 'CommunityPostPage Item $i',
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'CommunityPostPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('CommunityPostPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'CommunityPostPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'CommunityPostPage', style: AppTextStyles.headlineLarge),
