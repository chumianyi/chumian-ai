...
/// Cardfight vanguard page
class VanguardPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<VanguardPage> createState() => _VanguardPageState();
}

class _VanguardPageState extends State<VanguardPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('VanguardPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'VanguardPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'VanguardPage', style: AppTextStyles.headlineLarge),
