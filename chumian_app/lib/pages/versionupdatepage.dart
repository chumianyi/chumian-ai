...
class _VersionUpdatePageState extends State<VersionUpdatePage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        _items.add({
          ...
          'title': 'VersionUpdatePage Item $i',
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'VersionUpdatePage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('VersionUpdatePage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'VersionUpdatePage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'VersionUpdatePage', style: AppTextStyles.headlineLarge),
