...
/// Refreshed content page
class RefreshedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<RefreshedPage> createState() => _RefreshedPageState();
}

class _RefreshedPageState extends State<RefreshedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('RefreshedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'RefreshedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'RefreshedPage', style: AppTextStyles.headlineLarge),
