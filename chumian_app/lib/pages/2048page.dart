...
/// 2048 game page
class 2048Page extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<2048Page> createState() => _2048PageState();
}

class _2048PageState extends State<2048Page> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('2048Page Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? '2048Page', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? '2048Page', style: AppTextStyles.headlineLarge),
