...
/// Conflated page
class ConflatedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ConflatedPage> createState() => _ConflatedPageState();
}

class _ConflatedPageState extends State<ConflatedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ConflatedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ConflatedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ConflatedPage', style: AppTextStyles.headlineLarge),
