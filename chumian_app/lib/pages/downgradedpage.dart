...
/// Downgraded content page
class DowngradedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<DowngradedPage> createState() => _DowngradedPageState();
}

class _DowngradedPageState extends State<DowngradedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('DowngradedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'DowngradedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'DowngradedPage', style: AppTextStyles.headlineLarge),
