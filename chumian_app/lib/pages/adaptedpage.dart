...
/// Adapted content page
class AdaptedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<AdaptedPage> createState() => _AdaptedPageState();
}

class _AdaptedPageState extends State<AdaptedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('AdaptedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'AdaptedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'AdaptedPage', style: AppTextStyles.headlineLarge),
