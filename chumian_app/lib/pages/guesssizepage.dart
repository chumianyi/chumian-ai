...
/// Guess size game page
class GuessSizePage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<GuessSizePage> createState() => _GuessSizePageState();
}

class _GuessSizePageState extends State<GuessSizePage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('GuessSizePage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'GuessSizePage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'GuessSizePage', style: AppTextStyles.headlineLarge),
