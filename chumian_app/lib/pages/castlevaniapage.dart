...
/// Castlevania page
class CastlevaniaPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<CastlevaniaPage> createState() => _CastlevaniaPageState();
}

class _CastlevaniaPageState extends State<CastlevaniaPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'CastlevaniaPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('CastlevaniaPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'CastlevaniaPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'CastlevaniaPage', style: AppTextStyles.headlineLarge),
