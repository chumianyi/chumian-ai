            ...
            : _errorMessage != null
                ...
                return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  ...group.models.asMap().entries.map((entry) {
                    ...
                    return MiuixRipple(borderRadius: MiuixRadius.lg, child: GestureDetector(onTap: () => _selectModel(model), child: AnimatedContainer(duration: MiuixDuration.fast, margin: const EdgeInsets.only(bottom: 8), padding: const EdgeInsets.all(14), decoration: BoxDecoration(color: isSelected ? MiuixColors.primary.withOpacity(0.08) : MiuixColors.surfaceVariant.withOpacity(0.5), borderRadius: MiuixRadius.lgRadius, border: Border.all(color: isSelected ? MiuixColors.primary : MiuixColors.borderLight, width: isSelected ? 1.5 : 0.5)), child: Row(children: [
                      Container(width: 40, height: 40, decoration: BoxDecoration(color: _getTypeColor(model.type).withOpacity(0.12), borderRadius: MiuixRadius.smRadius), child: Center(child: Icon(_getTypeIcon(model.type), color: _getTypeColor(model.type), size: 20))),
                      const SizedBox(width: 12),
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Row(children: [Text(model.name, style: TextStyle(color: isSelected ? MiuixColors.primary : MiuixColors.textPrimary, fontSize: MiuixFontSize.md, fontWeight: FontWeight.w600)), const SizedBox(width: 6), if (model.isFree) Container(padding: const EdgeInsets.symmetric(horizontal: 5, vertical: 1), decoration: BoxDecoration(color: MiuixColors.success.withOpacity(0.1), borderRadius: MiuixRadius.xsRadius), child: const Text('免费', style: TextStyle(color: MiuixColors.success, fontSize: 9, fontWeight: FontWeight.w500)))]),
