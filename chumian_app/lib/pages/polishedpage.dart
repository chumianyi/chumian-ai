...
class PolishedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<PolishedPage> createState() => _PolishedPageState();
}

class _PolishedPageState extends State<PolishedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('PolishedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'PolishedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'PolishedPage', style: AppTextStyles.headlineLarge),
