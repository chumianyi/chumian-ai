...
class _OobePageState extends State<OobePage>
  ...
  static const List<_OobeItem> _items = [
    _OobeItem(
      ...
      illustration: 'assets/illustrations/onboarding_1_chat.png',
      title: '你好，我是初眠',
    ...
    _OobeItem(
      ...
      illustration: 'assets/illustrations/onboarding_2_tools.png',
      title: '创意无限',
    ...
    _OobeItem(
      icon: Icons.public,
      illustration: 'assets/illustrations/onboarding_3_community.png',
      title: '联网搜索',
    ...
    _OobeItem(
      icon: Icons.favorite,
      illustration: 'assets/illustrations/pink_decoration.png',
      title: '开始体验',
