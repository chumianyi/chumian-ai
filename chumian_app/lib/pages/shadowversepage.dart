...
/// Shadowverse page
class ShadowversePage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ShadowversePage> createState() => _ShadowversePageState();
}

class _ShadowversePageState extends State<ShadowversePage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'ShadowversePage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ShadowversePage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ShadowversePage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ShadowversePage', style: AppTextStyles.headlineLarge),
