...
/// Changed content page
class ChangedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<ChangedPage> createState() => _ChangedPageState();
}

class _ChangedPageState extends State<ChangedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('ChangedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'ChangedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'ChangedPage', style: AppTextStyles.headlineLarge),
