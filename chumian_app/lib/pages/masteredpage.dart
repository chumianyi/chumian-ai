...
/// Mastered content page
class MasteredPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<MasteredPage> createState() => _MasteredPageState();
}

class _MasteredPageState extends State<MasteredPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('MasteredPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'MasteredPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'MasteredPage', style: AppTextStyles.headlineLarge),
