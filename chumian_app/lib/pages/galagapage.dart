...
/// Galaga page
class GalagaPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<GalagaPage> createState() => _GalagaPageState();
}

class _GalagaPageState extends State<GalagaPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('GalagaPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'GalagaPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'GalagaPage', style: AppTextStyles.headlineLarge),
