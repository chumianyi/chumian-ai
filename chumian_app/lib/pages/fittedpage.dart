...
/// Fitted content page
class FittedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<FittedPage> createState() => _FittedPageState();
}

class _FittedPageState extends State<FittedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('FittedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'FittedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'FittedPage', style: AppTextStyles.headlineLarge),
