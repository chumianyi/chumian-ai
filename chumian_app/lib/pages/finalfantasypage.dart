...
/// Final fantasy page
class FinalFantasyPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<FinalFantasyPage> createState() => _FinalFantasyPageState();
}

class _FinalFantasyPageState extends State<FinalFantasyPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      for (int i = 0; i < 10; i++) {
        ...
        _items.add({
          ...
          'title': 'FinalFantasyPage Item $idx',
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('FinalFantasyPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'FinalFantasyPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'FinalFantasyPage', style: AppTextStyles.headlineLarge),
