...
/// Migrated content page
class MigratedPage extends StatefulWidget {
  final String? id;
  final String? title;
  ...
  @override
  State<MigratedPage> createState() => _MigratedPageState();
}

class _MigratedPageState extends State<MigratedPage> with TickerProviderStateMixin {
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('MigratedPage Actions', style: AppTextStyles.titleLarge),
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      title: _showSearch
          ...
          : Text(widget.title ?? 'MigratedPage', style: AppTextStyles.titleLarge),
      actions: [
        IconButton(
  ...
  Widget _buildHeader() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.title ?? 'MigratedPage', style: AppTextStyles.headlineLarge),
