...
/// Music senza sordino provider
class MusicSenzaSordinoProvider extends ChangeNotifier {
  MusicSenzaSordinoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicSenzaSordinoProvider Item $idx',
  ...
  /// Provider method 0 for MusicSenzaSordinoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicSenzaSordinoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 2 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 3 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 4 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 5 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 6 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 7 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 8 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 9 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 10 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 11 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 12 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 13 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 14 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 15 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 16 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 17 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 18 for MusicSenzaSordinoProvider
  ///
  ...
  /// Provider method 19 for MusicSenzaSordinoProvider
  ///
