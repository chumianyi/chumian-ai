...
/// Music pandeiro provider
class MusicPandeiroProvider extends ChangeNotifier {
  MusicPandeiroProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicPandeiroProvider Item $idx',
  ...
  /// Provider method 0 for MusicPandeiroProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicPandeiroProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 2 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 3 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 4 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 5 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 6 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 7 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 8 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 9 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 10 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 11 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 12 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 13 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 14 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 15 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 16 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 17 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 18 for MusicPandeiroProvider
  ///
  ...
  /// Provider method 19 for MusicPandeiroProvider
  ///
