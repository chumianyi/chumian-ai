...
/// Face reenactment provider
class FaceReenactmentProvider extends ChangeNotifier {
  FaceReenactmentProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'FaceReenactmentProvider Item $idx',
  ...
  /// Provider method 0 for FaceReenactmentProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'FaceReenactmentProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 2 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 3 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 4 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 5 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 6 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 7 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 8 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 9 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 10 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 11 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 12 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 13 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 14 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 15 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 16 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 17 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 18 for FaceReenactmentProvider
  ///
  ...
  /// Provider method 19 for FaceReenactmentProvider
  ///
