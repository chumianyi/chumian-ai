...
/// Music source separation provider
class MusicSourceSeparationProvider extends ChangeNotifier {
  MusicSourceSeparationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicSourceSeparationProvider Item $idx',
  ...
  /// Provider method 0 for MusicSourceSeparationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicSourceSeparationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 2 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 3 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 4 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 5 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 6 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 7 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 8 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 9 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 10 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 11 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 12 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 13 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 14 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 15 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 16 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 17 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 18 for MusicSourceSeparationProvider
  ///
  ...
  /// Provider method 19 for MusicSourceSeparationProvider
  ///
