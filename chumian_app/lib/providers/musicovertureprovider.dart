...
/// Music overture provider
class MusicOvertureProvider extends ChangeNotifier {
  MusicOvertureProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicOvertureProvider Item $idx',
  ...
  /// Provider method 0 for MusicOvertureProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicOvertureProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicOvertureProvider
  ///
  ...
  /// Provider method 2 for MusicOvertureProvider
  ///
  ...
  /// Provider method 3 for MusicOvertureProvider
  ///
  ...
  /// Provider method 4 for MusicOvertureProvider
  ///
  ...
  /// Provider method 5 for MusicOvertureProvider
  ///
  ...
  /// Provider method 6 for MusicOvertureProvider
  ///
  ...
  /// Provider method 7 for MusicOvertureProvider
  ///
  ...
  /// Provider method 8 for MusicOvertureProvider
  ///
  ...
  /// Provider method 9 for MusicOvertureProvider
  ///
  ...
  /// Provider method 10 for MusicOvertureProvider
  ///
  ...
  /// Provider method 11 for MusicOvertureProvider
  ///
  ...
  /// Provider method 12 for MusicOvertureProvider
  ///
  ...
  /// Provider method 13 for MusicOvertureProvider
  ///
  ...
  /// Provider method 14 for MusicOvertureProvider
  ///
  ...
  /// Provider method 15 for MusicOvertureProvider
  ///
  ...
  /// Provider method 16 for MusicOvertureProvider
  ///
  ...
  /// Provider method 17 for MusicOvertureProvider
  ///
  ...
  /// Provider method 18 for MusicOvertureProvider
  ///
  ...
  /// Provider method 19 for MusicOvertureProvider
  ///
