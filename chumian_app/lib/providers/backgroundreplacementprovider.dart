...
/// Background replacement provider
class BackgroundReplacementProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'BackgroundReplacementProvider Item $idx',
  ...
  /// Provider method 0 for BackgroundReplacementProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'BackgroundReplacementProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 2 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 3 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 4 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 5 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 6 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 7 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 8 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 9 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 10 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 11 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 12 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 13 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 14 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 15 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 16 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 17 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 18 for BackgroundReplacementProvider
  ///
  ...
  /// Provider method 19 for BackgroundReplacementProvider
  ///
