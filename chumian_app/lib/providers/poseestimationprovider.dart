...
class PoseEstimationProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'PoseEstimationProvider Item $idx',
  ...
  /// Provider method 0 for PoseEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'PoseEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for PoseEstimationProvider
  ///
  ...
  /// Provider method 2 for PoseEstimationProvider
  ///
  ...
  /// Provider method 3 for PoseEstimationProvider
  ///
  ...
  /// Provider method 4 for PoseEstimationProvider
  ///
  ...
  /// Provider method 5 for PoseEstimationProvider
  ///
  ...
  /// Provider method 6 for PoseEstimationProvider
  ///
  ...
  /// Provider method 7 for PoseEstimationProvider
  ///
  ...
  /// Provider method 8 for PoseEstimationProvider
  ///
  ...
  /// Provider method 9 for PoseEstimationProvider
  ///
  ...
  /// Provider method 10 for PoseEstimationProvider
  ///
  ...
  /// Provider method 11 for PoseEstimationProvider
  ///
  ...
  /// Provider method 12 for PoseEstimationProvider
  ///
  ...
  /// Provider method 13 for PoseEstimationProvider
  ///
  ...
  /// Provider method 14 for PoseEstimationProvider
  ///
  ...
  /// Provider method 15 for PoseEstimationProvider
  ///
  ...
  /// Provider method 16 for PoseEstimationProvider
  ///
  ...
  /// Provider method 17 for PoseEstimationProvider
  ///
  ...
  /// Provider method 18 for PoseEstimationProvider
  ///
  ...
  /// Provider method 19 for PoseEstimationProvider
  ///
