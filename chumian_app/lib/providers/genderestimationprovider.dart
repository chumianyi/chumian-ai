...
/// Gender estimation provider
class GenderEstimationProvider extends ChangeNotifier {
  GenderEstimationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'GenderEstimationProvider Item $idx',
  ...
  /// Provider method 0 for GenderEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'GenderEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for GenderEstimationProvider
  ///
  ...
  /// Provider method 2 for GenderEstimationProvider
  ///
  ...
  /// Provider method 3 for GenderEstimationProvider
  ///
  ...
  /// Provider method 4 for GenderEstimationProvider
  ///
  ...
  /// Provider method 5 for GenderEstimationProvider
  ///
  ...
  /// Provider method 6 for GenderEstimationProvider
  ///
  ...
  /// Provider method 7 for GenderEstimationProvider
  ///
  ...
  /// Provider method 8 for GenderEstimationProvider
  ///
  ...
  /// Provider method 9 for GenderEstimationProvider
  ///
  ...
  /// Provider method 10 for GenderEstimationProvider
  ///
  ...
  /// Provider method 11 for GenderEstimationProvider
  ///
  ...
  /// Provider method 12 for GenderEstimationProvider
  ///
  ...
  /// Provider method 13 for GenderEstimationProvider
  ///
  ...
  /// Provider method 14 for GenderEstimationProvider
  ///
  ...
  /// Provider method 15 for GenderEstimationProvider
  ///
  ...
  /// Provider method 16 for GenderEstimationProvider
  ///
  ...
  /// Provider method 17 for GenderEstimationProvider
  ///
  ...
  /// Provider method 18 for GenderEstimationProvider
  ///
  ...
  /// Provider method 19 for GenderEstimationProvider
  ///
