...
class SpeechEnhancementProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'SpeechEnhancementProvider Item $idx',
  ...
  /// Provider method 0 for SpeechEnhancementProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'SpeechEnhancementProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 2 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 3 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 4 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 5 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 6 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 7 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 8 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 9 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 10 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 11 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 12 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 13 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 14 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 15 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 16 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 17 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 18 for SpeechEnhancementProvider
  ///
  ...
  /// Provider method 19 for SpeechEnhancementProvider
  ///
