...
/// Music rancheira provider
class MusicRancheiraProvider extends ChangeNotifier {
  MusicRancheiraProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicRancheiraProvider Item $idx',
  ...
  /// Provider method 0 for MusicRancheiraProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicRancheiraProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 2 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 3 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 4 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 5 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 6 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 7 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 8 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 9 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 10 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 11 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 12 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 13 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 14 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 15 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 16 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 17 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 18 for MusicRancheiraProvider
  ///
  ...
  /// Provider method 19 for MusicRancheiraProvider
  ///
