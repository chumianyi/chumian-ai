...
class SuperResolutionProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'SuperResolutionProvider Item $idx',
  ...
  /// Provider method 0 for SuperResolutionProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'SuperResolutionProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for SuperResolutionProvider
  ///
  ...
  /// Provider method 2 for SuperResolutionProvider
  ///
  ...
  /// Provider method 3 for SuperResolutionProvider
  ///
  ...
  /// Provider method 4 for SuperResolutionProvider
  ///
  ...
  /// Provider method 5 for SuperResolutionProvider
  ///
  ...
  /// Provider method 6 for SuperResolutionProvider
  ///
  ...
  /// Provider method 7 for SuperResolutionProvider
  ///
  ...
  /// Provider method 8 for SuperResolutionProvider
  ///
  ...
  /// Provider method 9 for SuperResolutionProvider
  ///
  ...
  /// Provider method 10 for SuperResolutionProvider
  ///
  ...
  /// Provider method 11 for SuperResolutionProvider
  ///
  ...
  /// Provider method 12 for SuperResolutionProvider
  ///
  ...
  /// Provider method 13 for SuperResolutionProvider
  ///
  ...
  /// Provider method 14 for SuperResolutionProvider
  ///
  ...
  /// Provider method 15 for SuperResolutionProvider
  ///
  ...
  /// Provider method 16 for SuperResolutionProvider
  ///
  ...
  /// Provider method 17 for SuperResolutionProvider
  ///
  ...
  /// Provider method 18 for SuperResolutionProvider
  ///
  ...
  /// Provider method 19 for SuperResolutionProvider
  ///
