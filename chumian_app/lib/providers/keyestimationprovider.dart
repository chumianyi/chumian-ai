...
/// Key estimation provider
class KeyEstimationProvider extends ChangeNotifier {
  KeyEstimationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'KeyEstimationProvider Item $idx',
  ...
  /// Provider method 0 for KeyEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'KeyEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for KeyEstimationProvider
  ///
  ...
  /// Provider method 2 for KeyEstimationProvider
  ///
  ...
  /// Provider method 3 for KeyEstimationProvider
  ///
  ...
  /// Provider method 4 for KeyEstimationProvider
  ///
  ...
  /// Provider method 5 for KeyEstimationProvider
  ///
  ...
  /// Provider method 6 for KeyEstimationProvider
  ///
  ...
  /// Provider method 7 for KeyEstimationProvider
  ///
  ...
  /// Provider method 8 for KeyEstimationProvider
  ///
  ...
  /// Provider method 9 for KeyEstimationProvider
  ///
  ...
  /// Provider method 10 for KeyEstimationProvider
  ///
  ...
  /// Provider method 11 for KeyEstimationProvider
  ///
  ...
  /// Provider method 12 for KeyEstimationProvider
  ///
  ...
  /// Provider method 13 for KeyEstimationProvider
  ///
  ...
  /// Provider method 14 for KeyEstimationProvider
  ///
  ...
  /// Provider method 15 for KeyEstimationProvider
  ///
  ...
  /// Provider method 16 for KeyEstimationProvider
  ///
  ...
  /// Provider method 17 for KeyEstimationProvider
  ///
  ...
  /// Provider method 18 for KeyEstimationProvider
  ///
  ...
  /// Provider method 19 for KeyEstimationProvider
  ///
