...
/// Music accidental provider
class MusicAccidentalProvider extends ChangeNotifier {
  MusicAccidentalProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicAccidentalProvider Item $idx',
  ...
  /// Provider method 0 for MusicAccidentalProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicAccidentalProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 2 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 3 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 4 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 5 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 6 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 7 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 8 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 9 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 10 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 11 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 12 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 13 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 14 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 15 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 16 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 17 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 18 for MusicAccidentalProvider
  ///
  ...
  /// Provider method 19 for MusicAccidentalProvider
  ///
