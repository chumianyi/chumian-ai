...
/// Chord estimation provider
class ChordEstimationProvider extends ChangeNotifier {
  ChordEstimationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'ChordEstimationProvider Item $idx',
  ...
  /// Provider method 0 for ChordEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'ChordEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for ChordEstimationProvider
  ///
  ...
  /// Provider method 2 for ChordEstimationProvider
  ///
  ...
  /// Provider method 3 for ChordEstimationProvider
  ///
  ...
  /// Provider method 4 for ChordEstimationProvider
  ///
  ...
  /// Provider method 5 for ChordEstimationProvider
  ///
  ...
  /// Provider method 6 for ChordEstimationProvider
  ///
  ...
  /// Provider method 7 for ChordEstimationProvider
  ///
  ...
  /// Provider method 8 for ChordEstimationProvider
  ///
  ...
  /// Provider method 9 for ChordEstimationProvider
  ///
  ...
  /// Provider method 10 for ChordEstimationProvider
  ///
  ...
  /// Provider method 11 for ChordEstimationProvider
  ///
  ...
  /// Provider method 12 for ChordEstimationProvider
  ///
  ...
  /// Provider method 13 for ChordEstimationProvider
  ///
  ...
  /// Provider method 14 for ChordEstimationProvider
  ///
  ...
  /// Provider method 15 for ChordEstimationProvider
  ///
  ...
  /// Provider method 16 for ChordEstimationProvider
  ///
  ...
  /// Provider method 17 for ChordEstimationProvider
  ///
  ...
  /// Provider method 18 for ChordEstimationProvider
  ///
  ...
  /// Provider method 19 for ChordEstimationProvider
  ///
