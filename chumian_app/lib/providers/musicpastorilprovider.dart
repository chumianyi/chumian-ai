...
/// Music pastoril provider
class MusicPastorilProvider extends ChangeNotifier {
  MusicPastorilProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicPastorilProvider Item $idx',
  ...
  /// Provider method 0 for MusicPastorilProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicPastorilProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicPastorilProvider
  ///
  ...
  /// Provider method 2 for MusicPastorilProvider
  ///
  ...
  /// Provider method 3 for MusicPastorilProvider
  ///
  ...
  /// Provider method 4 for MusicPastorilProvider
  ///
  ...
  /// Provider method 5 for MusicPastorilProvider
  ///
  ...
  /// Provider method 6 for MusicPastorilProvider
  ///
  ...
  /// Provider method 7 for MusicPastorilProvider
  ///
  ...
  /// Provider method 8 for MusicPastorilProvider
  ///
  ...
  /// Provider method 9 for MusicPastorilProvider
  ///
  ...
  /// Provider method 10 for MusicPastorilProvider
  ///
  ...
  /// Provider method 11 for MusicPastorilProvider
  ///
  ...
  /// Provider method 12 for MusicPastorilProvider
  ///
  ...
  /// Provider method 13 for MusicPastorilProvider
  ///
  ...
  /// Provider method 14 for MusicPastorilProvider
  ///
  ...
  /// Provider method 15 for MusicPastorilProvider
  ///
  ...
  /// Provider method 16 for MusicPastorilProvider
  ///
  ...
  /// Provider method 17 for MusicPastorilProvider
  ///
  ...
  /// Provider method 18 for MusicPastorilProvider
  ///
  ...
  /// Provider method 19 for MusicPastorilProvider
  ///
