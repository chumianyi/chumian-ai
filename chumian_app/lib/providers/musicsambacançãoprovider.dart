...
/// Music samba canção provider
class MusicSambaCançãoProvider extends ChangeNotifier {
  MusicSambaCançãoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicSambaCançãoProvider Item $idx',
  ...
  /// Provider method 0 for MusicSambaCançãoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicSambaCançãoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 2 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 3 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 4 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 5 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 6 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 7 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 8 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 9 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 10 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 11 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 12 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 13 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 14 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 15 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 16 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 17 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 18 for MusicSambaCançãoProvider
  ///
  ...
  /// Provider method 19 for MusicSambaCançãoProvider
  ///
