...
/// Music ensemble provider
class MusicEnsembleProvider extends ChangeNotifier {
  MusicEnsembleProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicEnsembleProvider Item $idx',
  ...
  /// Provider method 0 for MusicEnsembleProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicEnsembleProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 2 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 3 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 4 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 5 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 6 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 7 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 8 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 9 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 10 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 11 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 12 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 13 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 14 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 15 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 16 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 17 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 18 for MusicEnsembleProvider
  ///
  ...
  /// Provider method 19 for MusicEnsembleProvider
  ///
