...
/// Music interval provider
class MusicIntervalProvider extends ChangeNotifier {
  MusicIntervalProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicIntervalProvider Item $idx',
  ...
  /// Provider method 0 for MusicIntervalProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicIntervalProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicIntervalProvider
  ///
  ...
  /// Provider method 2 for MusicIntervalProvider
  ///
  ...
  /// Provider method 3 for MusicIntervalProvider
  ///
  ...
  /// Provider method 4 for MusicIntervalProvider
  ///
  ...
  /// Provider method 5 for MusicIntervalProvider
  ///
  ...
  /// Provider method 6 for MusicIntervalProvider
  ///
  ...
  /// Provider method 7 for MusicIntervalProvider
  ///
  ...
  /// Provider method 8 for MusicIntervalProvider
  ///
  ...
  /// Provider method 9 for MusicIntervalProvider
  ///
  ...
  /// Provider method 10 for MusicIntervalProvider
  ///
  ...
  /// Provider method 11 for MusicIntervalProvider
  ///
  ...
  /// Provider method 12 for MusicIntervalProvider
  ///
  ...
  /// Provider method 13 for MusicIntervalProvider
  ///
  ...
  /// Provider method 14 for MusicIntervalProvider
  ///
  ...
  /// Provider method 15 for MusicIntervalProvider
  ///
  ...
  /// Provider method 16 for MusicIntervalProvider
  ///
  ...
  /// Provider method 17 for MusicIntervalProvider
  ///
  ...
  /// Provider method 18 for MusicIntervalProvider
  ///
  ...
  /// Provider method 19 for MusicIntervalProvider
  ///
