...
class EchoCancellationProvider extends ChangeNotifier {
  EchoCancellationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'EchoCancellationProvider Item $idx',
  ...
  /// Provider method 0 for EchoCancellationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'EchoCancellationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for EchoCancellationProvider
  ///
  ...
  /// Provider method 2 for EchoCancellationProvider
  ///
  ...
  /// Provider method 3 for EchoCancellationProvider
  ///
  ...
  /// Provider method 4 for EchoCancellationProvider
  ///
  ...
  /// Provider method 5 for EchoCancellationProvider
  ///
  ...
  /// Provider method 6 for EchoCancellationProvider
  ///
  ...
  /// Provider method 7 for EchoCancellationProvider
  ///
  ...
  /// Provider method 8 for EchoCancellationProvider
  ///
  ...
  /// Provider method 9 for EchoCancellationProvider
  ///
  ...
  /// Provider method 10 for EchoCancellationProvider
  ///
  ...
  /// Provider method 11 for EchoCancellationProvider
  ///
  ...
  /// Provider method 12 for EchoCancellationProvider
  ///
  ...
  /// Provider method 13 for EchoCancellationProvider
  ///
  ...
  /// Provider method 14 for EchoCancellationProvider
  ///
  ...
  /// Provider method 15 for EchoCancellationProvider
  ///
  ...
  /// Provider method 16 for EchoCancellationProvider
  ///
  ...
  /// Provider method 17 for EchoCancellationProvider
  ///
  ...
  /// Provider method 18 for EchoCancellationProvider
  ///
  ...
  /// Provider method 19 for EchoCancellationProvider
  ///
