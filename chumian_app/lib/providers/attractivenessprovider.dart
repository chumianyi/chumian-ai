...
/// Attractiveness provider
class AttractivenessProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'AttractivenessProvider Item $idx',
  ...
  /// Provider method 0 for AttractivenessProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'AttractivenessProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for AttractivenessProvider
  ///
  ...
  /// Provider method 2 for AttractivenessProvider
  ///
  ...
  /// Provider method 3 for AttractivenessProvider
  ///
  ...
  /// Provider method 4 for AttractivenessProvider
  ///
  ...
  /// Provider method 5 for AttractivenessProvider
  ///
  ...
  /// Provider method 6 for AttractivenessProvider
  ///
  ...
  /// Provider method 7 for AttractivenessProvider
  ///
  ...
  /// Provider method 8 for AttractivenessProvider
  ///
  ...
  /// Provider method 9 for AttractivenessProvider
  ///
  ...
  /// Provider method 10 for AttractivenessProvider
  ///
  ...
  /// Provider method 11 for AttractivenessProvider
  ///
  ...
  /// Provider method 12 for AttractivenessProvider
  ///
  ...
  /// Provider method 13 for AttractivenessProvider
  ///
  ...
  /// Provider method 14 for AttractivenessProvider
  ///
  ...
  /// Provider method 15 for AttractivenessProvider
  ///
  ...
  /// Provider method 16 for AttractivenessProvider
  ///
  ...
  /// Provider method 17 for AttractivenessProvider
  ///
  ...
  /// Provider method 18 for AttractivenessProvider
  ///
  ...
  /// Provider method 19 for AttractivenessProvider
  ///
