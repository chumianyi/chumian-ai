...
/// Music time signature provider
class MusicTimeSignatureProvider extends ChangeNotifier {
  MusicTimeSignatureProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicTimeSignatureProvider Item $idx',
  ...
  /// Provider method 0 for MusicTimeSignatureProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicTimeSignatureProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 2 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 3 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 4 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 5 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 6 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 7 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 8 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 9 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 10 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 11 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 12 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 13 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 14 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 15 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 16 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 17 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 18 for MusicTimeSignatureProvider
  ///
  ...
  /// Provider method 19 for MusicTimeSignatureProvider
  ///
