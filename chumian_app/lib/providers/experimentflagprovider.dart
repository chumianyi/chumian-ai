...
class ExperimentFlagProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'ExperimentFlagProvider Item $idx',
  ...
  /// Provider method 0 for ExperimentFlagProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'ExperimentFlagProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 2 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 3 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 4 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 5 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 6 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 7 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 8 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 9 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 10 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 11 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 12 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 13 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 14 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 15 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 16 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 17 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 18 for ExperimentFlagProvider
  ///
  ...
  /// Provider method 19 for ExperimentFlagProvider
  ///
