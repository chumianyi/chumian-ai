...
/// Music viola caipira provider
class MusicViolaCaipiraProvider extends ChangeNotifier {
  MusicViolaCaipiraProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicViolaCaipiraProvider Item $idx',
  ...
  /// Provider method 0 for MusicViolaCaipiraProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicViolaCaipiraProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 2 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 3 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 4 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 5 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 6 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 7 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 8 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 9 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 10 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 11 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 12 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 13 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 14 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 15 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 16 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 17 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 18 for MusicViolaCaipiraProvider
  ///
  ...
  /// Provider method 19 for MusicViolaCaipiraProvider
  ///
