...
/// Music pedal mark provider
class MusicPedalMarkProvider extends ChangeNotifier {
  MusicPedalMarkProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicPedalMarkProvider Item $idx',
  ...
  /// Provider method 0 for MusicPedalMarkProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicPedalMarkProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 2 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 3 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 4 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 5 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 6 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 7 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 8 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 9 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 10 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 11 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 12 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 13 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 14 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 15 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 16 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 17 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 18 for MusicPedalMarkProvider
  ///
  ...
  /// Provider method 19 for MusicPedalMarkProvider
  ///
