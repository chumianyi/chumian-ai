...
/// Music gaita ponto provider
class MusicGaitaPontoProvider extends ChangeNotifier {
  MusicGaitaPontoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicGaitaPontoProvider Item $idx',
  ...
  /// Provider method 0 for MusicGaitaPontoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicGaitaPontoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 2 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 3 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 4 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 5 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 6 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 7 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 8 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 9 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 10 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 11 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 12 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 13 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 14 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 15 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 16 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 17 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 18 for MusicGaitaPontoProvider
  ///
  ...
  /// Provider method 19 for MusicGaitaPontoProvider
  ///
