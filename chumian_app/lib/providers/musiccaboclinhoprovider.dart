...
/// Music caboclinho provider
class MusicCaboclinhoProvider extends ChangeNotifier {
  MusicCaboclinhoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicCaboclinhoProvider Item $idx',
  ...
  /// Provider method 0 for MusicCaboclinhoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicCaboclinhoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 2 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 3 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 4 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 5 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 6 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 7 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 8 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 9 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 10 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 11 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 12 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 13 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 14 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 15 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 16 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 17 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 18 for MusicCaboclinhoProvider
  ///
  ...
  /// Provider method 19 for MusicCaboclinhoProvider
  ///
