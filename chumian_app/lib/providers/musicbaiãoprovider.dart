...
/// Music baião provider
class MusicBaiãoProvider extends ChangeNotifier {
  MusicBaiãoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicBaiãoProvider Item $idx',
  ...
  /// Provider method 0 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 1 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 2 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 3 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 4 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 5 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 6 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 7 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 8 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 9 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 10 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 11 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 12 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 13 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 14 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 15 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 16 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 17 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 18 for MusicBaiãoProvider
  ///
  ...
  /// Provider method 19 for MusicBaiãoProvider
  ///
