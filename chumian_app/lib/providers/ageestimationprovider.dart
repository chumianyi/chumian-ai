...
/// Age estimation provider
class AgeEstimationProvider extends ChangeNotifier {
  AgeEstimationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'AgeEstimationProvider Item $idx',
  ...
  /// Provider method 0 for AgeEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'AgeEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for AgeEstimationProvider
  ///
  ...
  /// Provider method 2 for AgeEstimationProvider
  ///
  ...
  /// Provider method 3 for AgeEstimationProvider
  ///
  ...
  /// Provider method 4 for AgeEstimationProvider
  ///
  ...
  /// Provider method 5 for AgeEstimationProvider
  ///
  ...
  /// Provider method 6 for AgeEstimationProvider
  ///
  ...
  /// Provider method 7 for AgeEstimationProvider
  ///
  ...
  /// Provider method 8 for AgeEstimationProvider
  ///
  ...
  /// Provider method 9 for AgeEstimationProvider
  ///
  ...
  /// Provider method 10 for AgeEstimationProvider
  ///
  ...
  /// Provider method 11 for AgeEstimationProvider
  ///
  ...
  /// Provider method 12 for AgeEstimationProvider
  ///
  ...
  /// Provider method 13 for AgeEstimationProvider
  ///
  ...
  /// Provider method 14 for AgeEstimationProvider
  ///
  ...
  /// Provider method 15 for AgeEstimationProvider
  ///
  ...
  /// Provider method 16 for AgeEstimationProvider
  ///
  ...
  /// Provider method 17 for AgeEstimationProvider
  ///
  ...
  /// Provider method 18 for AgeEstimationProvider
  ///
  ...
  /// Provider method 19 for AgeEstimationProvider
  ///
