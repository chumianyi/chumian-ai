...
/// Music vaneirão provider
class MusicVaneirãoProvider extends ChangeNotifier {
  MusicVaneirãoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicVaneirãoProvider Item $idx',
  ...
  /// Provider method 0 for MusicVaneirãoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicVaneirãoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 2 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 3 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 4 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 5 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 6 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 7 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 8 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 9 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 10 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 11 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 12 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 13 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 14 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 15 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 16 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 17 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 18 for MusicVaneirãoProvider
  ///
  ...
  /// Provider method 19 for MusicVaneirãoProvider
  ///
