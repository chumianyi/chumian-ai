...
/// Music cavalhada provider
class MusicCavalhadaProvider extends ChangeNotifier {
  MusicCavalhadaProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicCavalhadaProvider Item $idx',
  ...
  /// Provider method 0 for MusicCavalhadaProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicCavalhadaProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 2 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 3 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 4 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 5 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 6 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 7 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 8 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 9 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 10 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 11 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 12 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 13 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 14 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 15 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 16 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 17 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 18 for MusicCavalhadaProvider
  ///
  ...
  /// Provider method 19 for MusicCavalhadaProvider
  ///
