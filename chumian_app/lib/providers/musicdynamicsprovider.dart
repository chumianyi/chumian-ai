...
/// Music dynamics provider
class MusicDynamicsProvider extends ChangeNotifier {
  MusicDynamicsProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicDynamicsProvider Item $idx',
  ...
  /// Provider method 0 for MusicDynamicsProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicDynamicsProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 2 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 3 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 4 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 5 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 6 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 7 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 8 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 9 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 10 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 11 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 12 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 13 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 14 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 15 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 16 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 17 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 18 for MusicDynamicsProvider
  ///
  ...
  /// Provider method 19 for MusicDynamicsProvider
  ///
