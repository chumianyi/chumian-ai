...
/// Music breath mark provider
class MusicBreathMarkProvider extends ChangeNotifier {
  MusicBreathMarkProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicBreathMarkProvider Item $idx',
  ...
  /// Provider method 0 for MusicBreathMarkProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicBreathMarkProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 2 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 3 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 4 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 5 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 6 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 7 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 8 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 9 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 10 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 11 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 12 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 13 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 14 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 15 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 16 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 17 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 18 for MusicBreathMarkProvider
  ///
  ...
  /// Provider method 19 for MusicBreathMarkProvider
  ///
