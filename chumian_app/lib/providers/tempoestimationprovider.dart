...
/// Tempo estimation provider
class TempoEstimationProvider extends ChangeNotifier {
  TempoEstimationProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'TempoEstimationProvider Item $idx',
  ...
  /// Provider method 0 for TempoEstimationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'TempoEstimationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for TempoEstimationProvider
  ///
  ...
  /// Provider method 2 for TempoEstimationProvider
  ///
  ...
  /// Provider method 3 for TempoEstimationProvider
  ///
  ...
  /// Provider method 4 for TempoEstimationProvider
  ///
  ...
  /// Provider method 5 for TempoEstimationProvider
  ///
  ...
  /// Provider method 6 for TempoEstimationProvider
  ///
  ...
  /// Provider method 7 for TempoEstimationProvider
  ///
  ...
  /// Provider method 8 for TempoEstimationProvider
  ///
  ...
  /// Provider method 9 for TempoEstimationProvider
  ///
  ...
  /// Provider method 10 for TempoEstimationProvider
  ///
  ...
  /// Provider method 11 for TempoEstimationProvider
  ///
  ...
  /// Provider method 12 for TempoEstimationProvider
  ///
  ...
  /// Provider method 13 for TempoEstimationProvider
  ///
  ...
  /// Provider method 14 for TempoEstimationProvider
  ///
  ...
  /// Provider method 15 for TempoEstimationProvider
  ///
  ...
  /// Provider method 16 for TempoEstimationProvider
  ///
  ...
  /// Provider method 17 for TempoEstimationProvider
  ///
  ...
  /// Provider method 18 for TempoEstimationProvider
  ///
  ...
  /// Provider method 19 for TempoEstimationProvider
  ///
