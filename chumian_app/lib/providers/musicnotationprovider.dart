...
/// Music notation provider
class MusicNotationProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicNotationProvider Item $idx',
  ...
  /// Provider method 0 for MusicNotationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicNotationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicNotationProvider
  ///
  ...
  /// Provider method 2 for MusicNotationProvider
  ///
  ...
  /// Provider method 3 for MusicNotationProvider
  ///
  ...
  /// Provider method 4 for MusicNotationProvider
  ///
  ...
  /// Provider method 5 for MusicNotationProvider
  ///
  ...
  /// Provider method 6 for MusicNotationProvider
  ///
  ...
  /// Provider method 7 for MusicNotationProvider
  ///
  ...
  /// Provider method 8 for MusicNotationProvider
  ///
  ...
  /// Provider method 9 for MusicNotationProvider
  ///
  ...
  /// Provider method 10 for MusicNotationProvider
  ///
  ...
  /// Provider method 11 for MusicNotationProvider
  ///
  ...
  /// Provider method 12 for MusicNotationProvider
  ///
  ...
  /// Provider method 13 for MusicNotationProvider
  ///
  ...
  /// Provider method 14 for MusicNotationProvider
  ///
  ...
  /// Provider method 15 for MusicNotationProvider
  ///
  ...
  /// Provider method 16 for MusicNotationProvider
  ///
  ...
  /// Provider method 17 for MusicNotationProvider
  ///
  ...
  /// Provider method 18 for MusicNotationProvider
  ///
  ...
  /// Provider method 19 for MusicNotationProvider
  ///
