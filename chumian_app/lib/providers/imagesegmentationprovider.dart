...
/// Image segmentation provider
class ImageSegmentationProvider extends ChangeNotifier {
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'ImageSegmentationProvider Item $idx',
  ...
  /// Provider method 0 for ImageSegmentationProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'ImageSegmentationProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 2 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 3 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 4 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 5 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 6 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 7 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 8 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 9 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 10 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 11 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 12 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 13 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 14 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 15 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 16 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 17 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 18 for ImageSegmentationProvider
  ///
  ...
  /// Provider method 19 for ImageSegmentationProvider
  ///
