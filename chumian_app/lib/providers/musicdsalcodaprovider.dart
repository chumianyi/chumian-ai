...
/// Music DS al coda provider
class MusicDsAlCodaProvider extends ChangeNotifier {
  MusicDsAlCodaProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicDsAlCodaProvider Item $idx',
  ...
  /// Provider method 0 for MusicDsAlCodaProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicDsAlCodaProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 2 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 3 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 4 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 5 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 6 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 7 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 8 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 9 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 10 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 11 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 12 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 13 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 14 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 15 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 16 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 17 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 18 for MusicDsAlCodaProvider
  ///
  ...
  /// Provider method 19 for MusicDsAlCodaProvider
  ///
