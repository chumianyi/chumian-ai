...
/// Music chegança provider
class MusicChegançaProvider extends ChangeNotifier {
  MusicChegançaProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicChegançaProvider Item $idx',
  ...
  /// Provider method 0 for MusicChegançaProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicChegançaProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicChegançaProvider
  ///
  ...
  /// Provider method 2 for MusicChegançaProvider
  ///
  ...
  /// Provider method 3 for MusicChegançaProvider
  ///
  ...
  /// Provider method 4 for MusicChegançaProvider
  ///
  ...
  /// Provider method 5 for MusicChegançaProvider
  ///
  ...
  /// Provider method 6 for MusicChegançaProvider
  ///
  ...
  /// Provider method 7 for MusicChegançaProvider
  ///
  ...
  /// Provider method 8 for MusicChegançaProvider
  ///
  ...
  /// Provider method 9 for MusicChegançaProvider
  ///
  ...
  /// Provider method 10 for MusicChegançaProvider
  ///
  ...
  /// Provider method 11 for MusicChegançaProvider
  ///
  ...
  /// Provider method 12 for MusicChegançaProvider
  ///
  ...
  /// Provider method 13 for MusicChegançaProvider
  ///
  ...
  /// Provider method 14 for MusicChegançaProvider
  ///
  ...
  /// Provider method 15 for MusicChegançaProvider
  ///
  ...
  /// Provider method 16 for MusicChegançaProvider
  ///
  ...
  /// Provider method 17 for MusicChegançaProvider
  ///
  ...
  /// Provider method 18 for MusicChegançaProvider
  ///
  ...
  /// Provider method 19 for MusicChegançaProvider
  ///
