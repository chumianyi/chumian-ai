...
/// Music entr'acte provider
class MusicEntrActeProvider extends ChangeNotifier {
  MusicEntrActeProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicEntrActeProvider Item $idx',
  ...
  /// Provider method 0 for MusicEntrActeProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicEntrActeProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 2 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 3 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 4 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 5 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 6 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 7 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 8 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 9 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 10 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 11 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 12 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 13 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 14 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 15 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 16 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 17 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 18 for MusicEntrActeProvider
  ///
  ...
  /// Provider method 19 for MusicEntrActeProvider
  ///
