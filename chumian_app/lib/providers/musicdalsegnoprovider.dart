...
/// Music dal segno provider
class MusicDalSegnoProvider extends ChangeNotifier {
  MusicDalSegnoProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicDalSegnoProvider Item $idx',
  ...
  /// Provider method 0 for MusicDalSegnoProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicDalSegnoProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 2 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 3 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 4 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 5 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 6 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 7 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 8 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 9 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 10 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 11 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 12 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 13 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 14 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 15 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 16 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 17 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 18 for MusicDalSegnoProvider
  ///
  ...
  /// Provider method 19 for MusicDalSegnoProvider
  ///
