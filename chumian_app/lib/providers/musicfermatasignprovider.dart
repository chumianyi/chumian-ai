...
/// Music fermata sign provider
class MusicFermataSignProvider extends ChangeNotifier {
  MusicFermataSignProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicFermataSignProvider Item $idx',
  ...
  /// Provider method 0 for MusicFermataSignProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicFermataSignProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 2 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 3 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 4 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 5 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 6 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 7 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 8 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 9 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 10 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 11 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 12 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 13 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 14 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 15 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 16 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 17 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 18 for MusicFermataSignProvider
  ///
  ...
  /// Provider method 19 for MusicFermataSignProvider
  ///
