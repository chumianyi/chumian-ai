...
/// Music recitative provider
class MusicRecitativeProvider extends ChangeNotifier {
  MusicRecitativeProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicRecitativeProvider Item $idx',
  ...
  /// Provider method 0 for MusicRecitativeProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicRecitativeProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 2 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 3 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 4 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 5 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 6 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 7 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 8 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 9 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 10 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 11 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 12 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 13 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 14 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 15 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 16 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 17 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 18 for MusicRecitativeProvider
  ///
  ...
  /// Provider method 19 for MusicRecitativeProvider
  ///
