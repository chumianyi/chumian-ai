...
/// Music tambor de crioula provider
class MusicTamborDeCrioulaProvider extends ChangeNotifier {
  MusicTamborDeCrioulaProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicTamborDeCrioulaProvider Item $idx',
  ...
  /// Provider method 0 for MusicTamborDeCrioulaProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicTamborDeCrioulaProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 2 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 3 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 4 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 5 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 6 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 7 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 8 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 9 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 10 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 11 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 12 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 13 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 14 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 15 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 16 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 17 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 18 for MusicTamborDeCrioulaProvider
  ///
  ...
  /// Provider method 19 for MusicTamborDeCrioulaProvider
  ///
