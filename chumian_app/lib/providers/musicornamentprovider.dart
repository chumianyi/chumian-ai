...
/// Music ornament provider
class MusicOrnamentProvider extends ChangeNotifier {
  MusicOrnamentProvider();
    ...
    try {
      ...
      for (int i = 0; i < 20; i++) {
        ...
        _items.add({
          ...
          'title': 'MusicOrnamentProvider Item $idx',
  ...
  /// Provider method 0 for MusicOrnamentProvider
  ///
  ...
  Future<Map<String, dynamic>> providerMethod0({
    ...
    try {
      ...
      final result = <String, dynamic>{
        ...
        'provider': 'MusicOrnamentProvider',
        'id': id,
        'data': data ?? {},
  ...
  /// Provider method 1 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 2 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 3 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 4 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 5 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 6 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 7 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 8 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 9 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 10 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 11 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 12 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 13 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 14 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 15 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 16 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 17 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 18 for MusicOrnamentProvider
  ///
  ...
  /// Provider method 19 for MusicOrnamentProvider
  ///
