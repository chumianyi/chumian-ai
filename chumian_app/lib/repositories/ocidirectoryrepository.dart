...
/// OCI Directory repository
class OciDirectoryRepository {
  OciDirectoryRepository._();
  static final OciDirectoryRepository instance = OciDirectoryRepository._();
  ...
  /// Repository method 0 for OciDirectoryRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDirectoryRepository',
  ...
  /// Repository method 1 for OciDirectoryRepository
  ///
  ...
  /// Repository method 2 for OciDirectoryRepository
  ///
  ...
  /// Repository method 3 for OciDirectoryRepository
  ///
  ...
  /// Repository method 4 for OciDirectoryRepository
  ///
  ...
  /// Repository method 5 for OciDirectoryRepository
  ///
  ...
  /// Repository method 6 for OciDirectoryRepository
  ///
  ...
  /// Repository method 7 for OciDirectoryRepository
  ///
  ...
  /// Repository method 8 for OciDirectoryRepository
  ///
  ...
  /// Repository method 9 for OciDirectoryRepository
  ///
  ...
  /// Repository method 10 for OciDirectoryRepository
  ///
  ...
  /// Repository method 11 for OciDirectoryRepository
  ///
  ...
  /// Repository method 12 for OciDirectoryRepository
  ///
  ...
  /// Repository method 13 for OciDirectoryRepository
  ///
  ...
  /// Repository method 14 for OciDirectoryRepository
  ///
