...
/// Virtuozzo repository
class VirtuozzoRepository {
  VirtuozzoRepository._();
  static final VirtuozzoRepository instance = VirtuozzoRepository._();
  ...
  /// Repository method 0 for VirtuozzoRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'VirtuozzoRepository',
  ...
  /// Repository method 1 for VirtuozzoRepository
  ///
  ...
  /// Repository method 2 for VirtuozzoRepository
  ///
  ...
  /// Repository method 3 for VirtuozzoRepository
  ///
  ...
  /// Repository method 4 for VirtuozzoRepository
  ///
  ...
  /// Repository method 5 for VirtuozzoRepository
  ///
  ...
  /// Repository method 6 for VirtuozzoRepository
  ///
  ...
  /// Repository method 7 for VirtuozzoRepository
  ///
  ...
  /// Repository method 8 for VirtuozzoRepository
  ///
  ...
  /// Repository method 9 for VirtuozzoRepository
  ///
  ...
  /// Repository method 10 for VirtuozzoRepository
  ///
  ...
  /// Repository method 11 for VirtuozzoRepository
  ///
  ...
  /// Repository method 12 for VirtuozzoRepository
  ///
  ...
  /// Repository method 13 for VirtuozzoRepository
  ///
  ...
  /// Repository method 14 for VirtuozzoRepository
  ///
