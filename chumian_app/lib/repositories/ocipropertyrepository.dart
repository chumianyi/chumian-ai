...
/// OCI Property repository
class OciPropertyRepository {
  OciPropertyRepository._();
  static final OciPropertyRepository instance = OciPropertyRepository._();
  ...
  /// Repository method 0 for OciPropertyRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPropertyRepository',
  ...
  /// Repository method 1 for OciPropertyRepository
  ///
  ...
  /// Repository method 2 for OciPropertyRepository
  ///
  ...
  /// Repository method 3 for OciPropertyRepository
  ///
  ...
  /// Repository method 4 for OciPropertyRepository
  ///
  ...
  /// Repository method 5 for OciPropertyRepository
  ///
  ...
  /// Repository method 6 for OciPropertyRepository
  ///
  ...
  /// Repository method 7 for OciPropertyRepository
  ///
  ...
  /// Repository method 8 for OciPropertyRepository
  ///
  ...
  /// Repository method 9 for OciPropertyRepository
  ///
  ...
  /// Repository method 10 for OciPropertyRepository
  ///
  ...
  /// Repository method 11 for OciPropertyRepository
  ///
  ...
  /// Repository method 12 for OciPropertyRepository
  ///
  ...
  /// Repository method 13 for OciPropertyRepository
  ///
  ...
  /// Repository method 14 for OciPropertyRepository
  ///
