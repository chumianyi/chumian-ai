...
/// OCI Notification repository
class OciNotificationRepository {
  OciNotificationRepository._();
  static final OciNotificationRepository instance = OciNotificationRepository._();
  ...
  /// Repository method 0 for OciNotificationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciNotificationRepository',
  ...
  /// Repository method 1 for OciNotificationRepository
  ///
  ...
  /// Repository method 2 for OciNotificationRepository
  ///
  ...
  /// Repository method 3 for OciNotificationRepository
  ///
  ...
  /// Repository method 4 for OciNotificationRepository
  ///
  ...
  /// Repository method 5 for OciNotificationRepository
  ///
  ...
  /// Repository method 6 for OciNotificationRepository
  ///
  ...
  /// Repository method 7 for OciNotificationRepository
  ///
  ...
  /// Repository method 8 for OciNotificationRepository
  ///
  ...
  /// Repository method 9 for OciNotificationRepository
  ///
  ...
  /// Repository method 10 for OciNotificationRepository
  ///
  ...
  /// Repository method 11 for OciNotificationRepository
  ///
  ...
  /// Repository method 12 for OciNotificationRepository
  ///
  ...
  /// Repository method 13 for OciNotificationRepository
  ///
  ...
  /// Repository method 14 for OciNotificationRepository
  ///
