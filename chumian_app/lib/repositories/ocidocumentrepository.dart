...
/// OCI Document repository
class OciDocumentRepository {
  OciDocumentRepository._();
  static final OciDocumentRepository instance = OciDocumentRepository._();
  ...
  /// Repository method 0 for OciDocumentRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDocumentRepository',
  ...
  /// Repository method 1 for OciDocumentRepository
  ///
  ...
  /// Repository method 2 for OciDocumentRepository
  ///
  ...
  /// Repository method 3 for OciDocumentRepository
  ///
  ...
  /// Repository method 4 for OciDocumentRepository
  ///
  ...
  /// Repository method 5 for OciDocumentRepository
  ///
  ...
  /// Repository method 6 for OciDocumentRepository
  ///
  ...
  /// Repository method 7 for OciDocumentRepository
  ///
  ...
  /// Repository method 8 for OciDocumentRepository
  ///
  ...
  /// Repository method 9 for OciDocumentRepository
  ///
  ...
  /// Repository method 10 for OciDocumentRepository
  ///
  ...
  /// Repository method 11 for OciDocumentRepository
  ///
  ...
  /// Repository method 12 for OciDocumentRepository
  ///
  ...
  /// Repository method 13 for OciDocumentRepository
  ///
  ...
  /// Repository method 14 for OciDocumentRepository
  ///
