...
/// OCI Namespace repository
class OciNamespaceRepository {
  OciNamespaceRepository._();
  static final OciNamespaceRepository instance = OciNamespaceRepository._();
  ...
  /// Repository method 0 for OciNamespaceRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciNamespaceRepository',
  ...
  /// Repository method 1 for OciNamespaceRepository
  ///
  ...
  /// Repository method 2 for OciNamespaceRepository
  ///
  ...
  /// Repository method 3 for OciNamespaceRepository
  ///
  ...
  /// Repository method 4 for OciNamespaceRepository
  ///
  ...
  /// Repository method 5 for OciNamespaceRepository
  ///
  ...
  /// Repository method 6 for OciNamespaceRepository
  ///
  ...
  /// Repository method 7 for OciNamespaceRepository
  ///
  ...
  /// Repository method 8 for OciNamespaceRepository
  ///
  ...
  /// Repository method 9 for OciNamespaceRepository
  ///
  ...
  /// Repository method 10 for OciNamespaceRepository
  ///
  ...
  /// Repository method 11 for OciNamespaceRepository
  ///
  ...
  /// Repository method 12 for OciNamespaceRepository
  ///
  ...
  /// Repository method 13 for OciNamespaceRepository
  ///
  ...
  /// Repository method 14 for OciNamespaceRepository
  ///
