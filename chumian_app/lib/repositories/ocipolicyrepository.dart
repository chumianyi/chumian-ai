...
/// OCI Policy repository
class OciPolicyRepository {
  OciPolicyRepository._();
  static final OciPolicyRepository instance = OciPolicyRepository._();
  ...
  /// Repository method 0 for OciPolicyRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPolicyRepository',
  ...
  /// Repository method 1 for OciPolicyRepository
  ///
  ...
  /// Repository method 2 for OciPolicyRepository
  ///
  ...
  /// Repository method 3 for OciPolicyRepository
  ///
  ...
  /// Repository method 4 for OciPolicyRepository
  ///
  ...
  /// Repository method 5 for OciPolicyRepository
  ///
  ...
  /// Repository method 6 for OciPolicyRepository
  ///
  ...
  /// Repository method 7 for OciPolicyRepository
  ///
  ...
  /// Repository method 8 for OciPolicyRepository
  ///
  ...
  /// Repository method 9 for OciPolicyRepository
  ///
  ...
  /// Repository method 10 for OciPolicyRepository
  ///
  ...
  /// Repository method 11 for OciPolicyRepository
  ///
  ...
  /// Repository method 12 for OciPolicyRepository
  ///
  ...
  /// Repository method 13 for OciPolicyRepository
  ///
  ...
  /// Repository method 14 for OciPolicyRepository
  ///
