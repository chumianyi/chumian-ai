...
/// GitLab Container Registry repository
class GitlabContainerRegistryRepository {
  GitlabContainerRegistryRepository._();
  static final GitlabContainerRegistryRepository instance = GitlabContainerRegistryRepository._();
  ...
  /// Repository method 0 for GitlabContainerRegistryRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'GitlabContainerRegistryRepository',
  ...
  /// Repository method 1 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 2 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 3 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 4 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 5 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 6 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 7 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 8 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 9 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 10 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 11 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 12 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 13 for GitlabContainerRegistryRepository
  ///
  ...
  /// Repository method 14 for GitlabContainerRegistryRepository
  ///
