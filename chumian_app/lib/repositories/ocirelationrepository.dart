...
/// OCI Relation repository
class OciRelationRepository {
  OciRelationRepository._();
  static final OciRelationRepository instance = OciRelationRepository._();
  ...
  /// Repository method 0 for OciRelationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciRelationRepository',
  ...
  /// Repository method 1 for OciRelationRepository
  ///
  ...
  /// Repository method 2 for OciRelationRepository
  ///
  ...
  /// Repository method 3 for OciRelationRepository
  ///
  ...
  /// Repository method 4 for OciRelationRepository
  ///
  ...
  /// Repository method 5 for OciRelationRepository
  ///
  ...
  /// Repository method 6 for OciRelationRepository
  ///
  ...
  /// Repository method 7 for OciRelationRepository
  ///
  ...
  /// Repository method 8 for OciRelationRepository
  ///
  ...
  /// Repository method 9 for OciRelationRepository
  ///
  ...
  /// Repository method 10 for OciRelationRepository
  ///
  ...
  /// Repository method 11 for OciRelationRepository
  ///
  ...
  /// Repository method 12 for OciRelationRepository
  ///
  ...
  /// Repository method 13 for OciRelationRepository
  ///
  ...
  /// Repository method 14 for OciRelationRepository
  ///
