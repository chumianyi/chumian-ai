...
/// OCI Action repository
class OciActionRepository {
  OciActionRepository._();
  static final OciActionRepository instance = OciActionRepository._();
  ...
  /// Repository method 0 for OciActionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciActionRepository',
  ...
  /// Repository method 1 for OciActionRepository
  ///
  ...
  /// Repository method 2 for OciActionRepository
  ///
  ...
  /// Repository method 3 for OciActionRepository
  ///
  ...
  /// Repository method 4 for OciActionRepository
  ///
  ...
  /// Repository method 5 for OciActionRepository
  ///
  ...
  /// Repository method 6 for OciActionRepository
  ///
  ...
  /// Repository method 7 for OciActionRepository
  ///
  ...
  /// Repository method 8 for OciActionRepository
  ///
  ...
  /// Repository method 9 for OciActionRepository
  ///
  ...
  /// Repository method 10 for OciActionRepository
  ///
  ...
  /// Repository method 11 for OciActionRepository
  ///
  ...
  /// Repository method 12 for OciActionRepository
  ///
  ...
  /// Repository method 13 for OciActionRepository
  ///
  ...
  /// Repository method 14 for OciActionRepository
  ///
