...
/// OCI Pointer repository
class OciPointerRepository {
  OciPointerRepository._();
  static final OciPointerRepository instance = OciPointerRepository._();
  ...
  /// Repository method 0 for OciPointerRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPointerRepository',
  ...
  /// Repository method 1 for OciPointerRepository
  ///
  ...
  /// Repository method 2 for OciPointerRepository
  ///
  ...
  /// Repository method 3 for OciPointerRepository
  ///
  ...
  /// Repository method 4 for OciPointerRepository
  ///
  ...
  /// Repository method 5 for OciPointerRepository
  ///
  ...
  /// Repository method 6 for OciPointerRepository
  ///
  ...
  /// Repository method 7 for OciPointerRepository
  ///
  ...
  /// Repository method 8 for OciPointerRepository
  ///
  ...
  /// Repository method 9 for OciPointerRepository
  ///
  ...
  /// Repository method 10 for OciPointerRepository
  ///
  ...
  /// Repository method 11 for OciPointerRepository
  ///
  ...
  /// Repository method 12 for OciPointerRepository
  ///
  ...
  /// Repository method 13 for OciPointerRepository
  ///
  ...
  /// Repository method 14 for OciPointerRepository
  ///
