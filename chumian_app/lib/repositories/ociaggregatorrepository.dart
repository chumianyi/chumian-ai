...
/// OCI Aggregator repository
class OciAggregatorRepository {
  OciAggregatorRepository._();
  static final OciAggregatorRepository instance = OciAggregatorRepository._();
  ...
  /// Repository method 0 for OciAggregatorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAggregatorRepository',
  ...
  /// Repository method 1 for OciAggregatorRepository
  ///
  ...
  /// Repository method 2 for OciAggregatorRepository
  ///
  ...
  /// Repository method 3 for OciAggregatorRepository
  ///
  ...
  /// Repository method 4 for OciAggregatorRepository
  ///
  ...
  /// Repository method 5 for OciAggregatorRepository
  ///
  ...
  /// Repository method 6 for OciAggregatorRepository
  ///
  ...
  /// Repository method 7 for OciAggregatorRepository
  ///
  ...
  /// Repository method 8 for OciAggregatorRepository
  ///
  ...
  /// Repository method 9 for OciAggregatorRepository
  ///
  ...
  /// Repository method 10 for OciAggregatorRepository
  ///
  ...
  /// Repository method 11 for OciAggregatorRepository
  ///
  ...
  /// Repository method 12 for OciAggregatorRepository
  ///
  ...
  /// Repository method 13 for OciAggregatorRepository
  ///
  ...
  /// Repository method 14 for OciAggregatorRepository
  ///
