...
/// OCI Location repository
class OciLocationRepository {
  OciLocationRepository._();
  static final OciLocationRepository instance = OciLocationRepository._();
  ...
  /// Repository method 0 for OciLocationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciLocationRepository',
  ...
  /// Repository method 1 for OciLocationRepository
  ///
  ...
  /// Repository method 2 for OciLocationRepository
  ///
  ...
  /// Repository method 3 for OciLocationRepository
  ///
  ...
  /// Repository method 4 for OciLocationRepository
  ///
  ...
  /// Repository method 5 for OciLocationRepository
  ///
  ...
  /// Repository method 6 for OciLocationRepository
  ///
  ...
  /// Repository method 7 for OciLocationRepository
  ///
  ...
  /// Repository method 8 for OciLocationRepository
  ///
  ...
  /// Repository method 9 for OciLocationRepository
  ///
  ...
  /// Repository method 10 for OciLocationRepository
  ///
  ...
  /// Repository method 11 for OciLocationRepository
  ///
  ...
  /// Repository method 12 for OciLocationRepository
  ///
  ...
  /// Repository method 13 for OciLocationRepository
  ///
  ...
  /// Repository method 14 for OciLocationRepository
  ///
