...
/// OCI Project repository
class OciProjectRepository {
  OciProjectRepository._();
  static final OciProjectRepository instance = OciProjectRepository._();
  ...
  /// Repository method 0 for OciProjectRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciProjectRepository',
  ...
  /// Repository method 1 for OciProjectRepository
  ///
  ...
  /// Repository method 2 for OciProjectRepository
  ///
  ...
  /// Repository method 3 for OciProjectRepository
  ///
  ...
  /// Repository method 4 for OciProjectRepository
  ///
  ...
  /// Repository method 5 for OciProjectRepository
  ///
  ...
  /// Repository method 6 for OciProjectRepository
  ///
  ...
  /// Repository method 7 for OciProjectRepository
  ///
  ...
  /// Repository method 8 for OciProjectRepository
  ///
  ...
  /// Repository method 9 for OciProjectRepository
  ///
  ...
  /// Repository method 10 for OciProjectRepository
  ///
  ...
  /// Repository method 11 for OciProjectRepository
  ///
  ...
  /// Repository method 12 for OciProjectRepository
  ///
  ...
  /// Repository method 13 for OciProjectRepository
  ///
  ...
  /// Repository method 14 for OciProjectRepository
  ///
