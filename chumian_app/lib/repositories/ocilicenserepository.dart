...
/// OCI License repository
class OciLicenseRepository {
  OciLicenseRepository._();
  static final OciLicenseRepository instance = OciLicenseRepository._();
  ...
  /// Repository method 0 for OciLicenseRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciLicenseRepository',
  ...
  /// Repository method 1 for OciLicenseRepository
  ///
  ...
  /// Repository method 2 for OciLicenseRepository
  ///
  ...
  /// Repository method 3 for OciLicenseRepository
  ///
  ...
  /// Repository method 4 for OciLicenseRepository
  ///
  ...
  /// Repository method 5 for OciLicenseRepository
  ///
  ...
  /// Repository method 6 for OciLicenseRepository
  ///
  ...
  /// Repository method 7 for OciLicenseRepository
  ///
  ...
  /// Repository method 8 for OciLicenseRepository
  ///
  ...
  /// Repository method 9 for OciLicenseRepository
  ///
  ...
  /// Repository method 10 for OciLicenseRepository
  ///
  ...
  /// Repository method 11 for OciLicenseRepository
  ///
  ...
  /// Repository method 12 for OciLicenseRepository
  ///
  ...
  /// Repository method 13 for OciLicenseRepository
  ///
  ...
  /// Repository method 14 for OciLicenseRepository
  ///
