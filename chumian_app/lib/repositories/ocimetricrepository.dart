...
/// OCI Metric repository
class OciMetricRepository {
  OciMetricRepository._();
  static final OciMetricRepository instance = OciMetricRepository._();
  ...
  /// Repository method 0 for OciMetricRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciMetricRepository',
  ...
  /// Repository method 1 for OciMetricRepository
  ///
  ...
  /// Repository method 2 for OciMetricRepository
  ///
  ...
  /// Repository method 3 for OciMetricRepository
  ///
  ...
  /// Repository method 4 for OciMetricRepository
  ///
  ...
  /// Repository method 5 for OciMetricRepository
  ///
  ...
  /// Repository method 6 for OciMetricRepository
  ///
  ...
  /// Repository method 7 for OciMetricRepository
  ///
  ...
  /// Repository method 8 for OciMetricRepository
  ///
  ...
  /// Repository method 9 for OciMetricRepository
  ///
  ...
  /// Repository method 10 for OciMetricRepository
  ///
  ...
  /// Repository method 11 for OciMetricRepository
  ///
  ...
  /// Repository method 12 for OciMetricRepository
  ///
  ...
  /// Repository method 13 for OciMetricRepository
  ///
  ...
  /// Repository method 14 for OciMetricRepository
  ///
