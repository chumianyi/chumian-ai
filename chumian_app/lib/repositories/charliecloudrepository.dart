...
/// Charliecloud repository
class CharliecloudRepository {
  CharliecloudRepository._();
  static final CharliecloudRepository instance = CharliecloudRepository._();
  ...
  /// Repository method 0 for CharliecloudRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'CharliecloudRepository',
  ...
  /// Repository method 1 for CharliecloudRepository
  ///
  ...
  /// Repository method 2 for CharliecloudRepository
  ///
  ...
  /// Repository method 3 for CharliecloudRepository
  ///
  ...
  /// Repository method 4 for CharliecloudRepository
  ///
  ...
  /// Repository method 5 for CharliecloudRepository
  ///
  ...
  /// Repository method 6 for CharliecloudRepository
  ///
  ...
  /// Repository method 7 for CharliecloudRepository
  ///
  ...
  /// Repository method 8 for CharliecloudRepository
  ///
  ...
  /// Repository method 9 for CharliecloudRepository
  ///
  ...
  /// Repository method 10 for CharliecloudRepository
  ///
  ...
  /// Repository method 11 for CharliecloudRepository
  ///
  ...
  /// Repository method 12 for CharliecloudRepository
  ///
  ...
  /// Repository method 13 for CharliecloudRepository
  ///
  ...
  /// Repository method 14 for CharliecloudRepository
  ///
