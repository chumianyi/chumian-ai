...
/// OCI Singleton repository
class OciSingletonRepository {
  OciSingletonRepository._();
  static final OciSingletonRepository instance = OciSingletonRepository._();
  ...
  /// Repository method 0 for OciSingletonRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciSingletonRepository',
  ...
  /// Repository method 1 for OciSingletonRepository
  ///
  ...
  /// Repository method 2 for OciSingletonRepository
  ///
  ...
  /// Repository method 3 for OciSingletonRepository
  ///
  ...
  /// Repository method 4 for OciSingletonRepository
  ///
  ...
  /// Repository method 5 for OciSingletonRepository
  ///
  ...
  /// Repository method 6 for OciSingletonRepository
  ///
  ...
  /// Repository method 7 for OciSingletonRepository
  ///
  ...
  /// Repository method 8 for OciSingletonRepository
  ///
  ...
  /// Repository method 9 for OciSingletonRepository
  ///
  ...
  /// Repository method 10 for OciSingletonRepository
  ///
  ...
  /// Repository method 11 for OciSingletonRepository
  ///
  ...
  /// Repository method 12 for OciSingletonRepository
  ///
  ...
  /// Repository method 13 for OciSingletonRepository
  ///
  ...
  /// Repository method 14 for OciSingletonRepository
  ///
