...
/// OCI Secret repository
class OciSecretRepository {
  OciSecretRepository._();
  static final OciSecretRepository instance = OciSecretRepository._();
  ...
  /// Repository method 0 for OciSecretRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciSecretRepository',
  ...
  /// Repository method 1 for OciSecretRepository
  ///
  ...
  /// Repository method 2 for OciSecretRepository
  ///
  ...
  /// Repository method 3 for OciSecretRepository
  ///
  ...
  /// Repository method 4 for OciSecretRepository
  ///
  ...
  /// Repository method 5 for OciSecretRepository
  ///
  ...
  /// Repository method 6 for OciSecretRepository
  ///
  ...
  /// Repository method 7 for OciSecretRepository
  ///
  ...
  /// Repository method 8 for OciSecretRepository
  ///
  ...
  /// Repository method 9 for OciSecretRepository
  ///
  ...
  /// Repository method 10 for OciSecretRepository
  ///
  ...
  /// Repository method 11 for OciSecretRepository
  ///
  ...
  /// Repository method 12 for OciSecretRepository
  ///
  ...
  /// Repository method 13 for OciSecretRepository
  ///
  ...
  /// Repository method 14 for OciSecretRepository
  ///
