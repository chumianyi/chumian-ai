...
/// OCI Finalization repository
class OciFinalizationRepository {
  OciFinalizationRepository._();
  static final OciFinalizationRepository instance = OciFinalizationRepository._();
  ...
  /// Repository method 0 for OciFinalizationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciFinalizationRepository',
  ...
  /// Repository method 1 for OciFinalizationRepository
  ///
  ...
  /// Repository method 2 for OciFinalizationRepository
  ///
  ...
  /// Repository method 3 for OciFinalizationRepository
  ///
  ...
  /// Repository method 4 for OciFinalizationRepository
  ///
  ...
  /// Repository method 5 for OciFinalizationRepository
  ///
  ...
  /// Repository method 6 for OciFinalizationRepository
  ///
  ...
  /// Repository method 7 for OciFinalizationRepository
  ///
  ...
  /// Repository method 8 for OciFinalizationRepository
  ///
  ...
  /// Repository method 9 for OciFinalizationRepository
  ///
  ...
  /// Repository method 10 for OciFinalizationRepository
  ///
  ...
  /// Repository method 11 for OciFinalizationRepository
  ///
  ...
  /// Repository method 12 for OciFinalizationRepository
  ///
  ...
  /// Repository method 13 for OciFinalizationRepository
  ///
  ...
  /// Repository method 14 for OciFinalizationRepository
  ///
