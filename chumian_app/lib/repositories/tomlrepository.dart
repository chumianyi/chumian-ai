...
class TomlRepository {
  TomlRepository._();
  static final TomlRepository instance = TomlRepository._();
  ...
  /// Repository method 0 for TomlRepository
  ///
  ...
  /// Repository method 1 for TomlRepository
  ///
  ...
  /// Repository method 2 for TomlRepository
  ///
  ...
  /// Repository method 3 for TomlRepository
  ///
  ...
  /// Repository method 4 for TomlRepository
  ///
  ...
  /// Repository method 5 for TomlRepository
  ///
  ...
  /// Repository method 6 for TomlRepository
  ///
  ...
  /// Repository method 7 for TomlRepository
  ///
  ...
  /// Repository method 8 for TomlRepository
  ///
  ...
  /// Repository method 9 for TomlRepository
  ///
