...
/// OCI Literal repository
class OciLiteralRepository {
  OciLiteralRepository._();
  static final OciLiteralRepository instance = OciLiteralRepository._();
  ...
  /// Repository method 0 for OciLiteralRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciLiteralRepository',
  ...
  /// Repository method 1 for OciLiteralRepository
  ///
  ...
  /// Repository method 2 for OciLiteralRepository
  ///
  ...
  /// Repository method 3 for OciLiteralRepository
  ///
  ...
  /// Repository method 4 for OciLiteralRepository
  ///
  ...
  /// Repository method 5 for OciLiteralRepository
  ///
  ...
  /// Repository method 6 for OciLiteralRepository
  ///
  ...
  /// Repository method 7 for OciLiteralRepository
  ///
  ...
  /// Repository method 8 for OciLiteralRepository
  ///
  ...
  /// Repository method 9 for OciLiteralRepository
  ///
  ...
  /// Repository method 10 for OciLiteralRepository
  ///
  ...
  /// Repository method 11 for OciLiteralRepository
  ///
  ...
  /// Repository method 12 for OciLiteralRepository
  ///
  ...
  /// Repository method 13 for OciLiteralRepository
  ///
  ...
  /// Repository method 14 for OciLiteralRepository
  ///
