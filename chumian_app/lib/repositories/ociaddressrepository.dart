...
/// OCI Address repository
class OciAddressRepository {
  OciAddressRepository._();
  static final OciAddressRepository instance = OciAddressRepository._();
  ...
  /// Repository method 0 for OciAddressRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAddressRepository',
  ...
  /// Repository method 1 for OciAddressRepository
  ///
  ...
  /// Repository method 2 for OciAddressRepository
  ///
  ...
  /// Repository method 3 for OciAddressRepository
  ///
  ...
  /// Repository method 4 for OciAddressRepository
  ///
  ...
  /// Repository method 5 for OciAddressRepository
  ///
  ...
  /// Repository method 6 for OciAddressRepository
  ///
  ...
  /// Repository method 7 for OciAddressRepository
  ///
  ...
  /// Repository method 8 for OciAddressRepository
  ///
  ...
  /// Repository method 9 for OciAddressRepository
  ///
  ...
  /// Repository method 10 for OciAddressRepository
  ///
  ...
  /// Repository method 11 for OciAddressRepository
  ///
  ...
  /// Repository method 12 for OciAddressRepository
  ///
  ...
  /// Repository method 13 for OciAddressRepository
  ///
  ...
  /// Repository method 14 for OciAddressRepository
  ///
