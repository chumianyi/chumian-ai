...
class OciCertificateRepository {
  OciCertificateRepository._();
  static final OciCertificateRepository instance = OciCertificateRepository._();
  ...
  /// Repository method 0 for OciCertificateRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciCertificateRepository',
  ...
  /// Repository method 1 for OciCertificateRepository
  ///
  ...
  /// Repository method 2 for OciCertificateRepository
  ///
  ...
  /// Repository method 3 for OciCertificateRepository
  ///
  ...
  /// Repository method 4 for OciCertificateRepository
  ///
  ...
  /// Repository method 5 for OciCertificateRepository
  ///
  ...
  /// Repository method 6 for OciCertificateRepository
  ///
  ...
  /// Repository method 7 for OciCertificateRepository
  ///
  ...
  /// Repository method 8 for OciCertificateRepository
  ///
  ...
  /// Repository method 9 for OciCertificateRepository
  ///
  ...
  /// Repository method 10 for OciCertificateRepository
  ///
  ...
  /// Repository method 11 for OciCertificateRepository
  ///
  ...
  /// Repository method 12 for OciCertificateRepository
  ///
  ...
  /// Repository method 13 for OciCertificateRepository
  ///
  ...
  /// Repository method 14 for OciCertificateRepository
  ///
