...
/// OCI Exception repository
class OciExceptionRepository {
  OciExceptionRepository._();
  static final OciExceptionRepository instance = OciExceptionRepository._();
  ...
  /// Repository method 0 for OciExceptionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciExceptionRepository',
  ...
  /// Repository method 1 for OciExceptionRepository
  ///
  ...
  /// Repository method 2 for OciExceptionRepository
  ///
  ...
  /// Repository method 3 for OciExceptionRepository
  ///
  ...
  /// Repository method 4 for OciExceptionRepository
  ///
  ...
  /// Repository method 5 for OciExceptionRepository
  ///
  ...
  /// Repository method 6 for OciExceptionRepository
  ///
  ...
  /// Repository method 7 for OciExceptionRepository
  ///
  ...
  /// Repository method 8 for OciExceptionRepository
  ///
  ...
  /// Repository method 9 for OciExceptionRepository
  ///
  ...
  /// Repository method 10 for OciExceptionRepository
  ///
  ...
  /// Repository method 11 for OciExceptionRepository
  ///
  ...
  /// Repository method 12 for OciExceptionRepository
  ///
  ...
  /// Repository method 13 for OciExceptionRepository
  ///
  ...
  /// Repository method 14 for OciExceptionRepository
  ///
