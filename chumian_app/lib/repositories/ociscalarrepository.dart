...
/// OCI Scalar repository
class OciScalarRepository {
  OciScalarRepository._();
  static final OciScalarRepository instance = OciScalarRepository._();
  ...
  /// Repository method 0 for OciScalarRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciScalarRepository',
  ...
  /// Repository method 1 for OciScalarRepository
  ///
  ...
  /// Repository method 2 for OciScalarRepository
  ///
  ...
  /// Repository method 3 for OciScalarRepository
  ///
  ...
  /// Repository method 4 for OciScalarRepository
  ///
  ...
  /// Repository method 5 for OciScalarRepository
  ///
  ...
  /// Repository method 6 for OciScalarRepository
  ///
  ...
  /// Repository method 7 for OciScalarRepository
  ///
  ...
  /// Repository method 8 for OciScalarRepository
  ///
  ...
  /// Repository method 9 for OciScalarRepository
  ///
  ...
  /// Repository method 10 for OciScalarRepository
  ///
  ...
  /// Repository method 11 for OciScalarRepository
  ///
  ...
  /// Repository method 12 for OciScalarRepository
  ///
  ...
  /// Repository method 13 for OciScalarRepository
  ///
  ...
  /// Repository method 14 for OciScalarRepository
  ///
