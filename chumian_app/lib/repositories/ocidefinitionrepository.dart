...
/// OCI Definition repository
class OciDefinitionRepository {
  OciDefinitionRepository._();
  static final OciDefinitionRepository instance = OciDefinitionRepository._();
  ...
  /// Repository method 0 for OciDefinitionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDefinitionRepository',
  ...
  /// Repository method 1 for OciDefinitionRepository
  ///
  ...
  /// Repository method 2 for OciDefinitionRepository
  ///
  ...
  /// Repository method 3 for OciDefinitionRepository
  ///
  ...
  /// Repository method 4 for OciDefinitionRepository
  ///
  ...
  /// Repository method 5 for OciDefinitionRepository
  ///
  ...
  /// Repository method 6 for OciDefinitionRepository
  ///
  ...
  /// Repository method 7 for OciDefinitionRepository
  ///
  ...
  /// Repository method 8 for OciDefinitionRepository
  ///
  ...
  /// Repository method 9 for OciDefinitionRepository
  ///
  ...
  /// Repository method 10 for OciDefinitionRepository
  ///
  ...
  /// Repository method 11 for OciDefinitionRepository
  ///
  ...
  /// Repository method 12 for OciDefinitionRepository
  ///
  ...
  /// Repository method 13 for OciDefinitionRepository
  ///
  ...
  /// Repository method 14 for OciDefinitionRepository
  ///
