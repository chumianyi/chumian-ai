...
/// OCI Instantiation repository
class OciInstantiationRepository {
  OciInstantiationRepository._();
  static final OciInstantiationRepository instance = OciInstantiationRepository._();
  ...
  /// Repository method 0 for OciInstantiationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciInstantiationRepository',
  ...
  /// Repository method 1 for OciInstantiationRepository
  ///
  ...
  /// Repository method 2 for OciInstantiationRepository
  ///
  ...
  /// Repository method 3 for OciInstantiationRepository
  ///
  ...
  /// Repository method 4 for OciInstantiationRepository
  ///
  ...
  /// Repository method 5 for OciInstantiationRepository
  ///
  ...
  /// Repository method 6 for OciInstantiationRepository
  ///
  ...
  /// Repository method 7 for OciInstantiationRepository
  ///
  ...
  /// Repository method 8 for OciInstantiationRepository
  ///
  ...
  /// Repository method 9 for OciInstantiationRepository
  ///
  ...
  /// Repository method 10 for OciInstantiationRepository
  ///
  ...
  /// Repository method 11 for OciInstantiationRepository
  ///
  ...
  /// Repository method 12 for OciInstantiationRepository
  ///
  ...
  /// Repository method 13 for OciInstantiationRepository
  ///
  ...
  /// Repository method 14 for OciInstantiationRepository
  ///
