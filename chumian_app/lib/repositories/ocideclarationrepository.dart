...
/// OCI Declaration repository
class OciDeclarationRepository {
  OciDeclarationRepository._();
  static final OciDeclarationRepository instance = OciDeclarationRepository._();
  ...
  /// Repository method 0 for OciDeclarationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDeclarationRepository',
  ...
  /// Repository method 1 for OciDeclarationRepository
  ///
  ...
  /// Repository method 2 for OciDeclarationRepository
  ///
  ...
  /// Repository method 3 for OciDeclarationRepository
  ///
  ...
  /// Repository method 4 for OciDeclarationRepository
  ///
  ...
  /// Repository method 5 for OciDeclarationRepository
  ///
  ...
  /// Repository method 6 for OciDeclarationRepository
  ///
  ...
  /// Repository method 7 for OciDeclarationRepository
  ///
  ...
  /// Repository method 8 for OciDeclarationRepository
  ///
  ...
  /// Repository method 9 for OciDeclarationRepository
  ///
  ...
  /// Repository method 10 for OciDeclarationRepository
  ///
  ...
  /// Repository method 11 for OciDeclarationRepository
  ///
  ...
  /// Repository method 12 for OciDeclarationRepository
  ///
  ...
  /// Repository method 13 for OciDeclarationRepository
  ///
  ...
  /// Repository method 14 for OciDeclarationRepository
  ///
