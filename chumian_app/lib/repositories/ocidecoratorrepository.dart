...
/// OCI Decorator repository
class OciDecoratorRepository {
  OciDecoratorRepository._();
  static final OciDecoratorRepository instance = OciDecoratorRepository._();
  ...
  /// Repository method 0 for OciDecoratorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDecoratorRepository',
  ...
  /// Repository method 1 for OciDecoratorRepository
  ///
  ...
  /// Repository method 2 for OciDecoratorRepository
  ///
  ...
  /// Repository method 3 for OciDecoratorRepository
  ///
  ...
  /// Repository method 4 for OciDecoratorRepository
  ///
  ...
  /// Repository method 5 for OciDecoratorRepository
  ///
  ...
  /// Repository method 6 for OciDecoratorRepository
  ///
  ...
  /// Repository method 7 for OciDecoratorRepository
  ///
  ...
  /// Repository method 8 for OciDecoratorRepository
  ///
  ...
  /// Repository method 9 for OciDecoratorRepository
  ///
  ...
  /// Repository method 10 for OciDecoratorRepository
  ///
  ...
  /// Repository method 11 for OciDecoratorRepository
  ///
  ...
  /// Repository method 12 for OciDecoratorRepository
  ///
  ...
  /// Repository method 13 for OciDecoratorRepository
  ///
  ...
  /// Repository method 14 for OciDecoratorRepository
  ///
