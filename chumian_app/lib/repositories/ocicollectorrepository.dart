...
/// OCI Collector repository
class OciCollectorRepository {
  OciCollectorRepository._();
  static final OciCollectorRepository instance = OciCollectorRepository._();
  ...
  /// Repository method 0 for OciCollectorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciCollectorRepository',
  ...
  /// Repository method 1 for OciCollectorRepository
  ///
  ...
  /// Repository method 2 for OciCollectorRepository
  ///
  ...
  /// Repository method 3 for OciCollectorRepository
  ///
  ...
  /// Repository method 4 for OciCollectorRepository
  ///
  ...
  /// Repository method 5 for OciCollectorRepository
  ///
  ...
  /// Repository method 6 for OciCollectorRepository
  ///
  ...
  /// Repository method 7 for OciCollectorRepository
  ///
  ...
  /// Repository method 8 for OciCollectorRepository
  ///
  ...
  /// Repository method 9 for OciCollectorRepository
  ///
  ...
  /// Repository method 10 for OciCollectorRepository
  ///
  ...
  /// Repository method 11 for OciCollectorRepository
  ///
  ...
  /// Repository method 12 for OciCollectorRepository
  ///
  ...
  /// Repository method 13 for OciCollectorRepository
  ///
  ...
  /// Repository method 14 for OciCollectorRepository
  ///
