...
/// Docker Swarm repository
class DockerSwarmRepository {
  DockerSwarmRepository._();
  static final DockerSwarmRepository instance = DockerSwarmRepository._();
  ...
  /// Repository method 0 for DockerSwarmRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'DockerSwarmRepository',
  ...
  /// Repository method 1 for DockerSwarmRepository
  ///
  ...
  /// Repository method 2 for DockerSwarmRepository
  ///
  ...
  /// Repository method 3 for DockerSwarmRepository
  ///
  ...
  /// Repository method 4 for DockerSwarmRepository
  ///
  ...
  /// Repository method 5 for DockerSwarmRepository
  ///
  ...
  /// Repository method 6 for DockerSwarmRepository
  ///
  ...
  /// Repository method 7 for DockerSwarmRepository
  ///
  ...
  /// Repository method 8 for DockerSwarmRepository
  ///
  ...
  /// Repository method 9 for DockerSwarmRepository
  ///
  ...
  /// Repository method 10 for DockerSwarmRepository
  ///
  ...
  /// Repository method 11 for DockerSwarmRepository
  ///
  ...
  /// Repository method 12 for DockerSwarmRepository
  ///
  ...
  /// Repository method 13 for DockerSwarmRepository
  ///
  ...
  /// Repository method 14 for DockerSwarmRepository
  ///
