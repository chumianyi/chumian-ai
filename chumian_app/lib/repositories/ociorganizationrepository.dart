...
class OciOrganizationRepository {
  OciOrganizationRepository._();
  static final OciOrganizationRepository instance = OciOrganizationRepository._();
  ...
  /// Repository method 0 for OciOrganizationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciOrganizationRepository',
  ...
  /// Repository method 1 for OciOrganizationRepository
  ///
  ...
  /// Repository method 2 for OciOrganizationRepository
  ///
  ...
  /// Repository method 3 for OciOrganizationRepository
  ///
  ...
  /// Repository method 4 for OciOrganizationRepository
  ///
  ...
  /// Repository method 5 for OciOrganizationRepository
  ///
  ...
  /// Repository method 6 for OciOrganizationRepository
  ///
  ...
  /// Repository method 7 for OciOrganizationRepository
  ///
  ...
  /// Repository method 8 for OciOrganizationRepository
  ///
  ...
  /// Repository method 9 for OciOrganizationRepository
  ///
  ...
  /// Repository method 10 for OciOrganizationRepository
  ///
  ...
  /// Repository method 11 for OciOrganizationRepository
  ///
  ...
  /// Repository method 12 for OciOrganizationRepository
  ///
  ...
  /// Repository method 13 for OciOrganizationRepository
  ///
  ...
  /// Repository method 14 for OciOrganizationRepository
  ///
