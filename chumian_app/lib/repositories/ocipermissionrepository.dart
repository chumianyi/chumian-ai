...
class OciPermissionRepository {
  OciPermissionRepository._();
  static final OciPermissionRepository instance = OciPermissionRepository._();
  ...
  /// Repository method 0 for OciPermissionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPermissionRepository',
  ...
  /// Repository method 1 for OciPermissionRepository
  ///
  ...
  /// Repository method 2 for OciPermissionRepository
  ///
  ...
  /// Repository method 3 for OciPermissionRepository
  ///
  ...
  /// Repository method 4 for OciPermissionRepository
  ///
  ...
  /// Repository method 5 for OciPermissionRepository
  ///
  ...
  /// Repository method 6 for OciPermissionRepository
  ///
  ...
  /// Repository method 7 for OciPermissionRepository
  ///
  ...
  /// Repository method 8 for OciPermissionRepository
  ///
  ...
  /// Repository method 9 for OciPermissionRepository
  ///
  ...
  /// Repository method 10 for OciPermissionRepository
  ///
  ...
  /// Repository method 11 for OciPermissionRepository
  ///
  ...
  /// Repository method 12 for OciPermissionRepository
  ///
  ...
  /// Repository method 13 for OciPermissionRepository
  ///
  ...
  /// Repository method 14 for OciPermissionRepository
  ///
