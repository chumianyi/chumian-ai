...
/// OCI Encryption repository
class OciEncryptionRepository {
  OciEncryptionRepository._();
  static final OciEncryptionRepository instance = OciEncryptionRepository._();
  ...
  /// Repository method 0 for OciEncryptionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciEncryptionRepository',
  ...
  /// Repository method 1 for OciEncryptionRepository
  ///
  ...
  /// Repository method 2 for OciEncryptionRepository
  ///
  ...
  /// Repository method 3 for OciEncryptionRepository
  ///
  ...
  /// Repository method 4 for OciEncryptionRepository
  ///
  ...
  /// Repository method 5 for OciEncryptionRepository
  ///
  ...
  /// Repository method 6 for OciEncryptionRepository
  ///
  ...
  /// Repository method 7 for OciEncryptionRepository
  ///
  ...
  /// Repository method 8 for OciEncryptionRepository
  ///
  ...
  /// Repository method 9 for OciEncryptionRepository
  ///
  ...
  /// Repository method 10 for OciEncryptionRepository
  ///
  ...
  /// Repository method 11 for OciEncryptionRepository
  ///
  ...
  /// Repository method 12 for OciEncryptionRepository
  ///
  ...
  /// Repository method 13 for OciEncryptionRepository
  ///
  ...
  /// Repository method 14 for OciEncryptionRepository
  ///
