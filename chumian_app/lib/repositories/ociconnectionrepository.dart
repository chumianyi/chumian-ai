...
/// OCI Connection repository
class OciConnectionRepository {
  OciConnectionRepository._();
  static final OciConnectionRepository instance = OciConnectionRepository._();
  ...
  /// Repository method 0 for OciConnectionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciConnectionRepository',
  ...
  /// Repository method 1 for OciConnectionRepository
  ///
  ...
  /// Repository method 2 for OciConnectionRepository
  ///
  ...
  /// Repository method 3 for OciConnectionRepository
  ///
  ...
  /// Repository method 4 for OciConnectionRepository
  ///
  ...
  /// Repository method 5 for OciConnectionRepository
  ///
  ...
  /// Repository method 6 for OciConnectionRepository
  ///
  ...
  /// Repository method 7 for OciConnectionRepository
  ///
  ...
  /// Repository method 8 for OciConnectionRepository
  ///
  ...
  /// Repository method 9 for OciConnectionRepository
  ///
  ...
  /// Repository method 10 for OciConnectionRepository
  ///
  ...
  /// Repository method 11 for OciConnectionRepository
  ///
  ...
  /// Repository method 12 for OciConnectionRepository
  ///
  ...
  /// Repository method 13 for OciConnectionRepository
  ///
  ...
  /// Repository method 14 for OciConnectionRepository
  ///
