...
class ContainerdRepository {
  ContainerdRepository._();
  static final ContainerdRepository instance = ContainerdRepository._();
  ...
  /// Repository method 0 for ContainerdRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'ContainerdRepository',
  ...
  /// Repository method 1 for ContainerdRepository
  ///
  ...
  /// Repository method 2 for ContainerdRepository
  ///
  ...
  /// Repository method 3 for ContainerdRepository
  ///
  ...
  /// Repository method 4 for ContainerdRepository
  ///
  ...
  /// Repository method 5 for ContainerdRepository
  ///
  ...
  /// Repository method 6 for ContainerdRepository
  ///
  ...
  /// Repository method 7 for ContainerdRepository
  ///
  ...
  /// Repository method 8 for ContainerdRepository
  ///
  ...
  /// Repository method 9 for ContainerdRepository
  ///
  ...
  /// Repository method 10 for ContainerdRepository
  ///
  ...
  /// Repository method 11 for ContainerdRepository
  ///
  ...
  /// Repository method 12 for ContainerdRepository
  ///
  ...
  /// Repository method 13 for ContainerdRepository
  ///
  ...
  /// Repository method 14 for ContainerdRepository
  ///
