...
/// OCI Trigger repository
class OciTriggerRepository {
  OciTriggerRepository._();
  static final OciTriggerRepository instance = OciTriggerRepository._();
  ...
  /// Repository method 0 for OciTriggerRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciTriggerRepository',
  ...
  /// Repository method 1 for OciTriggerRepository
  ///
  ...
  /// Repository method 2 for OciTriggerRepository
  ///
  ...
  /// Repository method 3 for OciTriggerRepository
  ///
  ...
  /// Repository method 4 for OciTriggerRepository
  ///
  ...
  /// Repository method 5 for OciTriggerRepository
  ///
  ...
  /// Repository method 6 for OciTriggerRepository
  ///
  ...
  /// Repository method 7 for OciTriggerRepository
  ///
  ...
  /// Repository method 8 for OciTriggerRepository
  ///
  ...
  /// Repository method 9 for OciTriggerRepository
  ///
  ...
  /// Repository method 10 for OciTriggerRepository
  ///
  ...
  /// Repository method 11 for OciTriggerRepository
  ///
  ...
  /// Repository method 12 for OciTriggerRepository
  ///
  ...
  /// Repository method 13 for OciTriggerRepository
  ///
  ...
  /// Repository method 14 for OciTriggerRepository
  ///
