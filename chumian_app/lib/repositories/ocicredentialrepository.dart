...
class OciCredentialRepository {
  OciCredentialRepository._();
  static final OciCredentialRepository instance = OciCredentialRepository._();
  ...
  /// Repository method 0 for OciCredentialRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciCredentialRepository',
  ...
  /// Repository method 1 for OciCredentialRepository
  ///
  ...
  /// Repository method 2 for OciCredentialRepository
  ///
  ...
  /// Repository method 3 for OciCredentialRepository
  ///
  ...
  /// Repository method 4 for OciCredentialRepository
  ///
  ...
  /// Repository method 5 for OciCredentialRepository
  ///
  ...
  /// Repository method 6 for OciCredentialRepository
  ///
  ...
  /// Repository method 7 for OciCredentialRepository
  ///
  ...
  /// Repository method 8 for OciCredentialRepository
  ///
  ...
  /// Repository method 9 for OciCredentialRepository
  ///
  ...
  /// Repository method 10 for OciCredentialRepository
  ///
  ...
  /// Repository method 11 for OciCredentialRepository
  ///
  ...
  /// Repository method 12 for OciCredentialRepository
  ///
  ...
  /// Repository method 13 for OciCredentialRepository
  ///
  ...
  /// Repository method 14 for OciCredentialRepository
  ///
