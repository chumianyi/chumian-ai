...
/// OCI Signature repository
class OciSignatureRepository {
  OciSignatureRepository._();
  static final OciSignatureRepository instance = OciSignatureRepository._();
  ...
  /// Repository method 0 for OciSignatureRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciSignatureRepository',
  ...
  /// Repository method 1 for OciSignatureRepository
  ///
  ...
  /// Repository method 2 for OciSignatureRepository
  ///
  ...
  /// Repository method 3 for OciSignatureRepository
  ///
  ...
  /// Repository method 4 for OciSignatureRepository
  ///
  ...
  /// Repository method 5 for OciSignatureRepository
  ///
  ...
  /// Repository method 6 for OciSignatureRepository
  ///
  ...
  /// Repository method 7 for OciSignatureRepository
  ///
  ...
  /// Repository method 8 for OciSignatureRepository
  ///
  ...
  /// Repository method 9 for OciSignatureRepository
  ///
  ...
  /// Repository method 10 for OciSignatureRepository
  ///
  ...
  /// Repository method 11 for OciSignatureRepository
  ///
  ...
  /// Repository method 12 for OciSignatureRepository
  ///
  ...
  /// Repository method 13 for OciSignatureRepository
  ///
  ...
  /// Repository method 14 for OciSignatureRepository
  ///
