...
/// OCI Abstract repository
class OciAbstractRepository {
  OciAbstractRepository._();
  static final OciAbstractRepository instance = OciAbstractRepository._();
  ...
  /// Repository method 0 for OciAbstractRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAbstractRepository',
  ...
  /// Repository method 1 for OciAbstractRepository
  ///
  ...
  /// Repository method 2 for OciAbstractRepository
  ///
  ...
  /// Repository method 3 for OciAbstractRepository
  ///
  ...
  /// Repository method 4 for OciAbstractRepository
  ///
  ...
  /// Repository method 5 for OciAbstractRepository
  ///
  ...
  /// Repository method 6 for OciAbstractRepository
  ///
  ...
  /// Repository method 7 for OciAbstractRepository
  ///
  ...
  /// Repository method 8 for OciAbstractRepository
  ///
  ...
  /// Repository method 9 for OciAbstractRepository
  ///
  ...
  /// Repository method 10 for OciAbstractRepository
  ///
  ...
  /// Repository method 11 for OciAbstractRepository
  ///
  ...
  /// Repository method 12 for OciAbstractRepository
  ///
  ...
  /// Repository method 13 for OciAbstractRepository
  ///
  ...
  /// Repository method 14 for OciAbstractRepository
  ///
