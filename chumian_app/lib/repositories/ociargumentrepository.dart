...
/// OCI Argument repository
class OciArgumentRepository {
  OciArgumentRepository._();
  static final OciArgumentRepository instance = OciArgumentRepository._();
  ...
  /// Repository method 0 for OciArgumentRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciArgumentRepository',
  ...
  /// Repository method 1 for OciArgumentRepository
  ///
  ...
  /// Repository method 2 for OciArgumentRepository
  ///
  ...
  /// Repository method 3 for OciArgumentRepository
  ///
  ...
  /// Repository method 4 for OciArgumentRepository
  ///
  ...
  /// Repository method 5 for OciArgumentRepository
  ///
  ...
  /// Repository method 6 for OciArgumentRepository
  ///
  ...
  /// Repository method 7 for OciArgumentRepository
  ///
  ...
  /// Repository method 8 for OciArgumentRepository
  ///
  ...
  /// Repository method 9 for OciArgumentRepository
  ///
  ...
  /// Repository method 10 for OciArgumentRepository
  ///
  ...
  /// Repository method 11 for OciArgumentRepository
  ///
  ...
  /// Repository method 12 for OciArgumentRepository
  ///
  ...
  /// Repository method 13 for OciArgumentRepository
  ///
  ...
  /// Repository method 14 for OciArgumentRepository
  ///
