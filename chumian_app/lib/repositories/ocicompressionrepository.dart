...
/// OCI Compression repository
class OciCompressionRepository {
  OciCompressionRepository._();
  static final OciCompressionRepository instance = OciCompressionRepository._();
  ...
  /// Repository method 0 for OciCompressionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciCompressionRepository',
  ...
  /// Repository method 1 for OciCompressionRepository
  ///
  ...
  /// Repository method 2 for OciCompressionRepository
  ///
  ...
  /// Repository method 3 for OciCompressionRepository
  ///
  ...
  /// Repository method 4 for OciCompressionRepository
  ///
  ...
  /// Repository method 5 for OciCompressionRepository
  ///
  ...
  /// Repository method 6 for OciCompressionRepository
  ///
  ...
  /// Repository method 7 for OciCompressionRepository
  ///
  ...
  /// Repository method 8 for OciCompressionRepository
  ///
  ...
  /// Repository method 9 for OciCompressionRepository
  ///
  ...
  /// Repository method 10 for OciCompressionRepository
  ///
  ...
  /// Repository method 11 for OciCompressionRepository
  ///
  ...
  /// Repository method 12 for OciCompressionRepository
  ///
  ...
  /// Repository method 13 for OciCompressionRepository
  ///
  ...
  /// Repository method 14 for OciCompressionRepository
  ///
