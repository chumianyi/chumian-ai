...
/// OCI Monitor repository
class OciMonitorRepository {
  OciMonitorRepository._();
  static final OciMonitorRepository instance = OciMonitorRepository._();
  ...
  /// Repository method 0 for OciMonitorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciMonitorRepository',
  ...
  /// Repository method 1 for OciMonitorRepository
  ///
  ...
  /// Repository method 2 for OciMonitorRepository
  ///
  ...
  /// Repository method 3 for OciMonitorRepository
  ///
  ...
  /// Repository method 4 for OciMonitorRepository
  ///
  ...
  /// Repository method 5 for OciMonitorRepository
  ///
  ...
  /// Repository method 6 for OciMonitorRepository
  ///
  ...
  /// Repository method 7 for OciMonitorRepository
  ///
  ...
  /// Repository method 8 for OciMonitorRepository
  ///
  ...
  /// Repository method 9 for OciMonitorRepository
  ///
  ...
  /// Repository method 10 for OciMonitorRepository
  ///
  ...
  /// Repository method 11 for OciMonitorRepository
  ///
  ...
  /// Repository method 12 for OciMonitorRepository
  ///
  ...
  /// Repository method 13 for OciMonitorRepository
  ///
  ...
  /// Repository method 14 for OciMonitorRepository
  ///
