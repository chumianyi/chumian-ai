...
/// OCI Termination repository
class OciTerminationRepository {
  OciTerminationRepository._();
  static final OciTerminationRepository instance = OciTerminationRepository._();
  ...
  /// Repository method 0 for OciTerminationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciTerminationRepository',
  ...
  /// Repository method 1 for OciTerminationRepository
  ///
  ...
  /// Repository method 2 for OciTerminationRepository
  ///
  ...
  /// Repository method 3 for OciTerminationRepository
  ///
  ...
  /// Repository method 4 for OciTerminationRepository
  ///
  ...
  /// Repository method 5 for OciTerminationRepository
  ///
  ...
  /// Repository method 6 for OciTerminationRepository
  ///
  ...
  /// Repository method 7 for OciTerminationRepository
  ///
  ...
  /// Repository method 8 for OciTerminationRepository
  ///
  ...
  /// Repository method 9 for OciTerminationRepository
  ///
  ...
  /// Repository method 10 for OciTerminationRepository
  ///
  ...
  /// Repository method 11 for OciTerminationRepository
  ///
  ...
  /// Repository method 12 for OciTerminationRepository
  ///
  ...
  /// Repository method 13 for OciTerminationRepository
  ///
  ...
  /// Repository method 14 for OciTerminationRepository
  ///
