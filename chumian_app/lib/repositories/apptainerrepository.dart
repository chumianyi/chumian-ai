...
/// Apptainer repository
class ApptainerRepository {
  ApptainerRepository._();
  static final ApptainerRepository instance = ApptainerRepository._();
  ...
  /// Repository method 0 for ApptainerRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'ApptainerRepository',
  ...
  /// Repository method 1 for ApptainerRepository
  ///
  ...
  /// Repository method 2 for ApptainerRepository
  ///
  ...
  /// Repository method 3 for ApptainerRepository
  ///
  ...
  /// Repository method 4 for ApptainerRepository
  ///
  ...
  /// Repository method 5 for ApptainerRepository
  ///
  ...
  /// Repository method 6 for ApptainerRepository
  ///
  ...
  /// Repository method 7 for ApptainerRepository
  ///
  ...
  /// Repository method 8 for ApptainerRepository
  ///
  ...
  /// Repository method 9 for ApptainerRepository
  ///
  ...
  /// Repository method 10 for ApptainerRepository
  ///
  ...
  /// Repository method 11 for ApptainerRepository
  ///
  ...
  /// Repository method 12 for ApptainerRepository
  ///
  ...
  /// Repository method 13 for ApptainerRepository
  ///
  ...
  /// Repository method 14 for ApptainerRepository
  ///
