...
/// OCI Column repository
class OciColumnRepository {
  OciColumnRepository._();
  static final OciColumnRepository instance = OciColumnRepository._();
  ...
  /// Repository method 0 for OciColumnRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciColumnRepository',
  ...
  /// Repository method 1 for OciColumnRepository
  ///
  ...
  /// Repository method 2 for OciColumnRepository
  ///
  ...
  /// Repository method 3 for OciColumnRepository
  ///
  ...
  /// Repository method 4 for OciColumnRepository
  ///
  ...
  /// Repository method 5 for OciColumnRepository
  ///
  ...
  /// Repository method 6 for OciColumnRepository
  ///
  ...
  /// Repository method 7 for OciColumnRepository
  ///
  ...
  /// Repository method 8 for OciColumnRepository
  ///
  ...
  /// Repository method 9 for OciColumnRepository
  ///
  ...
  /// Repository method 10 for OciColumnRepository
  ///
  ...
  /// Repository method 11 for OciColumnRepository
  ///
  ...
  /// Repository method 12 for OciColumnRepository
  ///
  ...
  /// Repository method 13 for OciColumnRepository
  ///
  ...
  /// Repository method 14 for OciColumnRepository
  ///
