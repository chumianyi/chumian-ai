...
/// OCI Interface repository
class OciInterfaceRepository {
  OciInterfaceRepository._();
  static final OciInterfaceRepository instance = OciInterfaceRepository._();
  ...
  /// Repository method 0 for OciInterfaceRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciInterfaceRepository',
  ...
  /// Repository method 1 for OciInterfaceRepository
  ///
  ...
  /// Repository method 2 for OciInterfaceRepository
  ///
  ...
  /// Repository method 3 for OciInterfaceRepository
  ///
  ...
  /// Repository method 4 for OciInterfaceRepository
  ///
  ...
  /// Repository method 5 for OciInterfaceRepository
  ///
  ...
  /// Repository method 6 for OciInterfaceRepository
  ///
  ...
  /// Repository method 7 for OciInterfaceRepository
  ///
  ...
  /// Repository method 8 for OciInterfaceRepository
  ///
  ...
  /// Repository method 9 for OciInterfaceRepository
  ///
  ...
  /// Repository method 10 for OciInterfaceRepository
  ///
  ...
  /// Repository method 11 for OciInterfaceRepository
  ///
  ...
  /// Repository method 12 for OciInterfaceRepository
  ///
  ...
  /// Repository method 13 for OciInterfaceRepository
  ///
  ...
  /// Repository method 14 for OciInterfaceRepository
  ///
