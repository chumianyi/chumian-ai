...
/// OCI Authorization repository
class OciAuthorizationRepository {
  OciAuthorizationRepository._();
  static final OciAuthorizationRepository instance = OciAuthorizationRepository._();
  ...
  /// Repository method 0 for OciAuthorizationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAuthorizationRepository',
  ...
  /// Repository method 1 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 2 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 3 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 4 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 5 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 6 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 7 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 8 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 9 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 10 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 11 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 12 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 13 for OciAuthorizationRepository
  ///
  ...
  /// Repository method 14 for OciAuthorizationRepository
  ///
