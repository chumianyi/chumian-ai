...
class OciRegistryRepository {
  OciRegistryRepository._();
  static final OciRegistryRepository instance = OciRegistryRepository._();
  ...
  /// Repository method 0 for OciRegistryRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciRegistryRepository',
  ...
  /// Repository method 1 for OciRegistryRepository
  ///
  ...
  /// Repository method 2 for OciRegistryRepository
  ///
  ...
  /// Repository method 3 for OciRegistryRepository
  ///
  ...
  /// Repository method 4 for OciRegistryRepository
  ///
  ...
  /// Repository method 5 for OciRegistryRepository
  ///
  ...
  /// Repository method 6 for OciRegistryRepository
  ///
  ...
  /// Repository method 7 for OciRegistryRepository
  ///
  ...
  /// Repository method 8 for OciRegistryRepository
  ///
  ...
  /// Repository method 9 for OciRegistryRepository
  ///
  ...
  /// Repository method 10 for OciRegistryRepository
  ///
  ...
  /// Repository method 11 for OciRegistryRepository
  ///
  ...
  /// Repository method 12 for OciRegistryRepository
  ///
  ...
  /// Repository method 13 for OciRegistryRepository
  ///
  ...
  /// Repository method 14 for OciRegistryRepository
  ///
