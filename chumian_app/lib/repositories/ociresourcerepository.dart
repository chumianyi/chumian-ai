...
class OciResourceRepository {
  OciResourceRepository._();
  static final OciResourceRepository instance = OciResourceRepository._();
  ...
  /// Repository method 0 for OciResourceRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciResourceRepository',
  ...
  /// Repository method 1 for OciResourceRepository
  ///
  ...
  /// Repository method 2 for OciResourceRepository
  ///
  ...
  /// Repository method 3 for OciResourceRepository
  ///
  ...
  /// Repository method 4 for OciResourceRepository
  ///
  ...
  /// Repository method 5 for OciResourceRepository
  ///
  ...
  /// Repository method 6 for OciResourceRepository
  ///
  ...
  /// Repository method 7 for OciResourceRepository
  ///
  ...
  /// Repository method 8 for OciResourceRepository
  ///
  ...
  /// Repository method 9 for OciResourceRepository
  ///
  ...
  /// Repository method 10 for OciResourceRepository
  ///
  ...
  /// Repository method 11 for OciResourceRepository
  ///
  ...
  /// Repository method 12 for OciResourceRepository
  ///
  ...
  /// Repository method 13 for OciResourceRepository
  ///
  ...
  /// Repository method 14 for OciResourceRepository
  ///
