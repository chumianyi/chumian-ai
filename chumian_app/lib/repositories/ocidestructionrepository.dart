...
/// OCI Destruction repository
class OciDestructionRepository {
  OciDestructionRepository._();
  static final OciDestructionRepository instance = OciDestructionRepository._();
  ...
  /// Repository method 0 for OciDestructionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDestructionRepository',
  ...
  /// Repository method 1 for OciDestructionRepository
  ///
  ...
  /// Repository method 2 for OciDestructionRepository
  ///
  ...
  /// Repository method 3 for OciDestructionRepository
  ///
  ...
  /// Repository method 4 for OciDestructionRepository
  ///
  ...
  /// Repository method 5 for OciDestructionRepository
  ///
  ...
  /// Repository method 6 for OciDestructionRepository
  ///
  ...
  /// Repository method 7 for OciDestructionRepository
  ///
  ...
  /// Repository method 8 for OciDestructionRepository
  ///
  ...
  /// Repository method 9 for OciDestructionRepository
  ///
  ...
  /// Repository method 10 for OciDestructionRepository
  ///
  ...
  /// Repository method 11 for OciDestructionRepository
  ///
  ...
  /// Repository method 12 for OciDestructionRepository
  ///
  ...
  /// Repository method 13 for OciDestructionRepository
  ///
  ...
  /// Repository method 14 for OciDestructionRepository
  ///
