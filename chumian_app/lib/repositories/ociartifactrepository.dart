...
class OciArtifactRepository {
  OciArtifactRepository._();
  static final OciArtifactRepository instance = OciArtifactRepository._();
  ...
  /// Repository method 0 for OciArtifactRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciArtifactRepository',
  ...
  /// Repository method 1 for OciArtifactRepository
  ///
  ...
  /// Repository method 2 for OciArtifactRepository
  ///
  ...
  /// Repository method 3 for OciArtifactRepository
  ///
  ...
  /// Repository method 4 for OciArtifactRepository
  ///
  ...
  /// Repository method 5 for OciArtifactRepository
  ///
  ...
  /// Repository method 6 for OciArtifactRepository
  ///
  ...
  /// Repository method 7 for OciArtifactRepository
  ///
  ...
  /// Repository method 8 for OciArtifactRepository
  ///
  ...
  /// Repository method 9 for OciArtifactRepository
  ///
  ...
  /// Repository method 10 for OciArtifactRepository
  ///
  ...
  /// Repository method 11 for OciArtifactRepository
  ///
  ...
  /// Repository method 12 for OciArtifactRepository
  ///
  ...
  /// Repository method 13 for OciArtifactRepository
  ///
  ...
  /// Repository method 14 for OciArtifactRepository
  ///
