...
/// OCI Schema repository
class OciSchemaRepository {
  OciSchemaRepository._();
  static final OciSchemaRepository instance = OciSchemaRepository._();
  ...
  /// Repository method 0 for OciSchemaRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciSchemaRepository',
  ...
  /// Repository method 1 for OciSchemaRepository
  ///
  ...
  /// Repository method 2 for OciSchemaRepository
  ///
  ...
  /// Repository method 3 for OciSchemaRepository
  ///
  ...
  /// Repository method 4 for OciSchemaRepository
  ///
  ...
  /// Repository method 5 for OciSchemaRepository
  ///
  ...
  /// Repository method 6 for OciSchemaRepository
  ///
  ...
  /// Repository method 7 for OciSchemaRepository
  ///
  ...
  /// Repository method 8 for OciSchemaRepository
  ///
  ...
  /// Repository method 9 for OciSchemaRepository
  ///
  ...
  /// Repository method 10 for OciSchemaRepository
  ///
  ...
  /// Repository method 11 for OciSchemaRepository
  ///
  ...
  /// Repository method 12 for OciSchemaRepository
  ///
  ...
  /// Repository method 13 for OciSchemaRepository
  ///
  ...
  /// Repository method 14 for OciSchemaRepository
  ///
