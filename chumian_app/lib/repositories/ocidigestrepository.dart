...
/// OCI Digest repository
class OciDigestRepository {
  OciDigestRepository._();
  static final OciDigestRepository instance = OciDigestRepository._();
  ...
  /// Repository method 0 for OciDigestRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDigestRepository',
  ...
  /// Repository method 1 for OciDigestRepository
  ///
  ...
  /// Repository method 2 for OciDigestRepository
  ///
  ...
  /// Repository method 3 for OciDigestRepository
  ///
  ...
  /// Repository method 4 for OciDigestRepository
  ///
  ...
  /// Repository method 5 for OciDigestRepository
  ///
  ...
  /// Repository method 6 for OciDigestRepository
  ///
  ...
  /// Repository method 7 for OciDigestRepository
  ///
  ...
  /// Repository method 8 for OciDigestRepository
  ///
  ...
  /// Repository method 9 for OciDigestRepository
  ///
  ...
  /// Repository method 10 for OciDigestRepository
  ///
  ...
  /// Repository method 11 for OciDigestRepository
  ///
  ...
  /// Repository method 12 for OciDigestRepository
  ///
  ...
  /// Repository method 13 for OciDigestRepository
  ///
  ...
  /// Repository method 14 for OciDigestRepository
  ///
