...
/// OCI Matrix repository
class OciMatrixRepository {
  OciMatrixRepository._();
  static final OciMatrixRepository instance = OciMatrixRepository._();
  ...
  /// Repository method 0 for OciMatrixRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciMatrixRepository',
  ...
  /// Repository method 1 for OciMatrixRepository
  ///
  ...
  /// Repository method 2 for OciMatrixRepository
  ///
  ...
  /// Repository method 3 for OciMatrixRepository
  ///
  ...
  /// Repository method 4 for OciMatrixRepository
  ///
  ...
  /// Repository method 5 for OciMatrixRepository
  ///
  ...
  /// Repository method 6 for OciMatrixRepository
  ///
  ...
  /// Repository method 7 for OciMatrixRepository
  ///
  ...
  /// Repository method 8 for OciMatrixRepository
  ///
  ...
  /// Repository method 9 for OciMatrixRepository
  ///
  ...
  /// Repository method 10 for OciMatrixRepository
  ///
  ...
  /// Repository method 11 for OciMatrixRepository
  ///
  ...
  /// Repository method 12 for OciMatrixRepository
  ///
  ...
  /// Repository method 13 for OciMatrixRepository
  ///
  ...
  /// Repository method 14 for OciMatrixRepository
  ///
