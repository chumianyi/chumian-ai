...
/// OCI Completion repository
class OciCompletionRepository {
  OciCompletionRepository._();
  static final OciCompletionRepository instance = OciCompletionRepository._();
  ...
  /// Repository method 0 for OciCompletionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciCompletionRepository',
  ...
  /// Repository method 1 for OciCompletionRepository
  ///
  ...
  /// Repository method 2 for OciCompletionRepository
  ///
  ...
  /// Repository method 3 for OciCompletionRepository
  ///
  ...
  /// Repository method 4 for OciCompletionRepository
  ///
  ...
  /// Repository method 5 for OciCompletionRepository
  ///
  ...
  /// Repository method 6 for OciCompletionRepository
  ///
  ...
  /// Repository method 7 for OciCompletionRepository
  ///
  ...
  /// Repository method 8 for OciCompletionRepository
  ///
  ...
  /// Repository method 9 for OciCompletionRepository
  ///
  ...
  /// Repository method 10 for OciCompletionRepository
  ///
  ...
  /// Repository method 11 for OciCompletionRepository
  ///
  ...
  /// Repository method 12 for OciCompletionRepository
  ///
  ...
  /// Repository method 13 for OciCompletionRepository
  ///
  ...
  /// Repository method 14 for OciCompletionRepository
  ///
