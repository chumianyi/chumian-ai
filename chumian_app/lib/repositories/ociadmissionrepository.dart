...
/// OCI Admission repository
class OciAdmissionRepository {
  OciAdmissionRepository._();
  static final OciAdmissionRepository instance = OciAdmissionRepository._();
  ...
  /// Repository method 0 for OciAdmissionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAdmissionRepository',
  ...
  /// Repository method 1 for OciAdmissionRepository
  ///
  ...
  /// Repository method 2 for OciAdmissionRepository
  ///
  ...
  /// Repository method 3 for OciAdmissionRepository
  ///
  ...
  /// Repository method 4 for OciAdmissionRepository
  ///
  ...
  /// Repository method 5 for OciAdmissionRepository
  ///
  ...
  /// Repository method 6 for OciAdmissionRepository
  ///
  ...
  /// Repository method 7 for OciAdmissionRepository
  ///
  ...
  /// Repository method 8 for OciAdmissionRepository
  ///
  ...
  /// Repository method 9 for OciAdmissionRepository
  ///
  ...
  /// Repository method 10 for OciAdmissionRepository
  ///
  ...
  /// Repository method 11 for OciAdmissionRepository
  ///
  ...
  /// Repository method 12 for OciAdmissionRepository
  ///
  ...
  /// Repository method 13 for OciAdmissionRepository
  ///
  ...
  /// Repository method 14 for OciAdmissionRepository
  ///
