...
/// OCI Statement repository
class OciStatementRepository {
  OciStatementRepository._();
  static final OciStatementRepository instance = OciStatementRepository._();
  ...
  /// Repository method 0 for OciStatementRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciStatementRepository',
  ...
  /// Repository method 1 for OciStatementRepository
  ///
  ...
  /// Repository method 2 for OciStatementRepository
  ///
  ...
  /// Repository method 3 for OciStatementRepository
  ///
  ...
  /// Repository method 4 for OciStatementRepository
  ///
  ...
  /// Repository method 5 for OciStatementRepository
  ///
  ...
  /// Repository method 6 for OciStatementRepository
  ///
  ...
  /// Repository method 7 for OciStatementRepository
  ///
  ...
  /// Repository method 8 for OciStatementRepository
  ///
  ...
  /// Repository method 9 for OciStatementRepository
  ///
  ...
  /// Repository method 10 for OciStatementRepository
  ///
  ...
  /// Repository method 11 for OciStatementRepository
  ///
  ...
  /// Repository method 12 for OciStatementRepository
  ///
  ...
  /// Repository method 13 for OciStatementRepository
  ///
  ...
  /// Repository method 14 for OciStatementRepository
  ///
