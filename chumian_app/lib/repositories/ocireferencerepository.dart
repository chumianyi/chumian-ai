...
/// OCI Reference repository
class OciReferenceRepository {
  OciReferenceRepository._();
  static final OciReferenceRepository instance = OciReferenceRepository._();
  ...
  /// Repository method 0 for OciReferenceRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciReferenceRepository',
  ...
  /// Repository method 1 for OciReferenceRepository
  ///
  ...
  /// Repository method 2 for OciReferenceRepository
  ///
  ...
  /// Repository method 3 for OciReferenceRepository
  ///
  ...
  /// Repository method 4 for OciReferenceRepository
  ///
  ...
  /// Repository method 5 for OciReferenceRepository
  ///
  ...
  /// Repository method 6 for OciReferenceRepository
  ///
  ...
  /// Repository method 7 for OciReferenceRepository
  ///
  ...
  /// Repository method 8 for OciReferenceRepository
  ///
  ...
  /// Repository method 9 for OciReferenceRepository
  ///
  ...
  /// Repository method 10 for OciReferenceRepository
  ///
  ...
  /// Repository method 11 for OciReferenceRepository
  ///
  ...
  /// Repository method 12 for OciReferenceRepository
  ///
  ...
  /// Repository method 13 for OciReferenceRepository
  ///
  ...
  /// Repository method 14 for OciReferenceRepository
  ///
