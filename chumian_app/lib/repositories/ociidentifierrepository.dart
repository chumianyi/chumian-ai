...
/// OCI Identifier repository
class OciIdentifierRepository {
  OciIdentifierRepository._();
  static final OciIdentifierRepository instance = OciIdentifierRepository._();
  ...
  /// Repository method 0 for OciIdentifierRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciIdentifierRepository',
  ...
  /// Repository method 1 for OciIdentifierRepository
  ///
  ...
  /// Repository method 2 for OciIdentifierRepository
  ///
  ...
  /// Repository method 3 for OciIdentifierRepository
  ///
  ...
  /// Repository method 4 for OciIdentifierRepository
  ///
  ...
  /// Repository method 5 for OciIdentifierRepository
  ///
  ...
  /// Repository method 6 for OciIdentifierRepository
  ///
  ...
  /// Repository method 7 for OciIdentifierRepository
  ///
  ...
  /// Repository method 8 for OciIdentifierRepository
  ///
  ...
  /// Repository method 9 for OciIdentifierRepository
  ///
  ...
  /// Repository method 10 for OciIdentifierRepository
  ///
  ...
  /// Repository method 11 for OciIdentifierRepository
  ///
  ...
  /// Repository method 12 for OciIdentifierRepository
  ///
  ...
  /// Repository method 13 for OciIdentifierRepository
  ///
  ...
  /// Repository method 14 for OciIdentifierRepository
  ///
