...
/// OCI Vector repository
class OciVectorRepository {
  OciVectorRepository._();
  static final OciVectorRepository instance = OciVectorRepository._();
  ...
  /// Repository method 0 for OciVectorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciVectorRepository',
  ...
  /// Repository method 1 for OciVectorRepository
  ///
  ...
  /// Repository method 2 for OciVectorRepository
  ///
  ...
  /// Repository method 3 for OciVectorRepository
  ///
  ...
  /// Repository method 4 for OciVectorRepository
  ///
  ...
  /// Repository method 5 for OciVectorRepository
  ///
  ...
  /// Repository method 6 for OciVectorRepository
  ///
  ...
  /// Repository method 7 for OciVectorRepository
  ///
  ...
  /// Repository method 8 for OciVectorRepository
  ///
  ...
  /// Repository method 9 for OciVectorRepository
  ///
  ...
  /// Repository method 10 for OciVectorRepository
  ///
  ...
  /// Repository method 11 for OciVectorRepository
  ///
  ...
  /// Repository method 12 for OciVectorRepository
  ///
  ...
  /// Repository method 13 for OciVectorRepository
  ///
  ...
  /// Repository method 14 for OciVectorRepository
  ///
