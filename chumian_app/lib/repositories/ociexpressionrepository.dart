...
/// OCI Expression repository
class OciExpressionRepository {
  OciExpressionRepository._();
  static final OciExpressionRepository instance = OciExpressionRepository._();
  ...
  /// Repository method 0 for OciExpressionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciExpressionRepository',
  ...
  /// Repository method 1 for OciExpressionRepository
  ///
  ...
  /// Repository method 2 for OciExpressionRepository
  ///
  ...
  /// Repository method 3 for OciExpressionRepository
  ///
  ...
  /// Repository method 4 for OciExpressionRepository
  ///
  ...
  /// Repository method 5 for OciExpressionRepository
  ///
  ...
  /// Repository method 6 for OciExpressionRepository
  ///
  ...
  /// Repository method 7 for OciExpressionRepository
  ///
  ...
  /// Repository method 8 for OciExpressionRepository
  ///
  ...
  /// Repository method 9 for OciExpressionRepository
  ///
  ...
  /// Repository method 10 for OciExpressionRepository
  ///
  ...
  /// Repository method 11 for OciExpressionRepository
  ///
  ...
  /// Repository method 12 for OciExpressionRepository
  ///
  ...
  /// Repository method 13 for OciExpressionRepository
  ///
  ...
  /// Repository method 14 for OciExpressionRepository
  ///
