...
/// OCI Operator repository
class OciOperatorRepository {
  OciOperatorRepository._();
  static final OciOperatorRepository instance = OciOperatorRepository._();
  ...
  /// Repository method 0 for OciOperatorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciOperatorRepository',
  ...
  /// Repository method 1 for OciOperatorRepository
  ///
  ...
  /// Repository method 2 for OciOperatorRepository
  ///
  ...
  /// Repository method 3 for OciOperatorRepository
  ///
  ...
  /// Repository method 4 for OciOperatorRepository
  ///
  ...
  /// Repository method 5 for OciOperatorRepository
  ///
  ...
  /// Repository method 6 for OciOperatorRepository
  ///
  ...
  /// Repository method 7 for OciOperatorRepository
  ///
  ...
  /// Repository method 8 for OciOperatorRepository
  ///
  ...
  /// Repository method 9 for OciOperatorRepository
  ///
  ...
  /// Repository method 10 for OciOperatorRepository
  ///
  ...
  /// Repository method 11 for OciOperatorRepository
  ///
  ...
  /// Repository method 12 for OciOperatorRepository
  ///
  ...
  /// Repository method 13 for OciOperatorRepository
  ///
  ...
  /// Repository method 14 for OciOperatorRepository
  ///
