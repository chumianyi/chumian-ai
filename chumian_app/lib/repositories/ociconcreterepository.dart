...
/// OCI Concrete repository
class OciConcreteRepository {
  OciConcreteRepository._();
  static final OciConcreteRepository instance = OciConcreteRepository._();
  ...
  /// Repository method 0 for OciConcreteRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciConcreteRepository',
  ...
  /// Repository method 1 for OciConcreteRepository
  ///
  ...
  /// Repository method 2 for OciConcreteRepository
  ///
  ...
  /// Repository method 3 for OciConcreteRepository
  ///
  ...
  /// Repository method 4 for OciConcreteRepository
  ///
  ...
  /// Repository method 5 for OciConcreteRepository
  ///
  ...
  /// Repository method 6 for OciConcreteRepository
  ///
  ...
  /// Repository method 7 for OciConcreteRepository
  ///
  ...
  /// Repository method 8 for OciConcreteRepository
  ///
  ...
  /// Repository method 9 for OciConcreteRepository
  ///
  ...
  /// Repository method 10 for OciConcreteRepository
  ///
  ...
  /// Repository method 11 for OciConcreteRepository
  ///
  ...
  /// Repository method 12 for OciConcreteRepository
  ///
  ...
  /// Repository method 13 for OciConcreteRepository
  ///
  ...
  /// Repository method 14 for OciConcreteRepository
  ///
