...
/// OCI Manifest repository
class OciManifestRepository {
  OciManifestRepository._();
  static final OciManifestRepository instance = OciManifestRepository._();
  ...
  /// Repository method 0 for OciManifestRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciManifestRepository',
  ...
  /// Repository method 1 for OciManifestRepository
  ///
  ...
  /// Repository method 2 for OciManifestRepository
  ///
  ...
  /// Repository method 3 for OciManifestRepository
  ///
  ...
  /// Repository method 4 for OciManifestRepository
  ///
  ...
  /// Repository method 5 for OciManifestRepository
  ///
  ...
  /// Repository method 6 for OciManifestRepository
  ///
  ...
  /// Repository method 7 for OciManifestRepository
  ///
  ...
  /// Repository method 8 for OciManifestRepository
  ///
  ...
  /// Repository method 9 for OciManifestRepository
  ///
  ...
  /// Repository method 10 for OciManifestRepository
  ///
  ...
  /// Repository method 11 for OciManifestRepository
  ///
  ...
  /// Repository method 12 for OciManifestRepository
  ///
  ...
  /// Repository method 13 for OciManifestRepository
  ///
  ...
  /// Repository method 14 for OciManifestRepository
  ///
