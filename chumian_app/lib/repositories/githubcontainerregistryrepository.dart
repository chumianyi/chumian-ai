...
class GithubContainerRegistryRepository {
  GithubContainerRegistryRepository._();
  static final GithubContainerRegistryRepository instance = GithubContainerRegistryRepository._();
  ...
  /// Repository method 0 for GithubContainerRegistryRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'GithubContainerRegistryRepository',
  ...
  /// Repository method 1 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 2 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 3 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 4 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 5 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 6 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 7 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 8 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 9 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 10 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 11 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 12 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 13 for GithubContainerRegistryRepository
  ///
  ...
  /// Repository method 14 for GithubContainerRegistryRepository
  ///
