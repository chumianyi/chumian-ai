...
/// OCI Tensor repository
class OciTensorRepository {
  OciTensorRepository._();
  static final OciTensorRepository instance = OciTensorRepository._();
  ...
  /// Repository method 0 for OciTensorRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciTensorRepository',
  ...
  /// Repository method 1 for OciTensorRepository
  ///
  ...
  /// Repository method 2 for OciTensorRepository
  ///
  ...
  /// Repository method 3 for OciTensorRepository
  ///
  ...
  /// Repository method 4 for OciTensorRepository
  ///
  ...
  /// Repository method 5 for OciTensorRepository
  ///
  ...
  /// Repository method 6 for OciTensorRepository
  ///
  ...
  /// Repository method 7 for OciTensorRepository
  ///
  ...
  /// Repository method 8 for OciTensorRepository
  ///
  ...
  /// Repository method 9 for OciTensorRepository
  ///
  ...
  /// Repository method 10 for OciTensorRepository
  ///
  ...
  /// Repository method 11 for OciTensorRepository
  ///
  ...
  /// Repository method 12 for OciTensorRepository
  ///
  ...
  /// Repository method 13 for OciTensorRepository
  ///
  ...
  /// Repository method 14 for OciTensorRepository
  ///
