...
class OciEndpointRepository {
  OciEndpointRepository._();
  static final OciEndpointRepository instance = OciEndpointRepository._();
  ...
  /// Repository method 0 for OciEndpointRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciEndpointRepository',
  ...
  /// Repository method 1 for OciEndpointRepository
  ///
  ...
  /// Repository method 2 for OciEndpointRepository
  ///
  ...
  /// Repository method 3 for OciEndpointRepository
  ///
  ...
  /// Repository method 4 for OciEndpointRepository
  ///
  ...
  /// Repository method 5 for OciEndpointRepository
  ///
  ...
  /// Repository method 6 for OciEndpointRepository
  ///
  ...
  /// Repository method 7 for OciEndpointRepository
  ///
  ...
  /// Repository method 8 for OciEndpointRepository
  ///
  ...
  /// Repository method 9 for OciEndpointRepository
  ///
  ...
  /// Repository method 10 for OciEndpointRepository
  ///
  ...
  /// Repository method 11 for OciEndpointRepository
  ///
  ...
  /// Repository method 12 for OciEndpointRepository
  ///
  ...
  /// Repository method 13 for OciEndpointRepository
  ///
  ...
  /// Repository method 14 for OciEndpointRepository
  ///
