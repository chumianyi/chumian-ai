...
/// OCI Pipeline repository
class OciPipelineRepository {
  OciPipelineRepository._();
  static final OciPipelineRepository instance = OciPipelineRepository._();
  ...
  /// Repository method 0 for OciPipelineRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPipelineRepository',
  ...
  /// Repository method 1 for OciPipelineRepository
  ///
  ...
  /// Repository method 2 for OciPipelineRepository
  ///
  ...
  /// Repository method 3 for OciPipelineRepository
  ///
  ...
  /// Repository method 4 for OciPipelineRepository
  ///
  ...
  /// Repository method 5 for OciPipelineRepository
  ///
  ...
  /// Repository method 6 for OciPipelineRepository
  ///
  ...
  /// Repository method 7 for OciPipelineRepository
  ///
  ...
  /// Repository method 8 for OciPipelineRepository
  ///
  ...
  /// Repository method 9 for OciPipelineRepository
  ///
  ...
  /// Repository method 10 for OciPipelineRepository
  ///
  ...
  /// Repository method 11 for OciPipelineRepository
  ///
  ...
  /// Repository method 12 for OciPipelineRepository
  ///
  ...
  /// Repository method 13 for OciPipelineRepository
  ///
  ...
  /// Repository method 14 for OciPipelineRepository
  ///
