...
class OciDistributionRepository {
  OciDistributionRepository._();
  static final OciDistributionRepository instance = OciDistributionRepository._();
  ...
  /// Repository method 0 for OciDistributionRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDistributionRepository',
  ...
  /// Repository method 1 for OciDistributionRepository
  ///
  ...
  /// Repository method 2 for OciDistributionRepository
  ///
  ...
  /// Repository method 3 for OciDistributionRepository
  ///
  ...
  /// Repository method 4 for OciDistributionRepository
  ///
  ...
  /// Repository method 5 for OciDistributionRepository
  ///
  ...
  /// Repository method 6 for OciDistributionRepository
  ///
  ...
  /// Repository method 7 for OciDistributionRepository
  ///
  ...
  /// Repository method 8 for OciDistributionRepository
  ///
  ...
  /// Repository method 9 for OciDistributionRepository
  ///
  ...
  /// Repository method 10 for OciDistributionRepository
  ///
  ...
  /// Repository method 11 for OciDistributionRepository
  ///
  ...
  /// Repository method 12 for OciDistributionRepository
  ///
  ...
  /// Repository method 13 for OciDistributionRepository
  ///
  ...
  /// Repository method 14 for OciDistributionRepository
  ///
