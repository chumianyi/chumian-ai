...
/// OCI Prototype repository
class OciPrototypeRepository {
  OciPrototypeRepository._();
  static final OciPrototypeRepository instance = OciPrototypeRepository._();
  ...
  /// Repository method 0 for OciPrototypeRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciPrototypeRepository',
  ...
  /// Repository method 1 for OciPrototypeRepository
  ///
  ...
  /// Repository method 2 for OciPrototypeRepository
  ///
  ...
  /// Repository method 3 for OciPrototypeRepository
  ///
  ...
  /// Repository method 4 for OciPrototypeRepository
  ///
  ...
  /// Repository method 5 for OciPrototypeRepository
  ///
  ...
  /// Repository method 6 for OciPrototypeRepository
  ///
  ...
  /// Repository method 7 for OciPrototypeRepository
  ///
  ...
  /// Repository method 8 for OciPrototypeRepository
  ///
  ...
  /// Repository method 9 for OciPrototypeRepository
  ///
  ...
  /// Repository method 10 for OciPrototypeRepository
  ///
  ...
  /// Repository method 11 for OciPrototypeRepository
  ///
  ...
  /// Repository method 12 for OciPrototypeRepository
  ///
  ...
  /// Repository method 13 for OciPrototypeRepository
  ///
  ...
  /// Repository method 14 for OciPrototypeRepository
  ///
