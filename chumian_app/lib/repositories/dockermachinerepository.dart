...
/// Docker Machine repository
class DockerMachineRepository {
  DockerMachineRepository._();
  static final DockerMachineRepository instance = DockerMachineRepository._();
  ...
  /// Repository method 0 for DockerMachineRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'DockerMachineRepository',
  ...
  /// Repository method 1 for DockerMachineRepository
  ///
  ...
  /// Repository method 2 for DockerMachineRepository
  ///
  ...
  /// Repository method 3 for DockerMachineRepository
  ///
  ...
  /// Repository method 4 for DockerMachineRepository
  ///
  ...
  /// Repository method 5 for DockerMachineRepository
  ///
  ...
  /// Repository method 6 for DockerMachineRepository
  ///
  ...
  /// Repository method 7 for DockerMachineRepository
  ///
  ...
  /// Repository method 8 for DockerMachineRepository
  ///
  ...
  /// Repository method 9 for DockerMachineRepository
  ///
  ...
  /// Repository method 10 for DockerMachineRepository
  ///
  ...
  /// Repository method 11 for DockerMachineRepository
  ///
  ...
  /// Repository method 12 for DockerMachineRepository
  ///
  ...
  /// Repository method 13 for DockerMachineRepository
  ///
  ...
  /// Repository method 14 for DockerMachineRepository
  ///
