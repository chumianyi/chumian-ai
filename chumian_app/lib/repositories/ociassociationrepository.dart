...
/// OCI Association repository
class OciAssociationRepository {
  OciAssociationRepository._();
  static final OciAssociationRepository instance = OciAssociationRepository._();
  ...
  /// Repository method 0 for OciAssociationRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciAssociationRepository',
  ...
  /// Repository method 1 for OciAssociationRepository
  ///
  ...
  /// Repository method 2 for OciAssociationRepository
  ///
  ...
  /// Repository method 3 for OciAssociationRepository
  ///
  ...
  /// Repository method 4 for OciAssociationRepository
  ///
  ...
  /// Repository method 5 for OciAssociationRepository
  ///
  ...
  /// Repository method 6 for OciAssociationRepository
  ///
  ...
  /// Repository method 7 for OciAssociationRepository
  ///
  ...
  /// Repository method 8 for OciAssociationRepository
  ///
  ...
  /// Repository method 9 for OciAssociationRepository
  ///
  ...
  /// Repository method 10 for OciAssociationRepository
  ///
  ...
  /// Repository method 11 for OciAssociationRepository
  ///
  ...
  /// Repository method 12 for OciAssociationRepository
  ///
  ...
  /// Repository method 13 for OciAssociationRepository
  ///
  ...
  /// Repository method 14 for OciAssociationRepository
  ///
