...
/// OCI Environment repository
class OciEnvironmentRepository {
  OciEnvironmentRepository._();
  static final OciEnvironmentRepository instance = OciEnvironmentRepository._();
  ...
  /// Repository method 0 for OciEnvironmentRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciEnvironmentRepository',
  ...
  /// Repository method 1 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 2 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 3 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 4 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 5 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 6 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 7 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 8 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 9 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 10 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 11 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 12 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 13 for OciEnvironmentRepository
  ///
  ...
  /// Repository method 14 for OciEnvironmentRepository
  ///
