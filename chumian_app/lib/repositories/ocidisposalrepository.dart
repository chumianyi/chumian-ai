...
/// OCI Disposal repository
class OciDisposalRepository {
  OciDisposalRepository._();
  static final OciDisposalRepository instance = OciDisposalRepository._();
  ...
  /// Repository method 0 for OciDisposalRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciDisposalRepository',
  ...
  /// Repository method 1 for OciDisposalRepository
  ///
  ...
  /// Repository method 2 for OciDisposalRepository
  ///
  ...
  /// Repository method 3 for OciDisposalRepository
  ///
  ...
  /// Repository method 4 for OciDisposalRepository
  ///
  ...
  /// Repository method 5 for OciDisposalRepository
  ///
  ...
  /// Repository method 6 for OciDisposalRepository
  ///
  ...
  /// Repository method 7 for OciDisposalRepository
  ///
  ...
  /// Repository method 8 for OciDisposalRepository
  ///
  ...
  /// Repository method 9 for OciDisposalRepository
  ///
  ...
  /// Repository method 10 for OciDisposalRepository
  ///
  ...
  /// Repository method 11 for OciDisposalRepository
  ///
  ...
  /// Repository method 12 for OciDisposalRepository
  ///
  ...
  /// Repository method 13 for OciDisposalRepository
  ///
  ...
  /// Repository method 14 for OciDisposalRepository
  ///
