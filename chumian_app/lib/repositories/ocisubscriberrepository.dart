...
/// OCI Subscriber repository
class OciSubscriberRepository {
  OciSubscriberRepository._();
  static final OciSubscriberRepository instance = OciSubscriberRepository._();
  ...
  /// Repository method 0 for OciSubscriberRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciSubscriberRepository',
  ...
  /// Repository method 1 for OciSubscriberRepository
  ///
  ...
  /// Repository method 2 for OciSubscriberRepository
  ///
  ...
  /// Repository method 3 for OciSubscriberRepository
  ///
  ...
  /// Repository method 4 for OciSubscriberRepository
  ///
  ...
  /// Repository method 5 for OciSubscriberRepository
  ///
  ...
  /// Repository method 6 for OciSubscriberRepository
  ///
  ...
  /// Repository method 7 for OciSubscriberRepository
  ///
  ...
  /// Repository method 8 for OciSubscriberRepository
  ///
  ...
  /// Repository method 9 for OciSubscriberRepository
  ///
  ...
  /// Repository method 10 for OciSubscriberRepository
  ///
  ...
  /// Repository method 11 for OciSubscriberRepository
  ///
  ...
  /// Repository method 12 for OciSubscriberRepository
  ///
  ...
  /// Repository method 13 for OciSubscriberRepository
  ///
  ...
  /// Repository method 14 for OciSubscriberRepository
  ///
