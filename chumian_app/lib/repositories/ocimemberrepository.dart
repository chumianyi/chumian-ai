...
/// OCI Member repository
class OciMemberRepository {
  OciMemberRepository._();
  static final OciMemberRepository instance = OciMemberRepository._();
  ...
  /// Repository method 0 for OciMemberRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'OciMemberRepository',
  ...
  /// Repository method 1 for OciMemberRepository
  ///
  ...
  /// Repository method 2 for OciMemberRepository
  ///
  ...
  /// Repository method 3 for OciMemberRepository
  ///
  ...
  /// Repository method 4 for OciMemberRepository
  ///
  ...
  /// Repository method 5 for OciMemberRepository
  ///
  ...
  /// Repository method 6 for OciMemberRepository
  ///
  ...
  /// Repository method 7 for OciMemberRepository
  ///
  ...
  /// Repository method 8 for OciMemberRepository
  ///
  ...
  /// Repository method 9 for OciMemberRepository
  ///
  ...
  /// Repository method 10 for OciMemberRepository
  ///
  ...
  /// Repository method 11 for OciMemberRepository
  ///
  ...
  /// Repository method 12 for OciMemberRepository
  ///
  ...
  /// Repository method 13 for OciMemberRepository
  ///
  ...
  /// Repository method 14 for OciMemberRepository
  ///
