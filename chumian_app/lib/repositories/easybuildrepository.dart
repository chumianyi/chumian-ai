...
class EasybuildRepository {
  EasybuildRepository._();
  static final EasybuildRepository instance = EasybuildRepository._();
  ...
  /// Repository method 0 for EasybuildRepository
  ///
    ...
    if (!forceRefresh) {
      ...
      if (cached != null) {
        return {
          ...
          'fromCache': true,
          'method': 'repoMethod0',
          'repository': 'EasybuildRepository',
  ...
  /// Repository method 1 for EasybuildRepository
  ///
  ...
  /// Repository method 2 for EasybuildRepository
  ///
  ...
  /// Repository method 3 for EasybuildRepository
  ///
  ...
  /// Repository method 4 for EasybuildRepository
  ///
  ...
  /// Repository method 5 for EasybuildRepository
  ///
  ...
  /// Repository method 6 for EasybuildRepository
  ///
  ...
  /// Repository method 7 for EasybuildRepository
  ///
  ...
  /// Repository method 8 for EasybuildRepository
  ///
  ...
  /// Repository method 9 for EasybuildRepository
  ///
  ...
  /// Repository method 10 for EasybuildRepository
  ///
  ...
  /// Repository method 11 for EasybuildRepository
  ///
  ...
  /// Repository method 12 for EasybuildRepository
  ///
  ...
  /// Repository method 13 for EasybuildRepository
  ///
  ...
  /// Repository method 14 for EasybuildRepository
  ///
